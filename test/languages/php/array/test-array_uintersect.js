...
describe('php', function () {
  describe('array.array_uintersect.js', function () {
    it('should pass test 1', function (done) {
      ...
      expected = {a: 'green', b: 'brown', 0: 'red'}
$array1 = {a: 'green', b: 'brown', c: 'blue', 0: 'red'}
$array2 = {a: 'GREEN', B: 'brown', 0: 'yellow', 1: 'red'}
      result = array_uintersect($array1, $array2, function( f_string1, f_string2){var string1 = (f_string1+'').toLowerCase(); var string2 = (f_string2+'').toLowerCase(); if (string1 > string2) return 1; if (string1 === string2) return 0; return -1;});
