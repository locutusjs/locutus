...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/reverse.ts').reverse
const __locutus_source_module_url = new URL("../../../../src/tcl/string/reverse.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/reverse (target function module)\nfunction reverse(str) {\n    //      discuss at: https://locutus.io/tcl/reverse/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: reverse('hello')\n    //       returns 1: 'olleh'\n    //       example 2: reverse('abc')\n    //       returns 2: 'cba'\n    return String(str).split('').reverse().join('');\n}"
const __locutus_standalone_js_code = "// tcl/string/reverse (target function module)\nfunction reverse(str) {\n    //      discuss at: https://locutus.io/tcl/reverse/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: reverse('hello')\n    //       returns 1: 'olleh'\n    //       example 2: reverse('abc')\n    //       returns 2: 'cba'\n    return String(str).split('').reverse().join('');\n}"
...
describe('src/tcl/string/reverse.ts (tested in test/generated/tcl/string/reverse.vitest.ts)', function () {
