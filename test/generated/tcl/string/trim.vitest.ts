...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/trim.ts').trim
const __locutus_source_module_url = new URL("../../../../src/tcl/string/trim.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/trim (target function module)\nconst escapeForCharClass = (chars) => chars.replace(/[\\\\\\]^/-]/g, '\\\\$&');\nfunction trim(str, chars) {\n    //      discuss at: https://locutus.io/tcl/trim/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim('  hello  ')\n    //       returns 1: 'hello'\n    //       example 2: trim('__hello__', '_')\n    //       returns 2: 'hello'\n    const value = String(str);\n    if (chars === undefined) {\n        return value.trim();\n    }\n    if (chars === '') {\n        return value;\n    }\n    const escaped = escapeForCharClass(chars);\n    const pattern = new RegExp(`^[${escaped}]+|[${escaped}]+$`, 'g');\n    return value.replace(pattern, '');\n}"
const __locutus_standalone_js_code = "// tcl/string/trim (target function module)\nconst escapeForCharClass = (chars) => chars.replace(/[\\\\\\]^/-]/g, '\\\\$&');\nfunction trim(str, chars) {\n    //      discuss at: https://locutus.io/tcl/trim/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim('  hello  ')\n    //       returns 1: 'hello'\n    //       example 2: trim('__hello__', '_')\n    //       returns 2: 'hello'\n    const value = String(str);\n    if (chars === undefined) {\n        return value.trim();\n    }\n    if (chars === '') {\n        return value;\n    }\n    const escaped = escapeForCharClass(chars);\n    const pattern = new RegExp(`^[${escaped}]+|[${escaped}]+$`, 'g');\n    return value.replace(pattern, '');\n}"
...
describe('src/tcl/string/trim.ts (tested in test/generated/tcl/string/trim.vitest.ts)', function () {
