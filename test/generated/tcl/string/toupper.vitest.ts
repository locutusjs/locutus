...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/toupper.ts').toupper
const __locutus_source_module_url = new URL("../../../../src/tcl/string/toupper.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/toupper (target function module)\nfunction toupper(str) {\n    //      discuss at: https://locutus.io/tcl/toupper/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: toupper('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: toupper('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(str).toUpperCase();\n}"
const __locutus_standalone_js_code = "// tcl/string/toupper (target function module)\nfunction toupper(str) {\n    //      discuss at: https://locutus.io/tcl/toupper/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: toupper('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: toupper('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(str).toUpperCase();\n}"
...
describe('src/tcl/string/toupper.ts (tested in test/generated/tcl/string/toupper.vitest.ts)', function () {
