...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/trimright.ts').trimright
const __locutus_source_module_url = new URL("../../../../src/tcl/string/trimright.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/trimright (target function module)\nconst escapeForCharClass = (chars) => chars.replace(/[\\\\\\]^/-]/g, '\\\\$&');\nfunction trimright(str, chars) {\n    //      discuss at: https://locutus.io/tcl/trimright/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trimright('  hello  ')\n    //       returns 1: '  hello'\n    //       example 2: trimright('__hello__', '_')\n    //       returns 2: '__hello'\n    const value = String(str);\n    if (chars === undefined) {\n        return value.trimEnd();\n    }\n    if (chars === '') {\n        return value;\n    }\n    const escaped = escapeForCharClass(chars);\n    const pattern = new RegExp(`[${escaped}]+$`, 'g');\n    return value.replace(pattern, '');\n}"
const __locutus_standalone_js_code = "// tcl/string/trimright (target function module)\nconst escapeForCharClass = (chars) => chars.replace(/[\\\\\\]^/-]/g, '\\\\$&');\nfunction trimright(str, chars) {\n    //      discuss at: https://locutus.io/tcl/trimright/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trimright('  hello  ')\n    //       returns 1: '  hello'\n    //       example 2: trimright('__hello__', '_')\n    //       returns 2: '__hello'\n    const value = String(str);\n    if (chars === undefined) {\n        return value.trimEnd();\n    }\n    if (chars === '') {\n        return value;\n    }\n    const escaped = escapeForCharClass(chars);\n    const pattern = new RegExp(`[${escaped}]+$`, 'g');\n    return value.replace(pattern, '');\n}"
...
describe('src/tcl/string/trimright.ts (tested in test/generated/tcl/string/trimright.vitest.ts)', function () {
