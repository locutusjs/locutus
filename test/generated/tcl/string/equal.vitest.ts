...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/equal.ts').equal
const __locutus_source_module_url = new URL("../../../../src/tcl/string/equal.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/equal (target function module)\nfunction equal(str1, str2) {\n    //      discuss at: https://locutus.io/tcl/equal/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: equal('abc', 'abc')\n    //       returns 1: true\n    //       example 2: equal('abc', 'abd')\n    //       returns 2: false\n    //       example 3: equal('', '')\n    //       returns 3: true\n    return String(str1) === String(str2);\n}"
const __locutus_standalone_js_code = "// tcl/string/equal (target function module)\nfunction equal(str1, str2) {\n    //      discuss at: https://locutus.io/tcl/equal/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: equal('abc', 'abc')\n    //       returns 1: true\n    //       example 2: equal('abc', 'abd')\n    //       returns 2: false\n    //       example 3: equal('', '')\n    //       returns 3: true\n    return String(str1) === String(str2);\n}"
...
describe('src/tcl/string/equal.ts (tested in test/generated/tcl/string/equal.vitest.ts)', function () {
