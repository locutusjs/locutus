...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/tolower.ts').tolower
const __locutus_source_module_url = new URL("../../../../src/tcl/string/tolower.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/tolower (target function module)\nfunction tolower(str) {\n    //      discuss at: https://locutus.io/tcl/tolower/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tolower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: tolower('Hello World')\n    //       returns 2: 'hello world'\n    return String(str).toLowerCase();\n}"
const __locutus_standalone_js_code = "// tcl/string/tolower (target function module)\nfunction tolower(str) {\n    //      discuss at: https://locutus.io/tcl/tolower/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tolower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: tolower('Hello World')\n    //       returns 2: 'hello world'\n    return String(str).toLowerCase();\n}"
...
describe('src/tcl/string/tolower.ts (tested in test/generated/tcl/string/tolower.vitest.ts)', function () {
