...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/length.ts').length
const __locutus_source_module_url = new URL("../../../../src/tcl/string/length.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/length (target function module)\nfunction length(str) {\n    //      discuss at: https://locutus.io/tcl/length/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: length('hello')\n    //       returns 1: 5\n    //       example 2: length('')\n    //       returns 2: 0\n    return String(str).length;\n}"
const __locutus_standalone_js_code = "// tcl/string/length (target function module)\nfunction length(str) {\n    //      discuss at: https://locutus.io/tcl/length/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: length('hello')\n    //       returns 1: 5\n    //       example 2: length('')\n    //       returns 2: 0\n    return String(str).length;\n}"
...
describe('src/tcl/string/length.ts (tested in test/generated/tcl/string/length.vitest.ts)', function () {
