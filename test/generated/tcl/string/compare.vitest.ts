...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/tcl/string/compare.ts').compare
const __locutus_source_module_url = new URL("../../../../src/tcl/string/compare.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// tcl/string/compare (target function module)\nfunction compare(str1, str2) {\n    //      discuss at: https://locutus.io/tcl/compare/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: compare('abc', 'abc')\n    //       returns 1: 0\n    //       example 2: compare('abc', 'abd')\n    //       returns 2: -1\n    //       example 3: compare('abd', 'abc')\n    //       returns 3: 1\n    const left = String(str1);\n    const right = String(str2);\n    if (left === right) {\n        return 0;\n    }\n    return left < right ? -1 : 1;\n}"
const __locutus_standalone_js_code = "// tcl/string/compare (target function module)\nfunction compare(str1, str2) {\n    //      discuss at: https://locutus.io/tcl/compare/\n    // parity verified: Tcl 8.6\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: compare('abc', 'abc')\n    //       returns 1: 0\n    //       example 2: compare('abc', 'abd')\n    //       returns 2: -1\n    //       example 3: compare('abd', 'abc')\n    //       returns 3: 1\n    const left = String(str1);\n    const right = String(str2);\n    if (left === right) {\n        return 0;\n    }\n    return left < right ? -1 : 1;\n}"
...
describe('src/tcl/string/compare.ts (tested in test/generated/tcl/string/compare.vitest.ts)', function () {
