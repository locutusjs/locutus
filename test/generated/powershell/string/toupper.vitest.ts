...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/powershell/string/toupper.ts').toupper
const __locutus_source_module_url = new URL("../../../../src/powershell/string/toupper.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// powershell/string/toupper (target function module)\nfunction toupper(str) {\n    //      discuss at: https://locutus.io/powershell/toupper/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: toupper('hello world')\n    //       returns 1: 'HELLO WORLD'\n    //       example 2: toupper('Locutus')\n    //       returns 2: 'LOCUTUS'\n    return String(str).toUpperCase();\n}"
const __locutus_standalone_js_code = "// powershell/string/toupper (target function module)\nfunction toupper(str) {\n    //      discuss at: https://locutus.io/powershell/toupper/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: toupper('hello world')\n    //       returns 1: 'HELLO WORLD'\n    //       example 2: toupper('Locutus')\n    //       returns 2: 'LOCUTUS'\n    return String(str).toUpperCase();\n}"
...
describe('src/powershell/string/toupper.ts (tested in test/generated/powershell/string/toupper.vitest.ts)', function () {
