...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/powershell/string/padleft.ts').padleft
const __locutus_source_module_url = new URL("../../../../src/powershell/string/padleft.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "padleft"
...
const __locutus_standalone_ts_code = "// powershell/string/padleft (target function module)\nfunction padleft(str, totalWidth, paddingChar) {\n    //      discuss at: https://locutus.io/powershell/padleft/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: padleft('42', 5)\n    //       returns 1: '   42'\n    //       example 2: padleft('42', 5, '0')\n    //       returns 2: '00042'\n    //       example 3: padleft('hello', 3)\n    //       returns 3: 'hello'\n    const source = String(str);\n    const width = Math.trunc(Number(totalWidth));\n    if (!Number.isFinite(width) || width < 0) {\n        throw new RangeError('padleft(): totalWidth must be a non-negative integer');\n    }\n    const fill = paddingChar === undefined ? ' ' : String(paddingChar);\n    if (fill === '') {\n        return source;\n    }\n    return source.padStart(width, fill[0] ?? ' ');\n}"
const __locutus_standalone_js_code = "// powershell/string/padleft (target function module)\nfunction padleft(str, totalWidth, paddingChar) {\n    //      discuss at: https://locutus.io/powershell/padleft/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: padleft('42', 5)\n    //       returns 1: '   42'\n    //       example 2: padleft('42', 5, '0')\n    //       returns 2: '00042'\n    //       example 3: padleft('hello', 3)\n    //       returns 3: 'hello'\n    const source = String(str);\n    const width = Math.trunc(Number(totalWidth));\n    if (!Number.isFinite(width) || width < 0) {\n        throw new RangeError('padleft(): totalWidth must be a non-negative integer');\n    }\n    const fill = paddingChar === undefined ? ' ' : String(paddingChar);\n    if (fill === '') {\n        return source;\n    }\n    return source.padStart(width, fill[0] ?? ' ');\n}"
...
describe('src/powershell/string/padleft.ts (tested in test/generated/powershell/string/padleft.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (padleft: typeof __locutus_source_fn) => {
      return padleft('42', 5)
    }
