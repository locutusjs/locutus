...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/powershell/string/lastindexof.ts').lastindexof
const __locutus_source_module_url = new URL("../../../../src/powershell/string/lastindexof.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "lastindexof"
...
const __locutus_standalone_ts_code = "// powershell/string/lastindexof (target function module)\nfunction lastindexof(needle, haystack, startIndex) {\n    //      discuss at: https://locutus.io/powershell/lastindexof/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lastindexof('o', 'Hello World')\n    //       returns 1: 7\n    //       example 2: lastindexof('x', 'Hello World')\n    //       returns 2: -1\n    //       example 3: lastindexof('o', 'Hello World', 6)\n    //       returns 3: 4\n    const source = String(haystack);\n    const search = String(needle);\n    if (startIndex === undefined) {\n        return source.lastIndexOf(search);\n    }\n    return source.lastIndexOf(search, Math.trunc(Number(startIndex)));\n}"
const __locutus_standalone_js_code = "// powershell/string/lastindexof (target function module)\nfunction lastindexof(needle, haystack, startIndex) {\n    //      discuss at: https://locutus.io/powershell/lastindexof/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lastindexof('o', 'Hello World')\n    //       returns 1: 7\n    //       example 2: lastindexof('x', 'Hello World')\n    //       returns 2: -1\n    //       example 3: lastindexof('o', 'Hello World', 6)\n    //       returns 3: 4\n    const source = String(haystack);\n    const search = String(needle);\n    if (startIndex === undefined) {\n        return source.lastIndexOf(search);\n    }\n    return source.lastIndexOf(search, Math.trunc(Number(startIndex)));\n}"
...
describe('src/powershell/string/lastindexof.ts (tested in test/generated/powershell/string/lastindexof.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (lastindexof: typeof __locutus_source_fn) => {
      return lastindexof('o', 'Hello World')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (lastindexof: typeof __locutus_source_fn) => {
      return lastindexof('x', 'Hello World')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
  ...
  it('should pass example 3', function () {
    ...
    const __locutus_run_example = (lastindexof: typeof __locutus_source_fn) => {
      return lastindexof('o', 'Hello World', 6)
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
