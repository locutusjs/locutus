...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/powershell/string/endswith.ts').endswith
const __locutus_source_module_url = new URL("../../../../src/powershell/string/endswith.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "endswith"
...
const __locutus_standalone_ts_code = "// powershell/string/endswith (target function module)\nfunction endswith(suffix, str) {\n    //      discuss at: https://locutus.io/powershell/endswith/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: endswith('World', 'Hello World')\n    //       returns 1: true\n    //       example 2: endswith('Hello', 'Hello World')\n    //       returns 2: false\n    return String(str).endsWith(String(suffix));\n}"
const __locutus_standalone_js_code = "// powershell/string/endswith (target function module)\nfunction endswith(suffix, str) {\n    //      discuss at: https://locutus.io/powershell/endswith/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: endswith('World', 'Hello World')\n    //       returns 1: true\n    //       example 2: endswith('Hello', 'Hello World')\n    //       returns 2: false\n    return String(str).endsWith(String(suffix));\n}"
...
describe('src/powershell/string/endswith.ts (tested in test/generated/powershell/string/endswith.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (endswith: typeof __locutus_source_fn) => {
      return endswith('World', 'Hello World')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (endswith: typeof __locutus_source_fn) => {
      return endswith('Hello', 'Hello World')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
