...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/powershell/string/startswith.ts').startswith
const __locutus_source_module_url = new URL("../../../../src/powershell/string/startswith.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "startswith"
...
const __locutus_standalone_ts_code = "// powershell/string/startswith (target function module)\nfunction startswith(prefix, str) {\n    //      discuss at: https://locutus.io/powershell/startswith/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: startswith('Hello', 'Hello World')\n    //       returns 1: true\n    //       example 2: startswith('World', 'Hello World')\n    //       returns 2: false\n    return String(str).startsWith(String(prefix));\n}"
const __locutus_standalone_js_code = "// powershell/string/startswith (target function module)\nfunction startswith(prefix, str) {\n    //      discuss at: https://locutus.io/powershell/startswith/\n    // parity verified: PowerShell 7.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: startswith('Hello', 'Hello World')\n    //       returns 1: true\n    //       example 2: startswith('World', 'Hello World')\n    //       returns 2: false\n    return String(str).startsWith(String(prefix));\n}"
...
describe('src/powershell/string/startswith.ts (tested in test/generated/powershell/string/startswith.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (startswith: typeof __locutus_source_fn) => {
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (startswith: typeof __locutus_source_fn) => {
      return startswith('World', 'Hello World')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
