...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/elixir/String/reverse.ts').reverse
const __locutus_source_module_url = new URL("../../../../src/elixir/String/reverse.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// elixir/String/reverse (target function module)\nfunction reverse(string) {\n    //      discuss at: https://locutus.io/elixir/reverse/\n    // parity verified: Elixir 1.18\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: reverse('hello')\n    //       returns 1: 'olleh'\n    //       example 2: reverse('abc')\n    //       returns 2: 'cba'\n    return String(string).split('').reverse().join('');\n}"
const __locutus_standalone_js_code = "// elixir/String/reverse (target function module)\nfunction reverse(string) {\n    //      discuss at: https://locutus.io/elixir/reverse/\n    // parity verified: Elixir 1.18\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: reverse('hello')\n    //       returns 1: 'olleh'\n    //       example 2: reverse('abc')\n    //       returns 2: 'cba'\n    return String(string).split('').reverse().join('');\n}"
...
describe('src/elixir/String/reverse.ts (tested in test/generated/elixir/String/reverse.vitest.ts)', function () {
