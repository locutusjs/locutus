...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/elixir/String/downcase.ts').downcase
const __locutus_source_module_url = new URL("../../../../src/elixir/String/downcase.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// elixir/String/downcase (target function module)\nfunction downcase(string) {\n    //      discuss at: https://locutus.io/elixir/downcase/\n    // parity verified: Elixir 1.18\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: downcase('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: downcase('Hello World')\n    //       returns 2: 'hello world'\n    return String(string).toLowerCase();\n}"
const __locutus_standalone_js_code = "// elixir/String/downcase (target function module)\nfunction downcase(string) {\n    //      discuss at: https://locutus.io/elixir/downcase/\n    // parity verified: Elixir 1.18\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: downcase('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: downcase('Hello World')\n    //       returns 2: 'hello world'\n    return String(string).toLowerCase();\n}"
