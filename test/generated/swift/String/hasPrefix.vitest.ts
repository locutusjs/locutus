...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/swift/String/hasPrefix.ts').hasPrefix
const __locutus_source_module_url = new URL("../../../../src/swift/String/hasPrefix.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// swift/String/hasPrefix (target function module)\nfunction hasPrefix(str, prefix) {\n    //  discuss at: https://locutus.io/swift/String/hasPrefix/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns true when str begins with prefix, like Swift hasPrefix(_:).\n    //   example 1: hasPrefix('Locutus', 'Loc')\n    //   returns 1: true\n    //   example 2: hasPrefix('Locutus', 'loc')\n    //   returns 2: false\n    //   example 3: hasPrefix('', '')\n    //   returns 3: true\n    return String(str).startsWith(String(prefix));\n}"
const __locutus_standalone_js_code = "// swift/String/hasPrefix (target function module)\nfunction hasPrefix(str, prefix) {\n    //  discuss at: https://locutus.io/swift/String/hasPrefix/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns true when str begins with prefix, like Swift hasPrefix(_:).\n    //   example 1: hasPrefix('Locutus', 'Loc')\n    //   returns 1: true\n    //   example 2: hasPrefix('Locutus', 'loc')\n    //   returns 2: false\n    //   example 3: hasPrefix('', '')\n    //   returns 3: true\n    return String(str).startsWith(String(prefix));\n}"
...
describe('src/swift/String/hasPrefix.ts (tested in test/generated/swift/String/hasPrefix.vitest.ts)', function () {
