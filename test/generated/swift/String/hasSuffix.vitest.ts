...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/swift/String/hasSuffix.ts').hasSuffix
const __locutus_source_module_url = new URL("../../../../src/swift/String/hasSuffix.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// swift/String/hasSuffix (target function module)\nfunction hasSuffix(str, suffix) {\n    //  discuss at: https://locutus.io/swift/String/hasSuffix/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns true when str ends with suffix, like Swift hasSuffix(_:).\n    //   example 1: hasSuffix('Locutus', 'tus')\n    //   returns 1: true\n    //   example 2: hasSuffix('Locutus', 'Tus')\n    //   returns 2: false\n    //   example 3: hasSuffix('', '')\n    //   returns 3: true\n    return String(str).endsWith(String(suffix));\n}"
const __locutus_standalone_js_code = "// swift/String/hasSuffix (target function module)\nfunction hasSuffix(str, suffix) {\n    //  discuss at: https://locutus.io/swift/String/hasSuffix/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns true when str ends with suffix, like Swift hasSuffix(_:).\n    //   example 1: hasSuffix('Locutus', 'tus')\n    //   returns 1: true\n    //   example 2: hasSuffix('Locutus', 'Tus')\n    //   returns 2: false\n    //   example 3: hasSuffix('', '')\n    //   returns 3: true\n    return String(str).endsWith(String(suffix));\n}"
...
describe('src/swift/String/hasSuffix.ts (tested in test/generated/swift/String/hasSuffix.vitest.ts)', function () {
