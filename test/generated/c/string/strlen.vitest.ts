...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/c/string/strlen.ts').strlen
const __locutus_source_module_url = new URL("../../../../src/c/string/strlen.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "strlen"
...
const __locutus_standalone_ts_code = "// c/string/strlen (target function module)\nfunction strlen(str) {\n    //      discuss at: https://locutus.io/c/string/strlen/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the length of the string.\n    //       example 1: strlen('hello')\n    //       returns 1: 5\n    //       example 2: strlen('')\n    //       returns 2: 0\n    return (str + '').length;\n}"
const __locutus_standalone_js_code = "// c/string/strlen (target function module)\nfunction strlen(str) {\n    //      discuss at: https://locutus.io/c/string/strlen/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the length of the string.\n    //       example 1: strlen('hello')\n    //       returns 1: 5\n    //       example 2: strlen('')\n    //       returns 2: 0\n    return (str + '').length;\n}"
...
describe('src/c/string/strlen.ts (tested in test/generated/c/string/strlen.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strlen: typeof __locutus_source_fn) => {
      return strlen('hello')
    }
