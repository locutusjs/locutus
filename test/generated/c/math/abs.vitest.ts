...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/c/math/abs.ts').abs
const __locutus_source_module_url = new URL("../../../../src/c/math/abs.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// c/math/abs (target function module)\nfunction abs(mixedNumber) {\n    //      discuss at: https://locutus.io/c/abs/\n    // parity verified: C 23\n    //     original by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //     improved by: Karol Kowalski\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Jonas Raoni Soares Silva (https://www.jsfromhell.com)\n    //       example 1: abs(-5)\n    //       returns 1: 5\n    //       example 2: abs(-42)\n    //       returns 2: 42\n    //       example 3: abs(0)\n    //       returns 3: 0\n    return Math.abs(mixedNumber) || 0;\n}"
const __locutus_standalone_js_code = "// c/math/abs (target function module)\nfunction abs(mixedNumber) {\n    //      discuss at: https://locutus.io/c/abs/\n    // parity verified: C 23\n    //     original by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //     improved by: Karol Kowalski\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Jonas Raoni Soares Silva (https://www.jsfromhell.com)\n    //       example 1: abs(-5)\n    //       returns 1: 5\n    //       example 2: abs(-42)\n    //       returns 2: 42\n    //       example 3: abs(0)\n    //       returns 3: 0\n    return Math.abs(mixedNumber) || 0;\n}"
...
describe('src/c/math/abs.ts (tested in test/generated/c/math/abs.vitest.ts)', function () {
