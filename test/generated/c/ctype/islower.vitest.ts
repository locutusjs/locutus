...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/c/ctype/islower.ts').islower
const __locutus_source_module_url = new URL("../../../../src/c/ctype/islower.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "islower"
...
const __locutus_standalone_ts_code = "// c/ctype/islower (target function module)\nfunction islower(c) {\n    //      discuss at: https://locutus.io/c/ctype/islower/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Checks if the character is a lowercase letter (a-z).\n    //       example 1: islower('a')\n    //       returns 1: true\n    //       example 2: islower('A')\n    //       returns 2: false\n    //       example 3: islower('5')\n    //       returns 3: false\n    c = (c + '').charAt(0);\n    return /^[a-z]$/.test(c);\n}"
const __locutus_standalone_js_code = "// c/ctype/islower (target function module)\nfunction islower(c) {\n    //      discuss at: https://locutus.io/c/ctype/islower/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Checks if the character is a lowercase letter (a-z).\n    //       example 1: islower('a')\n    //       returns 1: true\n    //       example 2: islower('A')\n    //       returns 2: false\n    //       example 3: islower('5')\n    //       returns 3: false\n    c = (c + '').charAt(0);\n    return /^[a-z]$/.test(c);\n}"
...
describe('src/c/ctype/islower.ts (tested in test/generated/c/ctype/islower.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (islower: typeof __locutus_source_fn) => {
      return islower('a')
    }
