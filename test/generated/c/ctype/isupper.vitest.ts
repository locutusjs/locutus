...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/c/ctype/isupper.ts').isupper
const __locutus_source_module_url = new URL("../../../../src/c/ctype/isupper.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "isupper"
...
const __locutus_standalone_ts_code = "// c/ctype/isupper (target function module)\nfunction isupper(c) {\n    //      discuss at: https://locutus.io/c/ctype/isupper/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Checks if the character is an uppercase letter (A-Z).\n    //       example 1: isupper('A')\n    //       returns 1: true\n    //       example 2: isupper('a')\n    //       returns 2: false\n    //       example 3: isupper('5')\n    //       returns 3: false\n    c = (c + '').charAt(0);\n    return /^[A-Z]$/.test(c);\n}"
const __locutus_standalone_js_code = "// c/ctype/isupper (target function module)\nfunction isupper(c) {\n    //      discuss at: https://locutus.io/c/ctype/isupper/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Checks if the character is an uppercase letter (A-Z).\n    //       example 1: isupper('A')\n    //       returns 1: true\n    //       example 2: isupper('a')\n    //       returns 2: false\n    //       example 3: isupper('5')\n    //       returns 3: false\n    c = (c + '').charAt(0);\n    return /^[A-Z]$/.test(c);\n}"
...
describe('src/c/ctype/isupper.ts (tested in test/generated/c/ctype/isupper.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (isupper: typeof __locutus_source_fn) => {
      return isupper('A')
    }
