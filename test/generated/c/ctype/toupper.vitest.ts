...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/c/ctype/toupper.ts').toupper
const __locutus_source_module_url = new URL("../../../../src/c/ctype/toupper.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// c/ctype/toupper (target function module)\nfunction toupper(c) {\n    //      discuss at: https://locutus.io/c/ctype/toupper/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts a lowercase letter to uppercase.\n    //       example 1: toupper('a')\n    //       returns 1: 'A'\n    //       example 2: toupper('A')\n    //       returns 2: 'A'\n    //       example 3: toupper('5')\n    //       returns 3: '5'\n    c = (c + '').charAt(0);\n    return c.toUpperCase();\n}"
const __locutus_standalone_js_code = "// c/ctype/toupper (target function module)\nfunction toupper(c) {\n    //      discuss at: https://locutus.io/c/ctype/toupper/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts a lowercase letter to uppercase.\n    //       example 1: toupper('a')\n    //       returns 1: 'A'\n    //       example 2: toupper('A')\n    //       returns 2: 'A'\n    //       example 3: toupper('5')\n    //       returns 3: '5'\n    c = (c + '').charAt(0);\n    return c.toUpperCase();\n}"
