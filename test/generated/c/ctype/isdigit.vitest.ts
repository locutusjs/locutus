...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/c/ctype/isdigit.ts').isdigit
const __locutus_source_module_url = new URL("../../../../src/c/ctype/isdigit.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "isdigit"
...
const __locutus_standalone_ts_code = "// c/ctype/isdigit (target function module)\nfunction isdigit(c) {\n    //      discuss at: https://locutus.io/c/ctype/isdigit/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Checks if the character is a decimal digit (0-9).\n    //       example 1: isdigit('5')\n    //       returns 1: true\n    //       example 2: isdigit('0')\n    //       returns 2: true\n    //       example 3: isdigit('A')\n    //       returns 3: false\n    c = (c + '').charAt(0);\n    return /^[0-9]$/.test(c);\n}"
const __locutus_standalone_js_code = "// c/ctype/isdigit (target function module)\nfunction isdigit(c) {\n    //      discuss at: https://locutus.io/c/ctype/isdigit/\n    // parity verified: C 23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Checks if the character is a decimal digit (0-9).\n    //       example 1: isdigit('5')\n    //       returns 1: true\n    //       example 2: isdigit('0')\n    //       returns 2: true\n    //       example 3: isdigit('A')\n    //       returns 3: false\n    c = (c + '').charAt(0);\n    return /^[0-9]$/.test(c);\n}"
...
describe('src/c/ctype/isdigit.ts (tested in test/generated/c/ctype/isdigit.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (isdigit: typeof __locutus_source_fn) => {
      return isdigit('5')
    }
