...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/String/include.ts').include
const __locutus_source_module_url = new URL("../../../../src/ruby/String/include.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "include"
...
const __locutus_standalone_ts_code = "// ruby/String/include (target function module)\nfunction include(str, other) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/include/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns true if str contains the given string other.\n    //       example 1: include('hello', 'lo')\n    //       returns 1: true\n    //       example 2: include('hello', 'ol')\n    //       returns 2: false\n    return (str + '').indexOf(other + '') !== -1;\n}"
const __locutus_standalone_js_code = "// ruby/String/include (target function module)\nfunction include(str, other) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/include/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns true if str contains the given string other.\n    //       example 1: include('hello', 'lo')\n    //       returns 1: true\n    //       example 2: include('hello', 'ol')\n    //       returns 2: false\n    return (str + '').indexOf(other + '') !== -1;\n}"
...
describe('src/ruby/String/include.ts (tested in test/generated/ruby/String/include.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (include: typeof __locutus_source_fn) => {
      return include('hello', 'lo')
    }
