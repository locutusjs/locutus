...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/String/length.ts').length
const __locutus_source_module_url = new URL("../../../../src/ruby/String/length.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/String/length (target function module)\nfunction length(str) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/length/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the character length of str.\n    //       example 1: length('hello')\n    //       returns 1: 5\n    //       example 2: length('')\n    //       returns 2: 0\n    return (str + '').length;\n}"
const __locutus_standalone_js_code = "// ruby/String/length (target function module)\nfunction length(str) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/length/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the character length of str.\n    //       example 1: length('hello')\n    //       returns 1: 5\n    //       example 2: length('')\n    //       returns 2: 0\n    return (str + '').length;\n}"
