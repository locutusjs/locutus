...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/String/reverse.ts').reverse
const __locutus_source_module_url = new URL("../../../../src/ruby/String/reverse.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/String/reverse (target function module)\nfunction reverse(str) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/reverse/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns a new string with the characters from str in reverse order.\n    //       example 1: reverse('stressed')\n    //       returns 1: 'desserts'\n    //       example 2: reverse('a')\n    //       returns 2: 'a'\n    return (str + '').split('').reverse().join('');\n}"
const __locutus_standalone_js_code = "// ruby/String/reverse (target function module)\nfunction reverse(str) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/reverse/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns a new string with the characters from str in reverse order.\n    //       example 1: reverse('stressed')\n    //       returns 1: 'desserts'\n    //       example 2: reverse('a')\n    //       returns 2: 'a'\n    return (str + '').split('').reverse().join('');\n}"
