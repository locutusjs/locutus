...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/String/delete_suffix.ts').delete_suffix
const __locutus_source_module_url = new URL("../../../../src/ruby/String/delete_suffix.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "delete_suffix"
...
const __locutus_standalone_ts_code = "// ruby/String/delete_suffix (target function module)\nfunction delete_suffix(str, suffix) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/delete_suffix/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Removes suffix when present and otherwise returns the original string unchanged.\n    //       example 1: delete_suffix('value-suffix', '-suffix')\n    //       returns 1: 'value'\n    //       example 2: delete_suffix('value', 'x')\n    //       returns 2: 'value'\n    const input = str + '';\n    const needle = suffix + '';\n    if (needle === '') {\n        return input;\n    }\n    return input.endsWith(needle) ? input.slice(0, -needle.length) : input;\n}"
const __locutus_standalone_js_code = "// ruby/String/delete_suffix (target function module)\nfunction delete_suffix(str, suffix) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/String/delete_suffix/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Removes suffix when present and otherwise returns the original string unchanged.\n    //       example 1: delete_suffix('value-suffix', '-suffix')\n    //       returns 1: 'value'\n    //       example 2: delete_suffix('value', 'x')\n    //       returns 2: 'value'\n    const input = str + '';\n    const needle = suffix + '';\n    if (needle === '') {\n        return input;\n    }\n    return input.endsWith(needle) ? input.slice(0, -needle.length) : input;\n}"
...
describe('src/ruby/String/delete_suffix.ts (tested in test/generated/ruby/String/delete_suffix.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (delete_suffix: typeof __locutus_source_fn) => {
      return delete_suffix('value-suffix', '-suffix')
    }
