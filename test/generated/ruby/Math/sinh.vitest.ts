...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/sinh.ts').sinh
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/sinh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/sinh (target function module)\nfunction sinh(x) {\n    //      discuss at: https://locutus.io/ruby/Math/sinh/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sinh(0)\n    //       returns 1: 0\n    //       example 2: sinh(1)\n    //       returns 2: 1.1752011936438014\n    return Math.sinh(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/sinh (target function module)\nfunction sinh(x) {\n    //      discuss at: https://locutus.io/ruby/Math/sinh/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sinh(0)\n    //       returns 1: 0\n    //       example 2: sinh(1)\n    //       returns 2: 1.1752011936438014\n    return Math.sinh(x);\n}"
...
describe('src/ruby/Math/sinh.ts (tested in test/generated/ruby/Math/sinh.vitest.ts)', function () {
