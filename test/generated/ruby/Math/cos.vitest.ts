...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/cos.ts').cos
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/cos.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/cos (target function module)\nfunction cos(x) {\n    //      discuss at: https://locutus.io/ruby/Math/cos/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Precision may vary across platforms\n    //       example 1: cos(0)\n    //       returns 1: 1\n    //       example 2: cos(1)\n    //       returns 2: 0.5403023058681398\n    return Math.cos(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/cos (target function module)\nfunction cos(x) {\n    //      discuss at: https://locutus.io/ruby/Math/cos/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Precision may vary across platforms\n    //       example 1: cos(0)\n    //       returns 1: 1\n    //       example 2: cos(1)\n    //       returns 2: 0.5403023058681398\n    return Math.cos(x);\n}"
