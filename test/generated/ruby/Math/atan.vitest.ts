...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/atan.ts').atan
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/atan.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/atan (target function module)\nfunction atan(x) {\n    //      discuss at: https://locutus.io/ruby/Math/atan/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: atan(0)\n    //       returns 1: 0\n    //       example 2: atan(1)\n    //       returns 2: 0.7853981633974483\n    return Math.atan(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/atan (target function module)\nfunction atan(x) {\n    //      discuss at: https://locutus.io/ruby/Math/atan/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: atan(0)\n    //       returns 1: 0\n    //       example 2: atan(1)\n    //       returns 2: 0.7853981633974483\n    return Math.atan(x);\n}"
