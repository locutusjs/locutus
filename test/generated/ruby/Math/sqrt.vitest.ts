...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/sqrt.ts').sqrt
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/sqrt.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/sqrt (target function module)\nfunction sqrt(x) {\n    //      discuss at: https://locutus.io/ruby/Math/sqrt/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sqrt(4)\n    //       returns 1: 2\n    //       example 2: sqrt(9)\n    //       returns 2: 3\n    //       example 3: sqrt(2)\n    //       returns 3: 1.4142135623730951\n    return Math.sqrt(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/sqrt (target function module)\nfunction sqrt(x) {\n    //      discuss at: https://locutus.io/ruby/Math/sqrt/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sqrt(4)\n    //       returns 1: 2\n    //       example 2: sqrt(9)\n    //       returns 2: 3\n    //       example 3: sqrt(2)\n    //       returns 3: 1.4142135623730951\n    return Math.sqrt(x);\n}"
