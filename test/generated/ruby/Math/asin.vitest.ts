...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/asin.ts').asin
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/asin.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/asin (target function module)\nfunction asin(x) {\n    //      discuss at: https://locutus.io/ruby/Math/asin/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: asin(0)\n    //       returns 1: 0\n    //       example 2: asin(1)\n    //       returns 2: 1.5707963267948966\n    return Math.asin(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/asin (target function module)\nfunction asin(x) {\n    //      discuss at: https://locutus.io/ruby/Math/asin/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: asin(0)\n    //       returns 1: 0\n    //       example 2: asin(1)\n    //       returns 2: 1.5707963267948966\n    return Math.asin(x);\n}"
