...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/log.ts').log
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/log.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/log (target function module)\nfunction log(x) {\n    //      discuss at: https://locutus.io/ruby/Math/log/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: log(1)\n    //       returns 1: 0\n    //       example 2: log(2.718281828459045)\n    //       returns 2: 1\n    return Math.log(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/log (target function module)\nfunction log(x) {\n    //      discuss at: https://locutus.io/ruby/Math/log/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: log(1)\n    //       returns 1: 0\n    //       example 2: log(2.718281828459045)\n    //       returns 2: 1\n    return Math.log(x);\n}"
