...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Math/tanh.ts').tanh
const __locutus_source_module_url = new URL("../../../../src/ruby/Math/tanh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// ruby/Math/tanh (target function module)\nfunction tanh(x) {\n    //      discuss at: https://locutus.io/ruby/Math/tanh/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tanh(0)\n    //       returns 1: 0\n    //       example 2: tanh(1)\n    //       returns 2: 0.7615941559557649\n    return Math.tanh(x);\n}"
const __locutus_standalone_js_code = "// ruby/Math/tanh (target function module)\nfunction tanh(x) {\n    //      discuss at: https://locutus.io/ruby/Math/tanh/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tanh(0)\n    //       returns 1: 0\n    //       example 2: tanh(1)\n    //       returns 2: 0.7615941559557649\n    return Math.tanh(x);\n}"
...
describe('src/ruby/Math/tanh.ts (tested in test/generated/ruby/Math/tanh.vitest.ts)', function () {
