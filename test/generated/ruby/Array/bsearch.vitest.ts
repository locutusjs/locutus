...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Array/bsearch.ts').bsearch
const __locutus_source_module_url = new URL("../../../../src/ruby/Array/bsearch.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "bsearch"
...
const __locutus_standalone_ts_code = "function bsearch(values, callback) {\n    //      discuss at: https://locutus.io/ruby/Array/bsearch/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Supports Ruby's boolean \"find minimum\" mode and numeric \"find any exact match\" mode.\n    //          note 2: In numeric mode, positive means search right, negative means search left, and zero means match.\n    //       example 1: bsearch([1, 3, 4, 6, 8], (value) => value >= 4)\n    //       returns 1: 4\n    //       example 2: bsearch([1, 3, 4, 6, 8], (value) => (value === 4 ? 0 : 4 > value ? 1 : -1))\n    //       returns 2: 4\n    //       example 3: bsearch([1, 3, 4, 6, 8], (value) => (value === 5 ? 0 : 5 > value ? 1 : -1))\n    //       returns 3: null\n    if (typeof callback !== 'function') {\n        throw new TypeError('bsearch(): callback must be a function');\n    }\n    if (!Array.isArray(values) || values.length === 0) {\n        return null;\n    }\n    let low = 0;\n    let high = values.length - 1;\n    let candidateIndex = null;\n    let mode = null;\n    while (low <= high) {\n        const mid = low + Math.floor((high - low) / 2);\n        const value = values[mid];\n        const result = callback(value, mid, values);\n        if (typeof result === 'number') {\n            if (mode === 'boolean') {\n                throw new TypeError('bsearch(): callback must consistently return booleans or numbers');\n            }\n            mode = 'numeric';\n            if (result === 0) {\n                return value;\n            }\n            if (result > 0) {\n                low = mid + 1;\n            }\n            else {\n                high = mid - 1;\n            }\n            continue;\n        }\n        if (mode === 'numeric') {\n            throw new TypeError('bsearch(): callback must consistently return booleans or numbers');\n        }\n        mode = 'boolean';\n        if (result) {\n            candidateIndex = mid;\n            high = mid - 1;\n        }\n        else {\n            low = mid + 1;\n        }\n    }\n    return candidateIndex === null ? null : values[candidateIndex];\n}"
const __locutus_standalone_js_code = "// ruby/Array/bsearch (target function module)\nfunction bsearch(values, callback) {\n    //      discuss at: https://locutus.io/ruby/Array/bsearch/\n    // parity verified: Ruby 3.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Supports Ruby's boolean \"find minimum\" mode and numeric \"find any exact match\" mode.\n    //          note 2: In numeric mode, positive means search right, negative means search left, and zero means match.\n    //       example 1: bsearch([1, 3, 4, 6, 8], (value) => value >= 4)\n    //       returns 1: 4\n    //       example 2: bsearch([1, 3, 4, 6, 8], (value) => (value === 4 ? 0 : 4 > value ? 1 : -1))\n    //       returns 2: 4\n    //       example 3: bsearch([1, 3, 4, 6, 8], (value) => (value === 5 ? 0 : 5 > value ? 1 : -1))\n    //       returns 3: null\n    if (typeof callback !== 'function') {\n        throw new TypeError('bsearch(): callback must be a function');\n    }\n    if (!Array.isArray(values) || values.length === 0) {\n        return null;\n    }\n    let low = 0;\n    let high = values.length - 1;\n    let candidateIndex = null;\n    let mode = null;\n    while (low <= high) {\n        const mid = low + Math.floor((high - low) / 2);\n        const value = values[mid];\n        const result = callback(value, mid, values);\n        if (typeof result === 'number') {\n            if (mode === 'boolean') {\n                throw new TypeError('bsearch(): callback must consistently return booleans or numbers');\n            }\n            mode = 'numeric';\n            if (result === 0) {\n                return value;\n            }\n            if (result > 0) {\n                low = mid + 1;\n            }\n            else {\n                high = mid - 1;\n            }\n            continue;\n        }\n        if (mode === 'numeric') {\n            throw new TypeError('bsearch(): callback must consistently return booleans or numbers');\n        }\n        mode = 'boolean';\n        if (result) {\n            candidateIndex = mid;\n            high = mid - 1;\n        }\n        else {\n            low = mid + 1;\n        }\n    }\n    return candidateIndex === null ? null : values[candidateIndex];\n}"
...
describe('src/ruby/Array/bsearch.ts (tested in test/generated/ruby/Array/bsearch.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (bsearch: typeof __locutus_source_fn) => {
      return bsearch([1, 3, 4, 6, 8], (value) => value >= 4)
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (bsearch: typeof __locutus_source_fn) => {
      return bsearch([1, 3, 4, 6, 8], (value) => (value === 4 ? 0 : 4 > value ? 1 : -1))
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
  ...
  it('should pass example 3', function () {
    ...
    const __locutus_run_example = (bsearch: typeof __locutus_source_fn) => {
      return bsearch([1, 3, 4, 6, 8], (value) => (value === 5 ? 0 : 5 > value ? 1 : -1))
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
