...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/ruby/Array/uniq.ts').uniq
const __locutus_source_module_url = new URL("../../../../src/ruby/Array/uniq.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "uniq"
...
const __locutus_standalone_ts_code = "// ruby/Array/uniq (target function module)\nfunction uniq(arr) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/Array/uniq/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns a new array with duplicate values removed.\n    //       example 1: uniq([1, 2, 2, 3, 3, 3])\n    //       returns 1: [1, 2, 3]\n    //       example 2: uniq(['a', 'b', 'a', 'c', 'b'])\n    //       returns 2: ['a', 'b', 'c']\n    if (!Array.isArray(arr)) {\n        return [];\n    }\n    return [...new Set(arr)];\n}"
const __locutus_standalone_js_code = "// ruby/Array/uniq (target function module)\nfunction uniq(arr) {\n    // parity verified: Ruby 3.3\n    //      discuss at: https://locutus.io/ruby/Array/uniq/\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns a new array with duplicate values removed.\n    //       example 1: uniq([1, 2, 2, 3, 3, 3])\n    //       returns 1: [1, 2, 3]\n    //       example 2: uniq(['a', 'b', 'a', 'c', 'b'])\n    //       returns 2: ['a', 'b', 'c']\n    if (!Array.isArray(arr)) {\n        return [];\n    }\n    return [...new Set(arr)];\n}"
...
describe('src/ruby/Array/uniq.ts (tested in test/generated/ruby/Array/uniq.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (uniq: typeof __locutus_source_fn) => {
      return uniq([1, 2, 2, 3, 3, 3])
    }
