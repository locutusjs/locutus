...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/replace.ts').replace
const __locutus_source_module_url = new URL("../../../../src/rust/str/replace.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// rust/str/replace (target function module)\nfunction replace(str, search, replacement) {\n    //      discuss at: https://locutus.io/rust/replace/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: replace('Hello World World', 'World', 'Locutus')\n    //       returns 1: 'Hello Locutus Locutus'\n    //       example 2: replace('a+b+c', '+', '-')\n    //       returns 2: 'a-b-c'\n    return String(str).replaceAll(String(search), String(replacement));\n}"
const __locutus_standalone_js_code = "// rust/str/replace (target function module)\nfunction replace(str, search, replacement) {\n    //      discuss at: https://locutus.io/rust/replace/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: replace('Hello World World', 'World', 'Locutus')\n    //       returns 1: 'Hello Locutus Locutus'\n    //       example 2: replace('a+b+c', '+', '-')\n    //       returns 2: 'a-b-c'\n    return String(str).replaceAll(String(search), String(replacement));\n}"
...
describe('src/rust/str/replace.ts (tested in test/generated/rust/str/replace.vitest.ts)', function () {
