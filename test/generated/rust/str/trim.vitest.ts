...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/trim.ts').trim
const __locutus_source_module_url = new URL("../../../../src/rust/str/trim.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// rust/str/trim (target function module)\nfunction trim(str) {\n    //      discuss at: https://locutus.io/rust/trim/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim('  hello  ')\n    //       returns 1: 'hello'\n    //       example 2: trim('\\n\\thello\\t\\n')\n    //       returns 2: 'hello'\n    return String(str).trim();\n}"
const __locutus_standalone_js_code = "// rust/str/trim (target function module)\nfunction trim(str) {\n    //      discuss at: https://locutus.io/rust/trim/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim('  hello  ')\n    //       returns 1: 'hello'\n    //       example 2: trim('\\n\\thello\\t\\n')\n    //       returns 2: 'hello'\n    return String(str).trim();\n}"
...
describe('src/rust/str/trim.ts (tested in test/generated/rust/str/trim.vitest.ts)', function () {
