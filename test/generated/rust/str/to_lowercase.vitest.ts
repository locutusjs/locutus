...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/to_lowercase.ts').to_lowercase
const __locutus_source_module_url = new URL("../../../../src/rust/str/to_lowercase.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "to_lowercase"
...
const __locutus_standalone_ts_code = "// rust/str/to_lowercase (target function module)\nfunction to_lowercase(str) {\n    //      discuss at: https://locutus.io/rust/to_lowercase/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: to_lowercase('HELLO WORLD')\n    //       returns 1: 'hello world'\n    //       example 2: to_lowercase('Locutus')\n    //       returns 2: 'locutus'\n    return String(str).toLowerCase();\n}"
const __locutus_standalone_js_code = "// rust/str/to_lowercase (target function module)\nfunction to_lowercase(str) {\n    //      discuss at: https://locutus.io/rust/to_lowercase/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: to_lowercase('HELLO WORLD')\n    //       returns 1: 'hello world'\n    //       example 2: to_lowercase('Locutus')\n    //       returns 2: 'locutus'\n    return String(str).toLowerCase();\n}"
...
describe('src/rust/str/to_lowercase.ts (tested in test/generated/rust/str/to_lowercase.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (to_lowercase: typeof __locutus_source_fn) => {
      return to_lowercase('HELLO WORLD')
    }
