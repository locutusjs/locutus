...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/trim_end.ts').trim_end
const __locutus_source_module_url = new URL("../../../../src/rust/str/trim_end.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "trim_end"
...
const __locutus_standalone_ts_code = "// rust/str/trim_end (target function module)\nfunction trim_end(str) {\n    //      discuss at: https://locutus.io/rust/trim_end/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim_end('  hello  ')\n    //       returns 1: '  hello'\n    //       example 2: trim_end('hello\\t\\n')\n    //       returns 2: 'hello'\n    return String(str).trimEnd();\n}"
const __locutus_standalone_js_code = "// rust/str/trim_end (target function module)\nfunction trim_end(str) {\n    //      discuss at: https://locutus.io/rust/trim_end/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim_end('  hello  ')\n    //       returns 1: '  hello'\n    //       example 2: trim_end('hello\\t\\n')\n    //       returns 2: 'hello'\n    return String(str).trimEnd();\n}"
...
describe('src/rust/str/trim_end.ts (tested in test/generated/rust/str/trim_end.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (trim_end: typeof __locutus_source_fn) => {
