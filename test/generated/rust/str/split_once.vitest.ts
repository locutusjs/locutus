...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/split_once.ts').split_once
const __locutus_source_module_url = new URL("../../../../src/rust/str/split_once.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "split_once"
...
const __locutus_standalone_ts_code = "// rust/str/split_once (target function module)\nfunction split_once(delimiter, str) {\n    //      discuss at: https://locutus.io/rust/split_once/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Splits string on first delimiter occurrence and returns [left, right] or null.\n    //       example 1: split_once('=', 'a=b=c')\n    //       returns 1: ['a', 'b=c']\n    //       example 2: split_once('::', 'x::y')\n    //       returns 2: ['x', 'y']\n    //       example 3: split_once(':', 'abc')\n    //       returns 3: null\n    const haystack = String(str);\n    const needle = String(delimiter);\n    if (needle === '') {\n        return ['', haystack];\n    }\n    const index = haystack.indexOf(needle);\n    if (index < 0) {\n        return null;\n    }\n    return [haystack.slice(0, index), haystack.slice(index + needle.length)];\n}"
const __locutus_standalone_js_code = "// rust/str/split_once (target function module)\nfunction split_once(delimiter, str) {\n    //      discuss at: https://locutus.io/rust/split_once/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Splits string on first delimiter occurrence and returns [left, right] or null.\n    //       example 1: split_once('=', 'a=b=c')\n    //       returns 1: ['a', 'b=c']\n    //       example 2: split_once('::', 'x::y')\n    //       returns 2: ['x', 'y']\n    //       example 3: split_once(':', 'abc')\n    //       returns 3: null\n    const haystack = String(str);\n    const needle = String(delimiter);\n    if (needle === '') {\n        return ['', haystack];\n    }\n    const index = haystack.indexOf(needle);\n    if (index < 0) {\n        return null;\n    }\n    return [haystack.slice(0, index), haystack.slice(index + needle.length)];\n}"
...
describe('src/rust/str/split_once.ts (tested in test/generated/rust/str/split_once.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (split_once: typeof __locutus_source_fn) => {
      return split_once('=', 'a=b=c')
    }
