...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/starts_with.ts').starts_with
const __locutus_source_module_url = new URL("../../../../src/rust/str/starts_with.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "starts_with"
...
const __locutus_standalone_ts_code = "// rust/str/starts_with (target function module)\nfunction starts_with(prefix, str) {\n    //      discuss at: https://locutus.io/rust/starts_with/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: starts_with('Hello', 'Hello World')\n    //       returns 1: true\n    //       example 2: starts_with('World', 'Hello World')\n    //       returns 2: false\n    return String(str).startsWith(String(prefix));\n}"
const __locutus_standalone_js_code = "// rust/str/starts_with (target function module)\nfunction starts_with(prefix, str) {\n    //      discuss at: https://locutus.io/rust/starts_with/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: starts_with('Hello', 'Hello World')\n    //       returns 1: true\n    //       example 2: starts_with('World', 'Hello World')\n    //       returns 2: false\n    return String(str).startsWith(String(prefix));\n}"
...
describe('src/rust/str/starts_with.ts (tested in test/generated/rust/str/starts_with.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (starts_with: typeof __locutus_source_fn) => {
      return starts_with('Hello', 'Hello World')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (starts_with: typeof __locutus_source_fn) => {
      return starts_with('World', 'Hello World')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
