...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/rfind.ts').rfind
const __locutus_source_module_url = new URL("../../../../src/rust/str/rfind.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "rfind"
...
const __locutus_standalone_ts_code = "// rust/str/rfind (target function module)\nfunction rfind(needle, haystack) {\n    //      discuss at: https://locutus.io/rust/rfind/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: rfind('l', 'Hello World')\n    //       returns 1: 9\n    //       example 2: rfind('x', 'Hello World')\n    //       returns 2: -1\n    return String(haystack).lastIndexOf(String(needle));\n}"
const __locutus_standalone_js_code = "// rust/str/rfind (target function module)\nfunction rfind(needle, haystack) {\n    //      discuss at: https://locutus.io/rust/rfind/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: rfind('l', 'Hello World')\n    //       returns 1: 9\n    //       example 2: rfind('x', 'Hello World')\n    //       returns 2: -1\n    return String(haystack).lastIndexOf(String(needle));\n}"
...
describe('src/rust/str/rfind.ts (tested in test/generated/rust/str/rfind.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (rfind: typeof __locutus_source_fn) => {
      return rfind('l', 'Hello World')
    }
