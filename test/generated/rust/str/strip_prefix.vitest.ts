...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/rust/str/strip_prefix.ts').strip_prefix
const __locutus_source_module_url = new URL("../../../../src/rust/str/strip_prefix.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "strip_prefix"
...
const __locutus_standalone_ts_code = "// rust/str/strip_prefix (target function module)\nfunction strip_prefix(prefix, str) {\n    //      discuss at: https://locutus.io/rust/strip_prefix/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the remainder after the first matching prefix, or null when the prefix is absent.\n    //       example 1: strip_prefix('foo:', 'foo:bar')\n    //       returns 1: 'bar'\n    //       example 2: strip_prefix('bar', 'foo:bar')\n    //       returns 2: null\n    //       example 3: strip_prefix('', 'abc')\n    //       returns 3: 'abc'\n    const source = String(str);\n    const value = String(prefix);\n    if (!source.startsWith(value)) {\n        return null;\n    }\n    return source.slice(value.length);\n}"
const __locutus_standalone_js_code = "// rust/str/strip_prefix (target function module)\nfunction strip_prefix(prefix, str) {\n    //      discuss at: https://locutus.io/rust/strip_prefix/\n    // parity verified: Rust 1.85\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the remainder after the first matching prefix, or null when the prefix is absent.\n    //       example 1: strip_prefix('foo:', 'foo:bar')\n    //       returns 1: 'bar'\n    //       example 2: strip_prefix('bar', 'foo:bar')\n    //       returns 2: null\n    //       example 3: strip_prefix('', 'abc')\n    //       returns 3: 'abc'\n    const source = String(str);\n    const value = String(prefix);\n    if (!source.startsWith(value)) {\n        return null;\n    }\n    return source.slice(value.length);\n}"
...
describe('src/rust/str/strip_prefix.ts (tested in test/generated/rust/str/strip_prefix.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strip_prefix: typeof __locutus_source_fn) => {
      return strip_prefix('foo:', 'foo:bar')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (strip_prefix: typeof __locutus_source_fn) => {
      return strip_prefix('bar', 'foo:bar')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
