...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/kotlin/collections/windowed.ts').windowed
const __locutus_source_module_url = new URL("../../../../src/kotlin/collections/windowed.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "windowed"
...
const __locutus_standalone_ts_code = "// kotlin/collections/windowed (target function module)\nfunction windowed(values, size, step = 1, partialWindows = false) {\n    //  discuss at: https://locutus.io/kotlin/collections/windowed/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Produces sliding windows over values, similar to Kotlin's windowed(size, step, partialWindows).\n    //   example 1: windowed([1, 2, 3, 4, 5], 3)\n    //   returns 1: [[1, 2, 3], [2, 3, 4], [3, 4, 5]]\n    //   example 2: windowed([1, 2, 3, 4, 5], 3, 2)\n    //   returns 2: [[1, 2, 3], [3, 4, 5]]\n    //   example 3: windowed([1, 2, 3, 4, 5], 3, 2, true)\n    //   returns 3: [[1, 2, 3], [3, 4, 5], [5]]\n    if (!Array.isArray(values)) {\n        return [];\n    }\n    const width = Math.trunc(Number(size));\n    const stride = Math.trunc(Number(step));\n    if (!Number.isFinite(width) || width <= 0) {\n        throw new RangeError('windowed(): size must be a positive integer');\n    }\n    if (!Number.isFinite(stride) || stride <= 0) {\n        throw new RangeError('windowed(): step must be a positive integer');\n    }\n    const out = [];\n    for (let i = 0; i < values.length; i += stride) {\n        const window = values.slice(i, i + width);\n        if (window.length === width || (partialWindows && window.length > 0)) {\n            out.push(window);\n        }\n    }\n    return out;\n}"
const __locutus_standalone_js_code = "// kotlin/collections/windowed (target function module)\nfunction windowed(values, size, step = 1, partialWindows = false) {\n    //  discuss at: https://locutus.io/kotlin/collections/windowed/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Produces sliding windows over values, similar to Kotlin's windowed(size, step, partialWindows).\n    //   example 1: windowed([1, 2, 3, 4, 5], 3)\n    //   returns 1: [[1, 2, 3], [2, 3, 4], [3, 4, 5]]\n    //   example 2: windowed([1, 2, 3, 4, 5], 3, 2)\n    //   returns 2: [[1, 2, 3], [3, 4, 5]]\n    //   example 3: windowed([1, 2, 3, 4, 5], 3, 2, true)\n    //   returns 3: [[1, 2, 3], [3, 4, 5], [5]]\n    if (!Array.isArray(values)) {\n        return [];\n    }\n    const width = Math.trunc(Number(size));\n    const stride = Math.trunc(Number(step));\n    if (!Number.isFinite(width) || width <= 0) {\n        throw new RangeError('windowed(): size must be a positive integer');\n    }\n    if (!Number.isFinite(stride) || stride <= 0) {\n        throw new RangeError('windowed(): step must be a positive integer');\n    }\n    const out = [];\n    for (let i = 0; i < values.length; i += stride) {\n        const window = values.slice(i, i + width);\n        if (window.length === width || (partialWindows && window.length > 0)) {\n            out.push(window);\n        }\n    }\n    return out;\n}"
...
describe('src/kotlin/collections/windowed.ts (tested in test/generated/kotlin/collections/windowed.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (windowed: typeof __locutus_source_fn) => {
      return windowed([1, 2, 3, 4, 5], 3)
    }
  ...
  it('should pass example 3', function () {
    ...
    const __locutus_run_example = (windowed: typeof __locutus_source_fn) => {
      return windowed([1, 2, 3, 4, 5], 3, 2, true)
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
