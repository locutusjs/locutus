...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/clojure/string/trim.ts').trim
const __locutus_source_module_url = new URL("../../../../src/clojure/string/trim.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// clojure/string/trim (target function module)\nfunction trim(s) {\n    //      discuss at: https://locutus.io/clojure/trim/\n    // parity verified: Clojure 1.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim('  hello  ')\n    //       returns 1: 'hello'\n    //       example 2: trim('abc')\n    //       returns 2: 'abc'\n    return String(s).trim();\n}"
const __locutus_standalone_js_code = "// clojure/string/trim (target function module)\nfunction trim(s) {\n    //      discuss at: https://locutus.io/clojure/trim/\n    // parity verified: Clojure 1.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: trim('  hello  ')\n    //       returns 1: 'hello'\n    //       example 2: trim('abc')\n    //       returns 2: 'abc'\n    return String(s).trim();\n}"
