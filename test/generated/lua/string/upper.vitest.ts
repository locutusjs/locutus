...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/lua/string/upper.ts').upper
const __locutus_source_module_url = new URL("../../../../src/lua/string/upper.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "upper"
...
const __locutus_standalone_ts_code = "// lua/string/upper (target function module)\nfunction upper(s) {\n    //      discuss at: https://locutus.io/lua/upper/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: upper('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: upper('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(s).toUpperCase();\n}"
const __locutus_standalone_js_code = "// lua/string/upper (target function module)\nfunction upper(s) {\n    //      discuss at: https://locutus.io/lua/upper/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: upper('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: upper('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(s).toUpperCase();\n}"
...
describe('src/lua/string/upper.ts (tested in test/generated/lua/string/upper.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (upper: typeof __locutus_source_fn) => {
      return upper('hello')
    }
