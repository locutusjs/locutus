...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/lua/string/lower.ts').lower
const __locutus_source_module_url = new URL("../../../../src/lua/string/lower.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "lower"
...
const __locutus_standalone_ts_code = "// lua/string/lower (target function module)\nfunction lower(s) {\n    //      discuss at: https://locutus.io/lua/lower/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: lower('Hello World')\n    //       returns 2: 'hello world'\n    return String(s).toLowerCase();\n}"
const __locutus_standalone_js_code = "// lua/string/lower (target function module)\nfunction lower(s) {\n    //      discuss at: https://locutus.io/lua/lower/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: lower('Hello World')\n    //       returns 2: 'hello world'\n    return String(s).toLowerCase();\n}"
...
describe('src/lua/string/lower.ts (tested in test/generated/lua/string/lower.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (lower: typeof __locutus_source_fn) => {
      return lower('HELLO')
    }
