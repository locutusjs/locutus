...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/lua/string/reverse.ts').reverse
const __locutus_source_module_url = new URL("../../../../src/lua/string/reverse.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// lua/string/reverse (target function module)\nfunction reverse(s) {\n    //      discuss at: https://locutus.io/lua/reverse/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: reverse('hello')\n    //       returns 1: 'olleh'\n    //       example 2: reverse('abc')\n    //       returns 2: 'cba'\n    return String(s).split('').reverse().join('');\n}"
const __locutus_standalone_js_code = "// lua/string/reverse (target function module)\nfunction reverse(s) {\n    //      discuss at: https://locutus.io/lua/reverse/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: reverse('hello')\n    //       returns 1: 'olleh'\n    //       example 2: reverse('abc')\n    //       returns 2: 'cba'\n    return String(s).split('').reverse().join('');\n}"
