...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/lua/math/sin.ts').sin
const __locutus_source_module_url = new URL("../../../../src/lua/math/sin.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// lua/math/sin (target function module)\nfunction sin(x) {\n    //      discuss at: https://locutus.io/lua/sin/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sin(0)\n    //       returns 1: 0\n    //       example 2: sin(1)\n    //       returns 2: 0.8414709848078965\n    return Math.sin(x);\n}"
const __locutus_standalone_js_code = "// lua/math/sin (target function module)\nfunction sin(x) {\n    //      discuss at: https://locutus.io/lua/sin/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sin(0)\n    //       returns 1: 0\n    //       example 2: sin(1)\n    //       returns 2: 0.8414709848078965\n    return Math.sin(x);\n}"
