...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/lua/math/cos.ts').cos
const __locutus_source_module_url = new URL("../../../../src/lua/math/cos.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// lua/math/cos (target function module)\nfunction cos(x) {\n    //      discuss at: https://locutus.io/lua/cos/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: cos(0)\n    //       returns 1: 1\n    //       example 2: cos(1)\n    //       returns 2: 0.5403023058681398\n    return Math.cos(x);\n}"
const __locutus_standalone_js_code = "// lua/math/cos (target function module)\nfunction cos(x) {\n    //      discuss at: https://locutus.io/lua/cos/\n    // parity verified: Lua 5.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: cos(0)\n    //       returns 1: 1\n    //       example 2: cos(1)\n    //       returns 2: 0.5403023058681398\n    return Math.cos(x);\n}"
