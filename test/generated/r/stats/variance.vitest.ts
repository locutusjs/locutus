...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/r/stats/variance.ts').variance
const __locutus_source_module_url = new URL("../../../../src/r/stats/variance.ts", import.meta.url)
...
describe('src/r/stats/variance.ts (tested in test/generated/r/stats/variance.vitest.ts)', function () {
