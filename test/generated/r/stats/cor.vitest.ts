...
describe('src/r/stats/cor.ts (tested in test/generated/r/stats/cor.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (cor: typeof __locutus_source_fn) => {
      return cor([1, 2, 3], [1, 5, 7])
    }
