...
describe('src/r/stats/sd.ts (tested in test/generated/r/stats/sd.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (sd: typeof __locutus_source_fn) => {
      return sd([1, 2, 3])
    }
