...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/r/base/min.ts').min
const __locutus_source_module_url = new URL("../../../../src/r/base/min.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// r/base/min (target function module)\nfunction min(...args) {\n    //      discuss at: https://locutus.io/r/min/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: min(1, 5, 3)\n    //       returns 1: 1\n    //       example 2: min(-1, -5)\n    //       returns 2: -5\n    return Math.min(...args);\n}"
const __locutus_standalone_js_code = "// r/base/min (target function module)\nfunction min(...args) {\n    //      discuss at: https://locutus.io/r/min/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: min(1, 5, 3)\n    //       returns 1: 1\n    //       example 2: min(-1, -5)\n    //       returns 2: -5\n    return Math.min(...args);\n}"
