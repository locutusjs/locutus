...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/r/base/max.ts').max
const __locutus_source_module_url = new URL("../../../../src/r/base/max.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// r/base/max (target function module)\nfunction max(...args) {\n    //      discuss at: https://locutus.io/r/max/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: max(1, 5, 3)\n    //       returns 1: 5\n    //       example 2: max(-1, -5)\n    //       returns 2: -1\n    return Math.max(...args);\n}"
const __locutus_standalone_js_code = "// r/base/max (target function module)\nfunction max(...args) {\n    //      discuss at: https://locutus.io/r/max/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: max(1, 5, 3)\n    //       returns 1: 5\n    //       example 2: max(-1, -5)\n    //       returns 2: -1\n    return Math.max(...args);\n}"
