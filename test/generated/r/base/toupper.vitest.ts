...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/r/base/toupper.ts').toupper
const __locutus_source_module_url = new URL("../../../../src/r/base/toupper.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// r/base/toupper (target function module)\nfunction toupper(x) {\n    //      discuss at: https://locutus.io/r/toupper/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: toupper('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: toupper('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(x).toUpperCase();\n}"
const __locutus_standalone_js_code = "// r/base/toupper (target function module)\nfunction toupper(x) {\n    //      discuss at: https://locutus.io/r/toupper/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: toupper('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: toupper('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(x).toUpperCase();\n}"
...
describe('src/r/base/toupper.ts (tested in test/generated/r/base/toupper.vitest.ts)', function () {
