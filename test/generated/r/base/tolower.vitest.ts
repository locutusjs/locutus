...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/r/base/tolower.ts').tolower
const __locutus_source_module_url = new URL("../../../../src/r/base/tolower.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// r/base/tolower (target function module)\nfunction tolower(x) {\n    //      discuss at: https://locutus.io/r/tolower/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tolower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: tolower('Hello World')\n    //       returns 2: 'hello world'\n    return String(x).toLowerCase();\n}"
const __locutus_standalone_js_code = "// r/base/tolower (target function module)\nfunction tolower(x) {\n    //      discuss at: https://locutus.io/r/tolower/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tolower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: tolower('Hello World')\n    //       returns 2: 'hello world'\n    return String(x).toLowerCase();\n}"
...
describe('src/r/base/tolower.ts (tested in test/generated/r/base/tolower.vitest.ts)', function () {
