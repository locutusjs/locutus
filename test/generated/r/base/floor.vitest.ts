...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/r/base/floor.ts').floor
const __locutus_source_module_url = new URL("../../../../src/r/base/floor.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// r/base/floor (target function module)\nfunction floor(x) {\n    //      discuss at: https://locutus.io/r/floor/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the largest integer <= x\n    //       example 1: floor(4.7)\n    //       returns 1: 4\n    //       example 2: floor(-0.5)\n    //       returns 2: -1\n    //       example 3: floor(3)\n    //       returns 3: 3\n    return Math.floor(x);\n}"
const __locutus_standalone_js_code = "// r/base/floor (target function module)\nfunction floor(x) {\n    //      discuss at: https://locutus.io/r/floor/\n    // parity verified: R 4.4\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the largest integer <= x\n    //       example 1: floor(4.7)\n    //       returns 1: 4\n    //       example 2: floor(-0.5)\n    //       returns 2: -1\n    //       example 3: floor(3)\n    //       returns 3: 3\n    return Math.floor(x);\n}"
...
describe('src/r/base/floor.ts (tested in test/generated/r/base/floor.vitest.ts)', function () {
