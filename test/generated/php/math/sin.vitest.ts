...
const __locutus_source_fn = require('../../../../src/php/math/sin.ts').sin
const __locutus_source_module_url = new URL("../../../../src/php/math/sin.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "sin"
...
const __locutus_standalone_ts_code = "// php/math/sin (target function module)\nfunction sin(arg) {\n    //      discuss at: https://locutus.io/php/sin/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: Math.ceil(sin(8723321.4) * 10000000)\n    //       returns 1: -9834330\n    return Math.sin(arg);\n}"
const __locutus_standalone_js_code = "// php/math/sin (target function module)\nfunction sin(arg) {\n    //      discuss at: https://locutus.io/php/sin/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: Math.ceil(sin(8723321.4) * 10000000)\n    //       returns 1: -9834330\n    return Math.sin(arg);\n}"
...
describe('src/php/math/sin.ts (tested in test/generated/php/math/sin.vitest.ts)', function () {
  it('should pass example 1', function () {
    const expected = -9834330
    ...
    const __locutus_run_example = (sin: typeof __locutus_source_fn) => {
      return Math.ceil(sin(8723321.4) * 10000000)
    }
