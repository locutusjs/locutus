...
const __locutus_source_fn = require('../../../../src/php/math/log.ts').log
const __locutus_source_module_url = new URL("../../../../src/php/math/log.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/log (target function module)\nfunction log(arg, base) {\n    //      discuss at: https://locutus.io/php/log/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: log(8723321.4, 7)\n    //       returns 1: 8.212871815082147\n    return typeof base === 'undefined' ? Math.log(arg) : Math.log(arg) / Math.log(base);\n}"
const __locutus_standalone_js_code = "// php/math/log (target function module)\nfunction log(arg, base) {\n    //      discuss at: https://locutus.io/php/log/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: log(8723321.4, 7)\n    //       returns 1: 8.212871815082147\n    return typeof base === 'undefined' ? Math.log(arg) : Math.log(arg) / Math.log(base);\n}"
...
describe('src/php/math/log.ts (tested in test/generated/php/math/log.vitest.ts)', function () {
