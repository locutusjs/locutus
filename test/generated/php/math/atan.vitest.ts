...
const __locutus_source_fn = require('../../../../src/php/math/atan.ts').atan
const __locutus_source_module_url = new URL("../../../../src/php/math/atan.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "atan"
...
const __locutus_standalone_ts_code = "// php/math/atan (target function module)\nfunction atan(arg) {\n    //      discuss at: https://locutus.io/php/atan/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: atan(8723321.4)\n    //       returns 1: 1.5707962121596615\n    return Math.atan(arg);\n}"
const __locutus_standalone_js_code = "// php/math/atan (target function module)\nfunction atan(arg) {\n    //      discuss at: https://locutus.io/php/atan/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: atan(8723321.4)\n    //       returns 1: 1.5707962121596615\n    return Math.atan(arg);\n}"
...
describe('src/php/math/atan.ts (tested in test/generated/php/math/atan.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (atan: typeof __locutus_source_fn) => {
      return atan(8723321.4)
    }
