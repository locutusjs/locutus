...
const __locutus_source_fn = require('../../../../src/php/math/asinh.ts').asinh
const __locutus_source_module_url = new URL("../../../../src/php/math/asinh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/asinh (target function module)\nfunction asinh(arg) {\n    //      discuss at: https://locutus.io/php/asinh/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: asinh(8723321.4)\n    //       returns 1: 16.67465779841863\n    return Math.log(arg + Math.sqrt(arg * arg + 1));\n}"
const __locutus_standalone_js_code = "// php/math/asinh (target function module)\nfunction asinh(arg) {\n    //      discuss at: https://locutus.io/php/asinh/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: asinh(8723321.4)\n    //       returns 1: 16.67465779841863\n    return Math.log(arg + Math.sqrt(arg * arg + 1));\n}"
