...
const __locutus_source_fn = require('../../../../src/php/math/asin.ts').asin
const __locutus_source_module_url = new URL("../../../../src/php/math/asin.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/asin (target function module)\nfunction asin(arg) {\n    //  discuss at: https://locutus.io/php/asin/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //      note 1: Sorry about the crippled test. Needed because precision differs accross platforms.\n    //   example 1: (asin(0.3) + '').substr(0, 17)\n    //   returns 1: \"0.304692654015397\"\n    return Math.asin(arg);\n}"
const __locutus_standalone_js_code = "// php/math/asin (target function module)\nfunction asin(arg) {\n    //  discuss at: https://locutus.io/php/asin/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //      note 1: Sorry about the crippled test. Needed because precision differs accross platforms.\n    //   example 1: (asin(0.3) + '').substr(0, 17)\n    //   returns 1: \"0.304692654015397\"\n    return Math.asin(arg);\n}"
