...
const __locutus_source_fn = require('../../../../src/php/math/acos.ts').acos
const __locutus_source_module_url = new URL("../../../../src/php/math/acos.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/acos (target function module)\nfunction acos(arg) {\n    //  discuss at: https://locutus.io/php/acos/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //      note 1: Sorry about the crippled test. Needed because precision differs accross platforms.\n    //   example 1: (acos(0.3) + '').substr(0, 17)\n    //   returns 1: \"1.266103672779499\"\n    return Math.acos(arg);\n}"
const __locutus_standalone_js_code = "// php/math/acos (target function module)\nfunction acos(arg) {\n    //  discuss at: https://locutus.io/php/acos/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //      note 1: Sorry about the crippled test. Needed because precision differs accross platforms.\n    //   example 1: (acos(0.3) + '').substr(0, 17)\n    //   returns 1: \"1.266103672779499\"\n    return Math.acos(arg);\n}"
