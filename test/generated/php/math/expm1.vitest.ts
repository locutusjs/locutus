...
const __locutus_source_fn = require('../../../../src/php/math/expm1.ts').expm1
const __locutus_source_module_url = new URL("../../../../src/php/math/expm1.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/expm1 (target function module)\nfunction expm1(x) {\n    //      discuss at: https://locutus.io/php/expm1/\n    // parity verified: PHP 8.3\n    //     original by: Brett Zamir (https://brett-zamir.me)\n    //     improved by: Robert Eisele (https://www.xarg.org/)\n    //          note 1: Precision 'n' can be adjusted as desired\n    //       example 1: expm1(1e-15)\n    //       returns 1: 1.0000000000000007e-15\n    return x < 1e-5 && x > -1e-5 ? x + 0.5 * x * x : Math.exp(x) - 1;\n}"
const __locutus_standalone_js_code = "// php/math/expm1 (target function module)\nfunction expm1(x) {\n    //      discuss at: https://locutus.io/php/expm1/\n    // parity verified: PHP 8.3\n    //     original by: Brett Zamir (https://brett-zamir.me)\n    //     improved by: Robert Eisele (https://www.xarg.org/)\n    //          note 1: Precision 'n' can be adjusted as desired\n    //       example 1: expm1(1e-15)\n    //       returns 1: 1.0000000000000007e-15\n    return x < 1e-5 && x > -1e-5 ? x + 0.5 * x * x : Math.exp(x) - 1;\n}"
...
describe('src/php/math/expm1.ts (tested in test/generated/php/math/expm1.vitest.ts)', function () {
