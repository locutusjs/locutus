...
const __locutus_source_fn = require('../../../../src/php/math/bindec.ts').bindec
const __locutus_source_module_url = new URL("../../../../src/php/math/bindec.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "bindec"
...
const __locutus_standalone_ts_code = "// php/math/bindec (target function module)\nfunction bindec(binaryString) {\n    //      discuss at: https://locutus.io/php/bindec/\n    // parity verified: PHP 8.3\n    //     original by: Philippe Baumann\n    //       example 1: bindec('110011')\n    //       returns 1: 51\n    //       example 2: bindec('000110011')\n    //       returns 2: 51\n    //       example 3: bindec('111')\n    //       returns 3: 7\n    binaryString = (binaryString + '').replace(/[^01]/gi, '');\n    return parseInt(binaryString, 2);\n}"
const __locutus_standalone_js_code = "// php/math/bindec (target function module)\nfunction bindec(binaryString) {\n    //      discuss at: https://locutus.io/php/bindec/\n    // parity verified: PHP 8.3\n    //     original by: Philippe Baumann\n    //       example 1: bindec('110011')\n    //       returns 1: 51\n    //       example 2: bindec('000110011')\n    //       returns 2: 51\n    //       example 3: bindec('111')\n    //       returns 3: 7\n    binaryString = (binaryString + '').replace(/[^01]/gi, '');\n    return parseInt(binaryString, 2);\n}"
...
describe('src/php/math/bindec.ts (tested in test/generated/php/math/bindec.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (bindec: typeof __locutus_source_fn) => {
      return bindec('110011')
    }
