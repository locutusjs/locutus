...
const __locutus_source_fn = require('../../../../src/php/math/tanh.ts').tanh
const __locutus_source_module_url = new URL("../../../../src/php/math/tanh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/tanh (target function module)\nfunction tanh(arg) {\n    //      discuss at: https://locutus.io/php/tanh/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: Robert Eisele (https://www.xarg.org/)\n    //       example 1: tanh(5.4251848798444815)\n    //       returns 1: 0.9999612058841574\n    return 1 - 2 / (Math.exp(2 * arg) + 1);\n}"
const __locutus_standalone_js_code = "// php/math/tanh (target function module)\nfunction tanh(arg) {\n    //      discuss at: https://locutus.io/php/tanh/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: Robert Eisele (https://www.xarg.org/)\n    //       example 1: tanh(5.4251848798444815)\n    //       returns 1: 0.9999612058841574\n    return 1 - 2 / (Math.exp(2 * arg) + 1);\n}"
...
describe('src/php/math/tanh.ts (tested in test/generated/php/math/tanh.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (tanh: typeof __locutus_source_fn) => {
      return tanh(5.4251848798444815)
    }
