...
const __locutus_source_fn = require('../../../../src/php/math/pow.ts').pow
const __locutus_source_module_url = new URL("../../../../src/php/math/pow.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/pow (target function module)\nfunction pow(base, exp) {\n    //  discuss at: https://locutus.io/php/pow/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    // improved by: Waldo Malqui Silva (https://fayr.us/waldo/)\n    //   example 1: pow(8723321.4, 7)\n    //   returns 1: 3.8439091680779e+48\n    return Number(Math.pow(base, exp).toPrecision(15));\n}"
const __locutus_standalone_js_code = "// php/math/pow (target function module)\nfunction pow(base, exp) {\n    //  discuss at: https://locutus.io/php/pow/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    // improved by: Waldo Malqui Silva (https://fayr.us/waldo/)\n    //   example 1: pow(8723321.4, 7)\n    //   returns 1: 3.8439091680779e+48\n    return Number(Math.pow(base, exp).toPrecision(15));\n}"
