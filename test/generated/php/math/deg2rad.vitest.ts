...
const __locutus_source_fn = require('../../../../src/php/math/deg2rad.ts').deg2rad
const __locutus_source_module_url = new URL("../../../../src/php/math/deg2rad.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "deg2rad"
...
const __locutus_standalone_ts_code = "// php/math/deg2rad (target function module)\nfunction deg2rad(angle) {\n    //      discuss at: https://locutus.io/php/deg2rad/\n    // parity verified: PHP 8.3\n    //     original by: Enrique Gonzalez\n    //     improved by: Thomas Grainger (https://graingert.co.uk)\n    //       example 1: deg2rad(45)\n    //       returns 1: 0.7853981633974483\n    return angle * 0.017453292519943295; // (angle / 180) * Math.PI;\n}"
const __locutus_standalone_js_code = "// php/math/deg2rad (target function module)\nfunction deg2rad(angle) {\n    //      discuss at: https://locutus.io/php/deg2rad/\n    // parity verified: PHP 8.3\n    //     original by: Enrique Gonzalez\n    //     improved by: Thomas Grainger (https://graingert.co.uk)\n    //       example 1: deg2rad(45)\n    //       returns 1: 0.7853981633974483\n    return angle * 0.017453292519943295; // (angle / 180) * Math.PI;\n}"
...
describe('src/php/math/deg2rad.ts (tested in test/generated/php/math/deg2rad.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (deg2rad: typeof __locutus_source_fn) => {
      return deg2rad(45)
    }
