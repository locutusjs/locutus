...
const __locutus_source_fn = require('../../../../src/php/math/pi.ts').pi
const __locutus_source_module_url = new URL("../../../../src/php/math/pi.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "pi"
...
const __locutus_standalone_ts_code = "// php/math/pi (target function module)\nfunction pi() {\n    //  discuss at: https://locutus.io/php/pi/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    // improved by: dude\n    //   example 1: pi(8723321.4)\n    //   returns 1: 3.141592653589793\n    return 3.141592653589793; // Math.PI\n}"
const __locutus_standalone_js_code = "// php/math/pi (target function module)\nfunction pi() {\n    //  discuss at: https://locutus.io/php/pi/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    // improved by: dude\n    //   example 1: pi(8723321.4)\n    //   returns 1: 3.141592653589793\n    return 3.141592653589793; // Math.PI\n}"
...
describe('src/php/math/pi.ts (tested in test/generated/php/math/pi.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (pi: typeof __locutus_source_fn) => {
      return pi(8723321.4)
    }
