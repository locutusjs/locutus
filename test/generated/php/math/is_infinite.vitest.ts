...
const __locutus_source_fn = require('../../../../src/php/math/is_infinite.ts').is_infinite
const __locutus_source_module_url = new URL("../../../../src/php/math/is_infinite.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_infinite"
...
const __locutus_standalone_ts_code = "function is_infinite(val) {\n    //  discuss at: https://locutus.io/php/is_infinite/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //   example 1: is_infinite(Infinity)\n    //   returns 1: true\n    //   example 2: is_infinite(-Infinity)\n    //   returns 2: true\n    //   example 3: is_infinite(0)\n    //   returns 3: false\n    let warningType = '';\n    if (val === Infinity || val === -Infinity) {\n        return true;\n    }\n    // Some warnings for maximum PHP compatibility\n    if (typeof val === 'object') {\n        warningType = Array.isArray(val) ? 'array' : 'object';\n    }\n    else if (typeof val === 'string' && !/^[+-]?\\d/.test(val)) {\n        // simulate PHP's behaviour: '-9a' doesn't give a warning, but 'a9' does.\n        warningType = 'string';\n    }\n    if (warningType) {\n        const msg = 'Warning: is_infinite() expects parameter 1 to be double, ' + warningType + ' given';\n        throw new Error(msg);\n    }\n    return false;\n}"
const __locutus_standalone_js_code = "// php/math/is_infinite (target function module)\nfunction is_infinite(val) {\n    //  discuss at: https://locutus.io/php/is_infinite/\n    // original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //   example 1: is_infinite(Infinity)\n    //   returns 1: true\n    //   example 2: is_infinite(-Infinity)\n    //   returns 2: true\n    //   example 3: is_infinite(0)\n    //   returns 3: false\n    let warningType = '';\n    if (val === Infinity || val === -Infinity) {\n        return true;\n    }\n    // Some warnings for maximum PHP compatibility\n    if (typeof val === 'object') {\n        warningType = Array.isArray(val) ? 'array' : 'object';\n    }\n    else if (typeof val === 'string' && !/^[+-]?\\d/.test(val)) {\n        // simulate PHP's behaviour: '-9a' doesn't give a warning, but 'a9' does.\n        warningType = 'string';\n    }\n    if (warningType) {\n        const msg = 'Warning: is_infinite() expects parameter 1 to be double, ' + warningType + ' given';\n        throw new Error(msg);\n    }\n    return false;\n}"
...
describe('src/php/math/is_infinite.ts (tested in test/generated/php/math/is_infinite.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_infinite: typeof __locutus_source_fn) => {
      return is_infinite(Infinity)
    }
