...
const __locutus_source_fn = require('../../../../src/php/math/atanh.ts').atanh
const __locutus_source_module_url = new URL("../../../../src/php/math/atanh.ts", import.meta.url)
...
describe('src/php/math/atanh.ts (tested in test/generated/php/math/atanh.vitest.ts)', function () {
