...
const __locutus_source_fn = require('../../../../src/php/math/lcg_value.ts').lcg_value
const __locutus_source_module_url = new URL("../../../../src/php/math/lcg_value.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "lcg_value"
...
const __locutus_standalone_ts_code = "// php/math/lcg_value (target function module)\nfunction lcg_value() {\n    //      discuss at: https://locutus.io/php/lcg_value/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: var $rnd = lcg_value()\n    //       example 1: var $result = $rnd >= 0 && $rnd <= 1\n    //       returns 1: true\n    return Math.random();\n}"
const __locutus_standalone_js_code = "// php/math/lcg_value (target function module)\nfunction lcg_value() {\n    //      discuss at: https://locutus.io/php/lcg_value/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: var $rnd = lcg_value()\n    //       example 1: var $result = $rnd >= 0 && $rnd <= 1\n    //       returns 1: true\n    return Math.random();\n}"
...
describe('src/php/math/lcg_value.ts (tested in test/generated/php/math/lcg_value.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (lcg_value: typeof __locutus_source_fn) => {
      var $rnd = lcg_value()
      return $rnd >= 0 && $rnd <= 1
    }
