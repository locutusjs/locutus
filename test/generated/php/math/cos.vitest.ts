...
const __locutus_source_fn = require('../../../../src/php/math/cos.ts').cos
const __locutus_source_module_url = new URL("../../../../src/php/math/cos.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/math/cos (target function module)\nfunction cos(arg) {\n    //      discuss at: https://locutus.io/php/cos/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: Math.ceil(cos(8723321.4) * 10000000)\n    //       returns 1: -1812718\n    return Math.cos(arg);\n}"
const __locutus_standalone_js_code = "// php/math/cos (target function module)\nfunction cos(arg) {\n    //      discuss at: https://locutus.io/php/cos/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: Math.ceil(cos(8723321.4) * 10000000)\n    //       returns 1: -1812718\n    return Math.cos(arg);\n}"
...
describe('src/php/math/cos.ts (tested in test/generated/php/math/cos.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (cos: typeof __locutus_source_fn) => {
      return Math.ceil(cos(8723321.4) * 10000000)
    }
