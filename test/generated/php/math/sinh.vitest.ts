...
const __locutus_source_fn = require('../../../../src/php/math/sinh.ts').sinh
const __locutus_source_module_url = new URL("../../../../src/php/math/sinh.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "sinh"
...
const __locutus_standalone_ts_code = "// php/math/sinh (target function module)\nfunction sinh(arg) {\n    //      discuss at: https://locutus.io/php/sinh/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: sinh(-0.9834330348825909)\n    //       returns 1: -1.1497971402636502\n    return (Math.exp(arg) - Math.exp(-arg)) / 2;\n}"
const __locutus_standalone_js_code = "// php/math/sinh (target function module)\nfunction sinh(arg) {\n    //      discuss at: https://locutus.io/php/sinh/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: sinh(-0.9834330348825909)\n    //       returns 1: -1.1497971402636502\n    return (Math.exp(arg) - Math.exp(-arg)) / 2;\n}"
...
describe('src/php/math/sinh.ts (tested in test/generated/php/math/sinh.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (sinh: typeof __locutus_source_fn) => {
      return sinh(-0.9834330348825909)
    }
