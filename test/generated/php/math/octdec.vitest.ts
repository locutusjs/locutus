...
const __locutus_source_fn = require('../../../../src/php/math/octdec.ts').octdec
const __locutus_source_module_url = new URL("../../../../src/php/math/octdec.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "octdec"
...
const __locutus_standalone_ts_code = "// php/math/octdec (target function module)\nfunction octdec(octString) {\n    //      discuss at: https://locutus.io/php/octdec/\n    // parity verified: PHP 8.3\n    //     original by: Philippe Baumann\n    //       example 1: octdec('77')\n    //       returns 1: 63\n    octString = (octString + '').replace(/[^0-7]/gi, '');\n    return parseInt(octString, 8);\n}"
const __locutus_standalone_js_code = "// php/math/octdec (target function module)\nfunction octdec(octString) {\n    //      discuss at: https://locutus.io/php/octdec/\n    // parity verified: PHP 8.3\n    //     original by: Philippe Baumann\n    //       example 1: octdec('77')\n    //       returns 1: 63\n    octString = (octString + '').replace(/[^0-7]/gi, '');\n    return parseInt(octString, 8);\n}"
...
describe('src/php/math/octdec.ts (tested in test/generated/php/math/octdec.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (octdec: typeof __locutus_source_fn) => {
      return octdec('77')
    }
