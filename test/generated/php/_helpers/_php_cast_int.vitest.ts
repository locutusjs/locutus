...
describe('src/php/_helpers/_php_cast_int.js (tested in test/generated/php/_helpers/_php_cast_int.vitest.ts)', function () {
  ...
  it('should pass example 2', function () {
    const expected = 1
    const result = _php_cast_int(true)
    expect(result).toEqual(expected)
  })
  it('should pass example 3', function () {
    const expected = 0
    const result = _php_cast_int(0)
    expect(result).toEqual(expected)
  })
  it('should pass example 4', function () {
    const expected = 1
    const result = _php_cast_int(1)
    expect(result).toEqual(expected)
  })
  it('should pass example 5', function () {
    const expected = 3
    const result = _php_cast_int(3.14)
    expect(result).toEqual(expected)
  })
  it('should pass example 6', function () {
    const expected = 0
    const result = _php_cast_int('')
    expect(result).toEqual(expected)
  })
  ...
  it('should pass example 8', function () {
    const expected = 0
    const result = _php_cast_int('abc')
    expect(result).toEqual(expected)
  })
  it('should pass example 9', function () {
    const expected = 0
    const result = _php_cast_int(null)
    expect(result).toEqual(expected)
  })
  it('should pass example 10', function () {
    const expected = 0
    const result = _php_cast_int(undefined)
    expect(result).toEqual(expected)
  })
  it('should pass example 11', function () {
    const expected = 123
    const result = _php_cast_int('123abc')
    expect(result).toEqual(expected)
  })
  it('should pass example 12', function () {
    const expected = 123
    const result = _php_cast_int('123e4')
    expect(result).toEqual(expected)
  })
  it('should pass example 13', function () {
    const expected = 8589934593
    const result = _php_cast_int(0x200000001)
    expect(result).toEqual(expected)
  })
})
