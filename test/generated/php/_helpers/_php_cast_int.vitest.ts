...
const __locutus_source_fn = require('../../../../src/php/_helpers/_php_cast_int.ts')._php_cast_int
const __locutus_source_module_url = new URL("../../../../src/php/_helpers/_php_cast_int.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "_php_cast_int"
...
describe('src/php/_helpers/_php_cast_int.ts (tested in test/generated/php/_helpers/_php_cast_int.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (_php_cast_int: typeof __locutus_source_fn) => {
      return _php_cast_int(false)
    }
  ...
  it('should pass example 10', function () {
    ...
    const __locutus_run_example = (_php_cast_int: typeof __locutus_source_fn) => {
      return _php_cast_int(undefined)
    }
    for (const __locutus_variant of __locutus_variants) {
      ;(globalThis as { $locutus?: unknown }).$locutus = undefined
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
  ...
  it('should pass example 13', function () {
    ...
    const __locutus_run_example = (_php_cast_int: typeof __locutus_source_fn) => {
      return _php_cast_int(0x200000001)
    }
    for (const __locutus_variant of __locutus_variants) {
      ;(globalThis as { $locutus?: unknown }).$locutus = undefined
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
