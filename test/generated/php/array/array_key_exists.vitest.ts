...
const __locutus_source_fn = require('../../../../src/php/array/array_key_exists.ts').array_key_exists
const __locutus_source_module_url = new URL("../../../../src/php/array/array_key_exists.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_key_exists"
...
const __locutus_standalone_ts_code = "// php/array/array_key_exists (target function module)\nfunction array_key_exists(key, search) {\n    //  discuss at: https://locutus.io/php/array_key_exists/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    // improved by: Felix Geisendoerfer (https://www.debuggable.com/felix)\n    //   example 1: array_key_exists('kevin', {'kevin': 'van Zonneveld'})\n    //   returns 1: true\n    return String(key) in search;\n}"
const __locutus_standalone_js_code = "// php/array/array_key_exists (target function module)\nfunction array_key_exists(key, search) {\n    //  discuss at: https://locutus.io/php/array_key_exists/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    // improved by: Felix Geisendoerfer (https://www.debuggable.com/felix)\n    //   example 1: array_key_exists('kevin', {'kevin': 'van Zonneveld'})\n    //   returns 1: true\n    return String(key) in search;\n}"
...
describe('src/php/array/array_key_exists.ts (tested in test/generated/php/array/array_key_exists.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_key_exists: typeof __locutus_source_fn) => {
      return array_key_exists('kevin', {'kevin': 'van Zonneveld'})
    }
