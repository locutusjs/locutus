...
const __locutus_source_fn = require('../../../../src/php/array/array_intersect_key.ts').array_intersect_key
const __locutus_source_module_url = new URL("../../../../src/php/array/array_intersect_key.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_intersect_key"
...
describe('src/php/array/array_intersect_key.ts (tested in test/generated/php/array/array_intersect_key.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_intersect_key: typeof __locutus_source_fn) => {
