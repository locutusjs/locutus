...
const __locutus_source_fn = require('../../../../src/php/array/array_merge_recursive.ts').array_merge_recursive
const __locutus_source_module_url = new URL("../../../../src/php/array/array_merge_recursive.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_merge_recursive"
...
describe('src/php/array/array_merge_recursive.ts (tested in test/generated/php/array/array_merge_recursive.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_merge_recursive: typeof __locutus_source_fn) => {
