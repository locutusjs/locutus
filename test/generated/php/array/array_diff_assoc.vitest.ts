...
describe('src/php/array/array_diff_assoc.ts (tested in test/generated/php/array/array_diff_assoc.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_diff_assoc: typeof __locutus_source_fn) => {
      return array_diff_assoc({0: 'Kevin', 1: 'van', 2: 'Zonneveld'}, {0: 'Kevin', 4: 'van', 5: 'Zonneveld'})
    }
