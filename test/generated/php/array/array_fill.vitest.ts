...
const __locutus_source_fn = require('../../../../src/php/array/array_fill.ts').array_fill
const __locutus_source_module_url = new URL("../../../../src/php/array/array_fill.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_fill"
...
const __locutus_standalone_ts_code = "// php/array/array_fill (target function module)\nfunction array_fill(startIndex, num, mixedVal) {\n    //      discuss at: https://locutus.io/php/array_fill/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //       example 1: array_fill(5, 6, 'banana')\n    //       returns 1: { 5: 'banana', 6: 'banana', 7: 'banana', 8: 'banana', 9: 'banana', 10: 'banana' }\n    const tmpArr = {};\n    if (!isNaN(startIndex) && !isNaN(num)) {\n        for (let key = 0; key < num; key++) {\n            tmpArr[String(key + startIndex)] = mixedVal;\n        }\n    }\n    return tmpArr;\n}"
const __locutus_standalone_js_code = "// php/array/array_fill (target function module)\nfunction array_fill(startIndex, num, mixedVal) {\n    //      discuss at: https://locutus.io/php/array_fill/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //       example 1: array_fill(5, 6, 'banana')\n    //       returns 1: { 5: 'banana', 6: 'banana', 7: 'banana', 8: 'banana', 9: 'banana', 10: 'banana' }\n    const tmpArr = {};\n    if (!isNaN(startIndex) && !isNaN(num)) {\n        for (let key = 0; key < num; key++) {\n            tmpArr[String(key + startIndex)] = mixedVal;\n        }\n    }\n    return tmpArr;\n}"
...
describe('src/php/array/array_fill.ts (tested in test/generated/php/array/array_fill.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_fill: typeof __locutus_source_fn) => {
