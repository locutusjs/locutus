...
const __locutus_source_fn = require('../../../../src/php/array/array_key_first.ts').array_key_first
const __locutus_source_module_url = new URL("../../../../src/php/array/array_key_first.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_key_first"
const __locutus_module_js_code = "\"use strict\";\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.array_key_first = array_key_first;\nconst normalizePhpArrayKey_ts_1 = require(\"../../_util/_helpers/normalizePhpArrayKey.ts\");\nfunction array_key_first(input) {\n    //      discuss at: https://locutus.io/php/array_key_first/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_first({ a: 1, b: 2 })\n    //       returns 1: 'a'\n    //       example 2: array_key_first(['x', 'y'])\n    //       returns 2: 0\n    //       example 3: array_key_first([])\n    //       returns 3: null\n    const [firstKey] = Object.keys(input);\n    return typeof firstKey === 'string' ? (0, normalizePhpArrayKey_ts_1.normalizePhpArrayKey)(firstKey) : null;\n}"
const __locutus_standalone_ts_code = "// _util/_helpers/normalizePhpArrayKey (Locutus helper dependency)\nfunction normalizePhpArrayKey(key) {\n    if (/^(0|-?[1-9]\\d*)$/.test(key)) {\n        const numericKey = Number(key);\n        if (Number.isSafeInteger(numericKey)) {\n            return numericKey;\n        }\n    }\n    return key;\n}\n// php/array/array_key_first (target function module)\nfunction array_key_first(input) {\n    //      discuss at: https://locutus.io/php/array_key_first/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_first({ a: 1, b: 2 })\n    //       returns 1: 'a'\n    //       example 2: array_key_first(['x', 'y'])\n    //       returns 2: 0\n    //       example 3: array_key_first([])\n    //       returns 3: null\n    const [firstKey] = Object.keys(input);\n    return typeof firstKey === 'string' ? normalizePhpArrayKey(firstKey) : null;\n}"
const __locutus_standalone_js_code = "// _util/_helpers/normalizePhpArrayKey (Locutus helper dependency)\nfunction normalizePhpArrayKey(key) {\n    if (/^(0|-?[1-9]\\d*)$/.test(key)) {\n        const numericKey = Number(key);\n        if (Number.isSafeInteger(numericKey)) {\n            return numericKey;\n        }\n    }\n    return key;\n}\n// php/array/array_key_first (target function module)\nfunction array_key_first(input) {\n    //      discuss at: https://locutus.io/php/array_key_first/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_first({ a: 1, b: 2 })\n    //       returns 1: 'a'\n    //       example 2: array_key_first(['x', 'y'])\n    //       returns 2: 0\n    //       example 3: array_key_first([])\n    //       returns 3: null\n    const [firstKey] = Object.keys(input);\n    return typeof firstKey === 'string' ? normalizePhpArrayKey(firstKey) : null;\n}"
...
describe('src/php/array/array_key_first.ts (tested in test/generated/php/array/array_key_first.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_key_first: typeof __locutus_source_fn) => {
      return array_key_first({ a: 1, b: 2 })
    }
