...
const __locutus_standalone_ts_code = "// php/array/array_key_first (target function module)\nconst normalizeArrayKey = (key) => {\n    if (/^(0|-?[1-9]\\d*)$/.test(key)) {\n        return Number(key);\n    }\n    return key;\n};\nfunction array_key_first(input) {\n    //      discuss at: https://locutus.io/php/array_key_first/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_first({ a: 1, b: 2 })\n    //       returns 1: 'a'\n    //       example 2: array_key_first(['x', 'y'])\n    //       returns 2: 0\n    //       example 3: array_key_first([])\n    //       returns 3: null\n    const [firstKey] = Object.keys(input);\n    return typeof firstKey === 'string' ? normalizeArrayKey(firstKey) : null;\n}"
const __locutus_standalone_js_code = "// php/array/array_key_first (target function module)\nconst normalizeArrayKey = (key) => {\n    if (/^(0|-?[1-9]\\d*)$/.test(key)) {\n        return Number(key);\n    }\n    return key;\n};\nfunction array_key_first(input) {\n    //      discuss at: https://locutus.io/php/array_key_first/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_first({ a: 1, b: 2 })\n    //       returns 1: 'a'\n    //       example 2: array_key_first(['x', 'y'])\n    //       returns 2: 0\n    //       example 3: array_key_first([])\n    //       returns 3: null\n    const [firstKey] = Object.keys(input);\n    return typeof firstKey === 'string' ? normalizeArrayKey(firstKey) : null;\n}"
