...
const __locutus_standalone_ts_code = "// php/array/array_key_last (target function module)\nconst normalizeArrayKey = (key) => {\n    if (/^(0|-?[1-9]\\d*)$/.test(key)) {\n        return Number(key);\n    }\n    return key;\n};\nfunction array_key_last(input) {\n    //      discuss at: https://locutus.io/php/array_key_last/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_last({ a: 1, b: 2 })\n    //       returns 1: 'b'\n    //       example 2: array_key_last(['x', 'y'])\n    //       returns 2: 1\n    //       example 3: array_key_last([])\n    //       returns 3: null\n    const keys = Object.keys(input);\n    const lastKey = keys.at(-1);\n    return typeof lastKey === 'string' ? normalizeArrayKey(lastKey) : null;\n}"
const __locutus_standalone_js_code = "// php/array/array_key_last (target function module)\nconst normalizeArrayKey = (key) => {\n    if (/^(0|-?[1-9]\\d*)$/.test(key)) {\n        return Number(key);\n    }\n    return key;\n};\nfunction array_key_last(input) {\n    //      discuss at: https://locutus.io/php/array_key_last/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: array_key_last({ a: 1, b: 2 })\n    //       returns 1: 'b'\n    //       example 2: array_key_last(['x', 'y'])\n    //       returns 2: 1\n    //       example 3: array_key_last([])\n    //       returns 3: null\n    const keys = Object.keys(input);\n    const lastKey = keys.at(-1);\n    return typeof lastKey === 'string' ? normalizeArrayKey(lastKey) : null;\n}"
