...
describe('src/php/array/array_key_last.ts (tested in test/generated/php/array/array_key_last.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_key_last: typeof __locutus_source_fn) => {
      return array_key_last({ a: 1, b: 2 })
    }
