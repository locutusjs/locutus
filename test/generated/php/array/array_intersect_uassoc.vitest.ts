...
describe('src/php/array/array_intersect_uassoc.js (tested in test/generated/php/array/array_intersect_uassoc.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const result = array_intersect_uassoc($array1, $array2, function (f_string1, f_string2){var string1 = (f_string1+'').toLowerCase(); var string2 = (f_string2+'').toLowerCase(); if (string1 > string2) return 1; if (string1 === string2) return 0; return -1;})
