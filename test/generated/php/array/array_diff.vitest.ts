...
const __locutus_source_fn = require('../../../../src/php/array/array_diff.ts').array_diff
const __locutus_source_module_url = new URL("../../../../src/php/array/array_diff.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_diff"
...
describe('src/php/array/array_diff.ts (tested in test/generated/php/array/array_diff.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_diff: typeof __locutus_source_fn) => {
      return array_diff(['Kevin', 'van', 'Zonneveld'], ['van', 'Zonneveld'])
    }
