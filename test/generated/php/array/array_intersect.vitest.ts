...
const __locutus_source_fn = require('../../../../src/php/array/array_intersect.ts').array_intersect
const __locutus_source_module_url = new URL("../../../../src/php/array/array_intersect.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_intersect"
...
describe('src/php/array/array_intersect.ts (tested in test/generated/php/array/array_intersect.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_intersect: typeof __locutus_source_fn) => {
