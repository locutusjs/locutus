...
const __locutus_source_fn = require('../../../../src/php/array/array_shift.ts').array_shift
const __locutus_source_module_url = new URL("../../../../src/php/array/array_shift.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "array_shift"
...
const __locutus_standalone_ts_code = "// php/array/array_shift (target function module)\nfunction array_shift(inputArr) {\n    //  discuss at: https://locutus.io/php/array_shift/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    // improved by: Martijn Wieringa\n    //      note 1: Currently does not handle objects\n    //   example 1: array_shift(['Kevin', 'van', 'Zonneveld'])\n    //   returns 1: 'Kevin'\n    if (inputArr.length === 0) {\n        return null;\n    }\n    if (inputArr.length > 0) {\n        return inputArr.shift() ?? null;\n    }\n    return null;\n}"
const __locutus_standalone_js_code = "// php/array/array_shift (target function module)\nfunction array_shift(inputArr) {\n    //  discuss at: https://locutus.io/php/array_shift/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    // improved by: Martijn Wieringa\n    //      note 1: Currently does not handle objects\n    //   example 1: array_shift(['Kevin', 'van', 'Zonneveld'])\n    //   returns 1: 'Kevin'\n    if (inputArr.length === 0) {\n        return null;\n    }\n    if (inputArr.length > 0) {\n        return inputArr.shift() ?? null;\n    }\n    return null;\n}"
...
describe('src/php/array/array_shift.ts (tested in test/generated/php/array/array_shift.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (array_shift: typeof __locutus_source_fn) => {
      return array_shift(['Kevin', 'van', 'Zonneveld'])
    }
