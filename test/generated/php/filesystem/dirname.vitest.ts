...
const __locutus_standalone_ts_code = "// php/filesystem/dirname (target function module)\nfunction dirname(path) {\n    //      discuss at: https://locutus.io/php/dirname/\n    // parity verified: PHP 8.3\n    //     original by: Ozh\n    //     improved by: XoraX (https://www.xorax.info)\n    //       example 1: dirname('/etc/passwd')\n    //       returns 1: '/etc'\n    //       example 2: dirname('c:/Temp/x')\n    //       returns 2: 'c:/Temp'\n    //       example 3: dirname('/dir/test/')\n    //       returns 3: '/dir'\n    return path.replace(/\\\\/g, '/').replace(/\\/[^/]*\\/?$/, '');\n}"
const __locutus_standalone_js_code = "// php/filesystem/dirname (target function module)\nfunction dirname(path) {\n    //      discuss at: https://locutus.io/php/dirname/\n    // parity verified: PHP 8.3\n    //     original by: Ozh\n    //     improved by: XoraX (https://www.xorax.info)\n    //       example 1: dirname('/etc/passwd')\n    //       returns 1: '/etc'\n    //       example 2: dirname('c:/Temp/x')\n    //       returns 2: 'c:/Temp'\n    //       example 3: dirname('/dir/test/')\n    //       returns 3: '/dir'\n    return path.replace(/\\\\/g, '/').replace(/\\/[^/]*\\/?$/, '');\n}"
