...
describe('src/php/info/ini_get.ts (tested in test/generated/php/info/ini_get.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (ini_get: typeof __locutus_source_fn) => {
