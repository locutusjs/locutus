...
const __locutus_source_fn = require('../../../../src/php/var/floatval.ts').floatval
const __locutus_source_module_url = new URL("../../../../src/php/var/floatval.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "floatval"
...
const __locutus_standalone_js_code = "// php/var/floatval (target function module)\nfunction floatval(mixedVar) {\n    //      discuss at: https://locutus.io/php/floatval/\n    // parity verified: PHP 8.3\n    //     original by: Michael White (https://getsprink.com)\n    //          note 1: The native parseFloat() method of JavaScript returns NaN\n    //          note 1: when it encounters a string before an int or float value.\n    //       example 1: floatval('150.03_page-section')\n    //       returns 1: 150.03\n    //       example 2: floatval('page: 3')\n    //       example 2: floatval('-50 + 8')\n    //       returns 2: 0\n    //       returns 2: -50\n    return parseFloat(String(mixedVar ?? '')) || 0;\n}"
...
describe('src/php/var/floatval.ts (tested in test/generated/php/var/floatval.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (floatval: typeof __locutus_source_fn) => {
      return floatval('150.03_page-section')
    }
