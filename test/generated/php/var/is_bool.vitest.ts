...
const __locutus_source_fn = require('../../../../src/php/var/is_bool.ts').is_bool
const __locutus_source_module_url = new URL("../../../../src/php/var/is_bool.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_bool"
...
const __locutus_standalone_ts_code = "// php/var/is_bool (target function module)\nfunction is_bool(mixedVar) {\n    //      discuss at: https://locutus.io/php/is_bool/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: CoursesWeb (https://www.coursesweb.net/)\n    //       example 1: is_bool(false)\n    //       returns 1: true\n    //       example 2: is_bool(0)\n    //       returns 2: false\n    return mixedVar === true || mixedVar === false; // Faster (in FF) than type checking\n}"
const __locutus_standalone_js_code = "// php/var/is_bool (target function module)\nfunction is_bool(mixedVar) {\n    //      discuss at: https://locutus.io/php/is_bool/\n    // parity verified: PHP 8.3\n    //     original by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: CoursesWeb (https://www.coursesweb.net/)\n    //       example 1: is_bool(false)\n    //       returns 1: true\n    //       example 2: is_bool(0)\n    //       returns 2: false\n    return mixedVar === true || mixedVar === false; // Faster (in FF) than type checking\n}"
...
describe('src/php/var/is_bool.ts (tested in test/generated/php/var/is_bool.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_bool: typeof __locutus_source_fn) => {
