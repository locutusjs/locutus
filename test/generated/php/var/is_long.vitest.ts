...
const __locutus_source_fn = require('../../../../src/php/var/is_long.ts').is_long
const __locutus_source_module_url = new URL("../../../../src/php/var/is_long.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_long"
...
describe('src/php/var/is_long.ts (tested in test/generated/php/var/is_long.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_long: typeof __locutus_source_fn) => {
      return is_long(186.31)
    }
