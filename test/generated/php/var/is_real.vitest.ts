...
const __locutus_source_fn = require('../../../../src/php/var/is_real.ts').is_real
const __locutus_source_module_url = new URL("../../../../src/php/var/is_real.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_real"
...
describe('src/php/var/is_real.ts (tested in test/generated/php/var/is_real.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_real: typeof __locutus_source_fn) => {
      return is_real(186.31)
    }
