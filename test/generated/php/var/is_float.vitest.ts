...
const __locutus_source_fn = require('../../../../src/php/var/is_float.ts').is_float
const __locutus_source_module_url = new URL("../../../../src/php/var/is_float.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_float"
...
const __locutus_standalone_ts_code = "// php/var/is_float (target function module)\nfunction is_float(mixedVar) {\n    //      discuss at: https://locutus.io/php/is_float/\n    // parity verified: PHP 8.3\n    //     original by: Paulo Freitas\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //     improved by: WebDevHobo (https://webdevhobo.blogspot.com/)\n    //     improved by: Rafał Kukawski (https://blog.kukawski.pl)\n    //          note 1: 1.0 is simplified to 1 before it can be accessed by the function, this makes\n    //          note 1: it different from the PHP implementation. We can't fix this unfortunately.\n    //       example 1: is_float(186.31)\n    //       returns 1: true\n    return +mixedVar === mixedVar && (!isFinite(mixedVar) || !!(mixedVar % 1));\n}"
const __locutus_standalone_js_code = "// php/var/is_float (target function module)\nfunction is_float(mixedVar) {\n    //      discuss at: https://locutus.io/php/is_float/\n    // parity verified: PHP 8.3\n    //     original by: Paulo Freitas\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //     improved by: WebDevHobo (https://webdevhobo.blogspot.com/)\n    //     improved by: Rafał Kukawski (https://blog.kukawski.pl)\n    //          note 1: 1.0 is simplified to 1 before it can be accessed by the function, this makes\n    //          note 1: it different from the PHP implementation. We can't fix this unfortunately.\n    //       example 1: is_float(186.31)\n    //       returns 1: true\n    return +mixedVar === mixedVar && (!isFinite(mixedVar) || !!(mixedVar % 1));\n}"
...
describe('src/php/var/is_float.ts (tested in test/generated/php/var/is_float.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_float: typeof __locutus_source_fn) => {
      return is_float(186.31)
    }
