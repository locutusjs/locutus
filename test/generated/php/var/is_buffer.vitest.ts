...
const __locutus_source_fn = require('../../../../src/php/var/is_buffer.ts').is_buffer
const __locutus_source_module_url = new URL("../../../../src/php/var/is_buffer.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_buffer"
...
const __locutus_standalone_ts_code = "// php/var/is_buffer (target function module)\nfunction is_buffer(vr) {\n    //  discuss at: https://locutus.io/php/is_buffer/\n    // original by: Brett Zamir (https://brett-zamir.me)\n    //   example 1: is_buffer('This could be binary or a regular string...')\n    //   returns 1: true\n    return typeof vr === 'string';\n}"
const __locutus_standalone_js_code = "// php/var/is_buffer (target function module)\nfunction is_buffer(vr) {\n    //  discuss at: https://locutus.io/php/is_buffer/\n    // original by: Brett Zamir (https://brett-zamir.me)\n    //   example 1: is_buffer('This could be binary or a regular string...')\n    //   returns 1: true\n    return typeof vr === 'string';\n}"
...
describe('src/php/var/is_buffer.ts (tested in test/generated/php/var/is_buffer.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_buffer: typeof __locutus_source_fn) => {
      return is_buffer('This could be binary or a regular string...')
    }
