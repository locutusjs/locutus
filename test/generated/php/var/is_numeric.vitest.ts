...
const __locutus_source_fn = require('../../../../src/php/var/is_numeric.ts').is_numeric
const __locutus_source_module_url = new URL("../../../../src/php/var/is_numeric.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "is_numeric"
...
const __locutus_standalone_ts_code = "function is_numeric(mixedVar) {\n    //  discuss at: https://locutus.io/php/is_numeric/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    // improved by: David\n    // improved by: taith\n    // bugfixed by: Tim de Koning\n    // bugfixed by: WebDevHobo (https://webdevhobo.blogspot.com/)\n    // bugfixed by: Brett Zamir (https://brett-zamir.me)\n    // bugfixed by: Denis Chenu (https://shnoulle.net)\n    //   example 1: is_numeric(186.31)\n    //   returns 1: true\n    //   example 2: is_numeric('Kevin van Zonneveld')\n    //   returns 2: false\n    //   example 3: is_numeric(' +186.31e2')\n    //   returns 3: true\n    //   example 4: is_numeric('')\n    //   returns 4: false\n    //   example 5: is_numeric([])\n    //   returns 5: false\n    //   example 6: is_numeric('1 ')\n    //   returns 6: false\n    const whitespace = [\n        ' ',\n        '\\n',\n        '\\r',\n        '\\t',\n        '\\f',\n        '\\x0b',\n        '\\xa0',\n        '\\u2000',\n        '\\u2001',\n        '\\u2002',\n        '\\u2003',\n        '\\u2004',\n        '\\u2005',\n        '\\u2006',\n        '\\u2007',\n        '\\u2008',\n        '\\u2009',\n        '\\u200a',\n        '\\u200b',\n        '\\u2028',\n        '\\u2029',\n        '\\u3000',\n    ].join('');\n    // @todo: Break this up using many single conditions with early returns\n    if (typeof mixedVar === 'number') {\n        return !Number.isNaN(mixedVar);\n    }\n    if (typeof mixedVar !== 'string') {\n        return false;\n    }\n    return mixedVar !== '' && whitespace.indexOf(mixedVar.slice(-1)) === -1 && !Number.isNaN(Number(mixedVar));\n}"
const __locutus_standalone_js_code = "// php/var/is_numeric (target function module)\nfunction is_numeric(mixedVar) {\n    //  discuss at: https://locutus.io/php/is_numeric/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    // improved by: David\n    // improved by: taith\n    // bugfixed by: Tim de Koning\n    // bugfixed by: WebDevHobo (https://webdevhobo.blogspot.com/)\n    // bugfixed by: Brett Zamir (https://brett-zamir.me)\n    // bugfixed by: Denis Chenu (https://shnoulle.net)\n    //   example 1: is_numeric(186.31)\n    //   returns 1: true\n    //   example 2: is_numeric('Kevin van Zonneveld')\n    //   returns 2: false\n    //   example 3: is_numeric(' +186.31e2')\n    //   returns 3: true\n    //   example 4: is_numeric('')\n    //   returns 4: false\n    //   example 5: is_numeric([])\n    //   returns 5: false\n    //   example 6: is_numeric('1 ')\n    //   returns 6: false\n    const whitespace = [\n        ' ',\n        '\\n',\n        '\\r',\n        '\\t',\n        '\\f',\n        '\\x0b',\n        '\\xa0',\n        '\\u2000',\n        '\\u2001',\n        '\\u2002',\n        '\\u2003',\n        '\\u2004',\n        '\\u2005',\n        '\\u2006',\n        '\\u2007',\n        '\\u2008',\n        '\\u2009',\n        '\\u200a',\n        '\\u200b',\n        '\\u2028',\n        '\\u2029',\n        '\\u3000',\n    ].join('');\n    // @todo: Break this up using many single conditions with early returns\n    if (typeof mixedVar === 'number') {\n        return !Number.isNaN(mixedVar);\n    }\n    if (typeof mixedVar !== 'string') {\n        return false;\n    }\n    return mixedVar !== '' && whitespace.indexOf(mixedVar.slice(-1)) === -1 && !Number.isNaN(Number(mixedVar));\n}"
...
describe('src/php/var/is_numeric.ts (tested in test/generated/php/var/is_numeric.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (is_numeric: typeof __locutus_source_fn) => {
      return is_numeric(186.31)
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (is_numeric: typeof __locutus_source_fn) => {
      return is_numeric('Kevin van Zonneveld')
    }
    for (const __locutus_variant of __locutus_variants) {
      ;(globalThis as { $locutus?: unknown }).$locutus = undefined
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
