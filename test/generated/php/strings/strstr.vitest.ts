...
const __locutus_source_fn = require('../../../../src/php/strings/strstr.ts').strstr
const __locutus_source_module_url = new URL("../../../../src/php/strings/strstr.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/strings/strstr (target function module)\nfunction strstr(haystack, needle, bool) {\n    //      discuss at: https://locutus.io/php/strstr/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: strstr('Kevin van Zonneveld', 'van')\n    //       returns 1: 'van Zonneveld'\n    //       example 2: strstr('Kevin van Zonneveld', 'van', true)\n    //       returns 2: 'Kevin '\n    //       example 3: strstr('name@example.com', '@')\n    //       returns 3: '@example.com'\n    //       example 4: strstr('name@example.com', '@', true)\n    //       returns 4: 'name'\n    let pos = 0;\n    haystack += '';\n    pos = haystack.indexOf(needle);\n    if (pos === -1) {\n        return false;\n    }\n    else {\n        if (bool) {\n            return haystack.substr(0, pos);\n        }\n        else {\n            return haystack.slice(pos);\n        }\n    }\n}"
const __locutus_standalone_js_code = "// php/strings/strstr (target function module)\nfunction strstr(haystack, needle, bool) {\n    //      discuss at: https://locutus.io/php/strstr/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: strstr('Kevin van Zonneveld', 'van')\n    //       returns 1: 'van Zonneveld'\n    //       example 2: strstr('Kevin van Zonneveld', 'van', true)\n    //       returns 2: 'Kevin '\n    //       example 3: strstr('name@example.com', '@')\n    //       returns 3: '@example.com'\n    //       example 4: strstr('name@example.com', '@', true)\n    //       returns 4: 'name'\n    let pos = 0;\n    haystack += '';\n    pos = haystack.indexOf(needle);\n    if (pos === -1) {\n        return false;\n    }\n    else {\n        if (bool) {\n            return haystack.substr(0, pos);\n        }\n        else {\n            return haystack.slice(pos);\n        }\n    }\n}"
...
describe('src/php/strings/strstr.ts (tested in test/generated/php/strings/strstr.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strstr: typeof __locutus_source_fn) => {
      return strstr('Kevin van Zonneveld', 'van')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (strstr: typeof __locutus_source_fn) => {
      return strstr('Kevin van Zonneveld', 'van', true)
    }
    for (const __locutus_variant of __locutus_variants) {
      ;(globalThis as { $locutus?: unknown }).$locutus = undefined
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
  ...
  it('should pass example 3', function () {
    ...
    const __locutus_run_example = (strstr: typeof __locutus_source_fn) => {
      return strstr('name@example.com', '@')
    }
    for (const __locutus_variant of __locutus_variants) {
      ;(globalThis as { $locutus?: unknown }).$locutus = undefined
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
  ...
  it('should pass example 4', function () {
    ...
    const __locutus_run_example = (strstr: typeof __locutus_source_fn) => {
      return strstr('name@example.com', '@', true)
    }
    for (const __locutus_variant of __locutus_variants) {
      ;(globalThis as { $locutus?: unknown }).$locutus = undefined
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
