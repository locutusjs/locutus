...
const __locutus_standalone_ts_code = "// php/strings/strtoupper (target function module)\nfunction strtoupper(str) {\n    //      discuss at: https://locutus.io/php/strtoupper/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: strtoupper('Kevin van Zonneveld')\n    //       returns 1: 'KEVIN VAN ZONNEVELD'\n    return (str + '').toUpperCase();\n}"
const __locutus_standalone_js_code = "// php/strings/strtoupper (target function module)\nfunction strtoupper(str) {\n    //      discuss at: https://locutus.io/php/strtoupper/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: strtoupper('Kevin van Zonneveld')\n    //       returns 1: 'KEVIN VAN ZONNEVELD'\n    return (str + '').toUpperCase();\n}"
