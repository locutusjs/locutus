...
const __locutus_source_fn = require('../../../../src/php/strings/parse_str.ts').parse_str
...
describe('src/php/strings/parse_str.ts (tested in test/generated/php/strings/parse_str.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (parse_str: typeof __locutus_source_fn) => {
      var $arr = {}
