...
const __locutus_source_fn = require('../../../../src/php/strings/strtolower.ts').strtolower
const __locutus_source_module_url = new URL("../../../../src/php/strings/strtolower.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "strtolower"
...
const __locutus_standalone_ts_code = "// php/strings/strtolower (target function module)\nfunction strtolower(str) {\n    //      discuss at: https://locutus.io/php/strtolower/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: strtolower('Kevin van Zonneveld')\n    //       returns 1: 'kevin van zonneveld'\n    if (typeof str === 'undefined') {\n        throw new Error('strtolower() expects exactly 1 argument, 0 given');\n    }\n    return (str + '').toLowerCase();\n}"
const __locutus_standalone_js_code = "// php/strings/strtolower (target function module)\nfunction strtolower(str) {\n    //      discuss at: https://locutus.io/php/strtolower/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: strtolower('Kevin van Zonneveld')\n    //       returns 1: 'kevin van zonneveld'\n    if (typeof str === 'undefined') {\n        throw new Error('strtolower() expects exactly 1 argument, 0 given');\n    }\n    return (str + '').toLowerCase();\n}"
...
describe('src/php/strings/strtolower.ts (tested in test/generated/php/strings/strtolower.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strtolower: typeof __locutus_source_fn) => {
      return strtolower('Kevin van Zonneveld')
    }
