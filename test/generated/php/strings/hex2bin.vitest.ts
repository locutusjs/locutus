...
const __locutus_source_fn = require('../../../../src/php/strings/hex2bin.ts').hex2bin
const __locutus_source_module_url = new URL("../../../../src/php/strings/hex2bin.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "hex2bin"
...
const __locutus_standalone_ts_code = "// php/strings/hex2bin (target function module)\nfunction hex2bin(s) {\n    //      discuss at: https://locutus.io/php/hex2bin/\n    // parity verified: PHP 8.3\n    //     original by: Dumitru Uzun (https://duzun.me)\n    //       example 1: hex2bin('44696d61')\n    //       returns 1: 'Dima'\n    //       example 2: hex2bin('00')\n    //       returns 2: '\\x00'\n    //       example 3: hex2bin('2f1q')\n    //       returns 3: false\n    const ret = [];\n    const input = String(s);\n    for (let i = 0; i < input.length; i += 2) {\n        const c = Number.parseInt(input.substring(i, i + 1), 16);\n        const k = Number.parseInt(input.substring(i + 1, i + 2), 16);\n        if (Number.isNaN(c) || Number.isNaN(k)) {\n            return false;\n        }\n        ret.push((c << 4) | k);\n    }\n    return String.fromCharCode.apply(String, ret);\n}"
const __locutus_standalone_js_code = "// php/strings/hex2bin (target function module)\nfunction hex2bin(s) {\n    //      discuss at: https://locutus.io/php/hex2bin/\n    // parity verified: PHP 8.3\n    //     original by: Dumitru Uzun (https://duzun.me)\n    //       example 1: hex2bin('44696d61')\n    //       returns 1: 'Dima'\n    //       example 2: hex2bin('00')\n    //       returns 2: '\\x00'\n    //       example 3: hex2bin('2f1q')\n    //       returns 3: false\n    const ret = [];\n    const input = String(s);\n    for (let i = 0; i < input.length; i += 2) {\n        const c = Number.parseInt(input.substring(i, i + 1), 16);\n        const k = Number.parseInt(input.substring(i + 1, i + 2), 16);\n        if (Number.isNaN(c) || Number.isNaN(k)) {\n            return false;\n        }\n        ret.push((c << 4) | k);\n    }\n    return String.fromCharCode.apply(String, ret);\n}"
...
describe('src/php/strings/hex2bin.ts (tested in test/generated/php/strings/hex2bin.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (hex2bin: typeof __locutus_source_fn) => {
      return hex2bin('44696d61')
    }
