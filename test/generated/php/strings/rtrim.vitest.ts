...
const __locutus_source_fn = require('../../../../src/php/strings/rtrim.ts').rtrim
const __locutus_source_module_url = new URL("../../../../src/php/strings/rtrim.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "rtrim"
...
const __locutus_standalone_ts_code = "// php/strings/rtrim (target function module)\nfunction rtrim(str, charlist) {\n    //      discuss at: https://locutus.io/php/rtrim/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //        input by: Erkekjetter\n    //        input by: rem\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: rtrim('    Kevin van Zonneveld    ')\n    //       returns 1: '    Kevin van Zonneveld'\n    charlist = !charlist ? ' \\\\s\\u00A0' : (charlist + '').replace(/([[\\]().?/*{}+$^:])/g, '\\\\$1');\n    const re = new RegExp('[' + charlist + ']+$', 'g');\n    return (str + '').replace(re, '');\n}"
const __locutus_standalone_js_code = "// php/strings/rtrim (target function module)\nfunction rtrim(str, charlist) {\n    //      discuss at: https://locutus.io/php/rtrim/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //        input by: Erkekjetter\n    //        input by: rem\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: rtrim('    Kevin van Zonneveld    ')\n    //       returns 1: '    Kevin van Zonneveld'\n    charlist = !charlist ? ' \\\\s\\u00A0' : (charlist + '').replace(/([[\\]().?/*{}+$^:])/g, '\\\\$1');\n    const re = new RegExp('[' + charlist + ']+$', 'g');\n    return (str + '').replace(re, '');\n}"
...
describe('src/php/strings/rtrim.ts (tested in test/generated/php/strings/rtrim.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (rtrim: typeof __locutus_source_fn) => {
      return rtrim('    Kevin van Zonneveld    ')
    }
