...
const __locutus_source_fn = require('../../../../src/php/strings/split.ts').split
const __locutus_source_module_url = new URL("../../../../src/php/strings/split.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "split"
const __locutus_module_js_code = "\"use strict\";\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.split = split;\nconst explode_ts_1 = require(\"../strings/explode.ts\");\nfunction split(delimiter, string) {\n    //      discuss at: https://locutus.io/php/split/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: split(' ', 'Kevin van Zonneveld')\n    //       returns 1: ['Kevin', 'van', 'Zonneveld']\n    return (0, explode_ts_1.explode)(delimiter, string);\n}"
...
const __locutus_standalone_js_code = "// php/strings/explode (Locutus dependency module)\nfunction explode(...args) {\n    //      discuss at: https://locutus.io/php/explode/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: explode(' ', 'Kevin van Zonneveld')\n    //       returns 1: [ 'Kevin', 'van', 'Zonneveld' ]\n    let [delimiterRaw, stringRaw, limit] = args;\n    let delimiter = delimiterRaw;\n    const string = stringRaw;\n    if (args.length < 2 || typeof delimiter === 'undefined' || typeof string === 'undefined') {\n        return null;\n    }\n    if (delimiter === '' || delimiter === false || delimiter === null) {\n        return false;\n    }\n    if (typeof delimiter === 'function' ||\n        typeof delimiter === 'object' ||\n        typeof string === 'function' ||\n        typeof string === 'object') {\n        return {\n            0: '',\n        };\n    }\n    if (delimiter === true) {\n        delimiter = '1';\n    }\n    // Here we go...\n    const normalizedDelimiter = delimiter + '';\n    const normalizedString = string + '';\n    const s = normalizedString.split(normalizedDelimiter);\n    if (typeof limit === 'undefined') {\n        return s;\n    }\n    // Support for limit\n    if (limit === 0) {\n        limit = 1;\n    }\n    // Positive limit\n    if (limit > 0) {\n        if (limit >= s.length) {\n            return s;\n        }\n        return s.slice(0, limit - 1).concat([s.slice(limit - 1).join(normalizedDelimiter)]);\n    }\n    // Negative limit\n    if (-limit >= s.length) {\n        return [];\n    }\n    s.splice(s.length + limit);\n    return s;\n}\n// php/strings/split (target function module)\nfunction split(delimiter, string) {\n    //      discuss at: https://locutus.io/php/split/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: split(' ', 'Kevin van Zonneveld')\n    //       returns 1: ['Kevin', 'van', 'Zonneveld']\n    return explode(delimiter, string);\n}"
...
describe('src/php/strings/split.ts (tested in test/generated/php/strings/split.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (split: typeof __locutus_source_fn) => {
      return split(' ', 'Kevin van Zonneveld')
    }
