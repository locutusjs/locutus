...
const __locutus_source_fn = require('../../../../src/php/strings/stripos.ts').stripos
const __locutus_source_module_url = new URL("../../../../src/php/strings/stripos.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "stripos"
...
const __locutus_standalone_ts_code = "// php/strings/stripos (target function module)\nfunction stripos(fHaystack, fNeedle, fOffset) {\n    //      discuss at: https://locutus.io/php/stripos/\n    // parity verified: PHP 8.3\n    //     original by: Martijn Wieringa\n    //      revised by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: stripos('ABC', 'a')\n    //       returns 1: 0\n    const haystack = (fHaystack + '').toLowerCase();\n    const needle = (fNeedle + '').toLowerCase();\n    let index = 0;\n    if ((index = haystack.indexOf(needle, fOffset)) !== -1) {\n        return index;\n    }\n    return false;\n}"
const __locutus_standalone_js_code = "// php/strings/stripos (target function module)\nfunction stripos(fHaystack, fNeedle, fOffset) {\n    //      discuss at: https://locutus.io/php/stripos/\n    // parity verified: PHP 8.3\n    //     original by: Martijn Wieringa\n    //      revised by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: stripos('ABC', 'a')\n    //       returns 1: 0\n    const haystack = (fHaystack + '').toLowerCase();\n    const needle = (fNeedle + '').toLowerCase();\n    let index = 0;\n    if ((index = haystack.indexOf(needle, fOffset)) !== -1) {\n        return index;\n    }\n    return false;\n}"
...
describe('src/php/strings/stripos.ts (tested in test/generated/php/strings/stripos.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (stripos: typeof __locutus_source_fn) => {
      return stripos('ABC', 'a')
    }
