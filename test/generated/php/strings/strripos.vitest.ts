...
const __locutus_source_fn = require('../../../../src/php/strings/strripos.ts').strripos
const __locutus_source_module_url = new URL("../../../../src/php/strings/strripos.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "strripos"
...
const __locutus_standalone_ts_code = "// php/strings/strripos (target function module)\nfunction strripos(haystack, needle, offset) {\n    //      discuss at: https://locutus.io/php/strripos/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //        input by: saulius\n    //       example 1: strripos('Kevin van Zonneveld', 'E')\n    //       returns 1: 16\n    haystack = (haystack + '').toLowerCase();\n    needle = (needle + '').toLowerCase();\n    let i = -1;\n    if (typeof offset === 'number') {\n        i = (haystack + '').slice(offset).lastIndexOf(needle); // strrpos' offset indicates starting point of range till end,\n        // while lastIndexOf's optional 2nd argument indicates ending point of range from the beginning\n        if (i !== -1) {\n            i += offset;\n        }\n    }\n    else {\n        i = (haystack + '').lastIndexOf(needle);\n    }\n    return i >= 0 ? i : false;\n}"
const __locutus_standalone_js_code = "// php/strings/strripos (target function module)\nfunction strripos(haystack, needle, offset) {\n    //      discuss at: https://locutus.io/php/strripos/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //        input by: saulius\n    //       example 1: strripos('Kevin van Zonneveld', 'E')\n    //       returns 1: 16\n    haystack = (haystack + '').toLowerCase();\n    needle = (needle + '').toLowerCase();\n    let i = -1;\n    if (typeof offset === 'number') {\n        i = (haystack + '').slice(offset).lastIndexOf(needle); // strrpos' offset indicates starting point of range till end,\n        // while lastIndexOf's optional 2nd argument indicates ending point of range from the beginning\n        if (i !== -1) {\n            i += offset;\n        }\n    }\n    else {\n        i = (haystack + '').lastIndexOf(needle);\n    }\n    return i >= 0 ? i : false;\n}"
...
describe('src/php/strings/strripos.ts (tested in test/generated/php/strings/strripos.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strripos: typeof __locutus_source_fn) => {
      return strripos('Kevin van Zonneveld', 'E')
    }
