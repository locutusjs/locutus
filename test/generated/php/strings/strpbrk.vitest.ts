...
const __locutus_source_fn = require('../../../../src/php/strings/strpbrk.ts').strpbrk
const __locutus_source_module_url = new URL("../../../../src/php/strings/strpbrk.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "strpbrk"
...
const __locutus_standalone_ts_code = "// php/strings/strpbrk (target function module)\nfunction strpbrk(haystack, charList) {\n    //      discuss at: https://locutus.io/php/strpbrk/\n    // parity verified: PHP 8.3\n    //     original by: Alfonso Jimenez (https://www.alfonsojimenez.com)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //      revised by: Christoph\n    //     improved by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: strpbrk('This is a Simple text.', 'is')\n    //       returns 1: 'is is a Simple text.'\n    for (let i = 0, len = haystack.length; i < len; ++i) {\n        if (charList.indexOf(haystack.charAt(i)) >= 0) {\n            return haystack.slice(i);\n        }\n    }\n    return false;\n}"
const __locutus_standalone_js_code = "// php/strings/strpbrk (target function module)\nfunction strpbrk(haystack, charList) {\n    //      discuss at: https://locutus.io/php/strpbrk/\n    // parity verified: PHP 8.3\n    //     original by: Alfonso Jimenez (https://www.alfonsojimenez.com)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //      revised by: Christoph\n    //     improved by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: strpbrk('This is a Simple text.', 'is')\n    //       returns 1: 'is is a Simple text.'\n    for (let i = 0, len = haystack.length; i < len; ++i) {\n        if (charList.indexOf(haystack.charAt(i)) >= 0) {\n            return haystack.slice(i);\n        }\n    }\n    return false;\n}"
...
describe('src/php/strings/strpbrk.ts (tested in test/generated/php/strings/strpbrk.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strpbrk: typeof __locutus_source_fn) => {
      return strpbrk('This is a Simple text.', 'is')
    }
