...
const __locutus_source_fn = require('../../../../src/php/strings/quotemeta.ts').quotemeta
const __locutus_source_module_url = new URL("../../../../src/php/strings/quotemeta.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// php/strings/quotemeta (target function module)\nfunction quotemeta(str) {\n    //      discuss at: https://locutus.io/php/quotemeta/\n    // parity verified: PHP 8.3\n    //     original by: Paulo Freitas\n    //       example 1: quotemeta(\". + * ? ^ ( $ )\")\n    //       returns 1: '\\\\. \\\\+ \\\\* \\\\? \\\\^ \\\\( \\\\$ \\\\)'\n    return (str + '').replace(/([.\\\\+*?[^\\]$()])/g, '\\\\$1');\n}"
const __locutus_standalone_js_code = "// php/strings/quotemeta (target function module)\nfunction quotemeta(str) {\n    //      discuss at: https://locutus.io/php/quotemeta/\n    // parity verified: PHP 8.3\n    //     original by: Paulo Freitas\n    //       example 1: quotemeta(\". + * ? ^ ( $ )\")\n    //       returns 1: '\\\\. \\\\+ \\\\* \\\\? \\\\^ \\\\( \\\\$ \\\\)'\n    return (str + '').replace(/([.\\\\+*?[^\\]$()])/g, '\\\\$1');\n}"
...
describe('src/php/strings/quotemeta.ts (tested in test/generated/php/strings/quotemeta.vitest.ts)', function () {
