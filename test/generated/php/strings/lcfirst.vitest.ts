...
const __locutus_source_fn = require('../../../../src/php/strings/lcfirst.ts').lcfirst
const __locutus_source_module_url = new URL("../../../../src/php/strings/lcfirst.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "lcfirst"
...
const __locutus_standalone_ts_code = "// php/strings/lcfirst (target function module)\nfunction lcfirst(str) {\n    //      discuss at: https://locutus.io/php/lcfirst/\n    // parity verified: PHP 8.3\n    //     original by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: lcfirst('Kevin Van Zonneveld')\n    //       returns 1: 'kevin Van Zonneveld'\n    str += '';\n    const f = str.charAt(0).toLowerCase();\n    return f + str.substr(1);\n}"
const __locutus_standalone_js_code = "// php/strings/lcfirst (target function module)\nfunction lcfirst(str) {\n    //      discuss at: https://locutus.io/php/lcfirst/\n    // parity verified: PHP 8.3\n    //     original by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: lcfirst('Kevin Van Zonneveld')\n    //       returns 1: 'kevin Van Zonneveld'\n    str += '';\n    const f = str.charAt(0).toLowerCase();\n    return f + str.substr(1);\n}"
...
describe('src/php/strings/lcfirst.ts (tested in test/generated/php/strings/lcfirst.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (lcfirst: typeof __locutus_source_fn) => {
      return lcfirst('Kevin Van Zonneveld')
    }
