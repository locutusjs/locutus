...
const __locutus_source_fn = require('../../../../src/php/strings/ltrim.ts').ltrim
const __locutus_source_module_url = new URL("../../../../src/php/strings/ltrim.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "ltrim"
...
const __locutus_standalone_ts_code = "// php/strings/ltrim (target function module)\nfunction ltrim(str, charlist) {\n    //      discuss at: https://locutus.io/php/ltrim/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //        input by: Erkekjetter\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: ltrim('    Kevin van Zonneveld    ')\n    //       returns 1: 'Kevin van Zonneveld    '\n    if (typeof str === 'undefined') {\n        throw new Error('ltrim() expects at least 1 argument, 0 given');\n    }\n    charlist = !charlist ? ' \\\\s\\u00A0' : (charlist + '').replace(/([[\\]().?/*{}+$^:])/g, '$1');\n    const re = new RegExp('^[' + charlist + ']+', 'g');\n    return (str + '').replace(re, '');\n}"
const __locutus_standalone_js_code = "// php/strings/ltrim (target function module)\nfunction ltrim(str, charlist) {\n    //      discuss at: https://locutus.io/php/ltrim/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //        input by: Erkekjetter\n    //     improved by: Kevin van Zonneveld (https://kvz.io)\n    //     bugfixed by: Onno Marsman (https://twitter.com/onnomarsman)\n    //       example 1: ltrim('    Kevin van Zonneveld    ')\n    //       returns 1: 'Kevin van Zonneveld    '\n    if (typeof str === 'undefined') {\n        throw new Error('ltrim() expects at least 1 argument, 0 given');\n    }\n    charlist = !charlist ? ' \\\\s\\u00A0' : (charlist + '').replace(/([[\\]().?/*{}+$^:])/g, '$1');\n    const re = new RegExp('^[' + charlist + ']+', 'g');\n    return (str + '').replace(re, '');\n}"
...
describe('src/php/strings/ltrim.ts (tested in test/generated/php/strings/ltrim.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (ltrim: typeof __locutus_source_fn) => {
      return ltrim('    Kevin van Zonneveld    ')
    }
