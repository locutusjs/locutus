...
const __locutus_source_fn = require('../../../../src/php/strings/join.ts').join
const __locutus_source_module_url = new URL("../../../../src/php/strings/join.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "join"
const __locutus_module_js_code = "\"use strict\";\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.join = join;\nconst implode_ts_1 = require(\"../strings/implode.ts\");\nfunction join(glue, pieces) {\n    //      discuss at: https://locutus.io/php/join/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: join(' ', ['Kevin', 'van', 'Zonneveld'])\n    //       returns 1: 'Kevin van Zonneveld'\n    return (0, implode_ts_1.implode)(glue, pieces);\n}"
...
const __locutus_standalone_js_code = "// php/strings/implode (Locutus dependency module)\nfunction implode(...providedArgs) {\n    //      discuss at: https://locutus.io/php/implode/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //     improved by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //     improved by: Itsacon (https://www.itsacon.net/)\n    //     bugfixed by: Brett Zamir (https://brett-zamir.me)\n    //       example 1: implode(' ', ['Kevin', 'van', 'Zonneveld'])\n    //       returns 1: 'Kevin van Zonneveld'\n    //       example 2: implode(' ', {first:'Kevin', last: 'van Zonneveld'})\n    //       returns 2: 'Kevin van Zonneveld'\n    let retVal = '';\n    let tGlue = '';\n    let actualGlue = '';\n    let actualPieces;\n    if (providedArgs.length === 1) {\n        const [glueOrPieces] = providedArgs;\n        actualPieces = glueOrPieces;\n    }\n    else {\n        const [glueOrPieces, pieces] = providedArgs;\n        actualGlue = String(glueOrPieces ?? '');\n        actualPieces = pieces;\n    }\n    if (typeof actualPieces === 'object' && actualPieces !== null) {\n        if (Array.isArray(actualPieces)) {\n            return actualPieces.join(actualGlue);\n        }\n        for (const key in actualPieces) {\n            retVal += tGlue + actualPieces[key];\n            tGlue = actualGlue;\n        }\n        return retVal;\n    }\n    return String(actualPieces);\n}\n// php/strings/join (target function module)\nfunction join(glue, pieces) {\n    //      discuss at: https://locutus.io/php/join/\n    // parity verified: PHP 8.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: join(' ', ['Kevin', 'van', 'Zonneveld'])\n    //       returns 1: 'Kevin van Zonneveld'\n    return implode(glue, pieces);\n}"
...
describe('src/php/strings/join.ts (tested in test/generated/php/strings/join.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (join: typeof __locutus_source_fn) => {
      return join(' ', ['Kevin', 'van', 'Zonneveld'])
    }
