...
const __locutus_source_fn = require('../../../../src/php/strings/strncmp.ts').strncmp
const __locutus_source_module_url = new URL("../../../../src/php/strings/strncmp.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "strncmp"
...
const __locutus_standalone_ts_code = "// php/strings/strncmp (target function module)\nfunction strncmp(str1, str2, lgth) {\n    //       discuss at: https://locutus.io/php/strncmp/\n    //  parity verified: PHP 8.3\n    //      original by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //         input by: Steve Hilder\n    //      improved by: Kevin van Zonneveld (https://kvz.io)\n    //       revised by: gorthaur\n    // reimplemented by: Brett Zamir (https://brett-zamir.me)\n    //        example 1: strncmp('aaa', 'aab', 2)\n    //        returns 1: 0\n    //        example 2: strncmp('aaa', 'aab', 3 )\n    //        returns 2: -1\n    const s1 = (str1 + '').substr(0, lgth);\n    const s2 = (str2 + '').substr(0, lgth);\n    return s1 === s2 ? 0 : s1 > s2 ? 1 : -1;\n}"
const __locutus_standalone_js_code = "// php/strings/strncmp (target function module)\nfunction strncmp(str1, str2, lgth) {\n    //       discuss at: https://locutus.io/php/strncmp/\n    //  parity verified: PHP 8.3\n    //      original by: Waldo Malqui Silva (https://waldo.malqui.info)\n    //         input by: Steve Hilder\n    //      improved by: Kevin van Zonneveld (https://kvz.io)\n    //       revised by: gorthaur\n    // reimplemented by: Brett Zamir (https://brett-zamir.me)\n    //        example 1: strncmp('aaa', 'aab', 2)\n    //        returns 1: 0\n    //        example 2: strncmp('aaa', 'aab', 3 )\n    //        returns 2: -1\n    const s1 = (str1 + '').substr(0, lgth);\n    const s2 = (str2 + '').substr(0, lgth);\n    return s1 === s2 ? 0 : s1 > s2 ? 1 : -1;\n}"
...
describe('src/php/strings/strncmp.ts (tested in test/generated/php/strings/strncmp.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (strncmp: typeof __locutus_source_fn) => {
      return strncmp('aaa', 'aab', 2)
    }
