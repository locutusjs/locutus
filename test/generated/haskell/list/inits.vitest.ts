...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/haskell/list/inits.ts').inits
const __locutus_source_module_url = new URL("../../../../src/haskell/list/inits.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "inits"
const __locutus_module_js_code = "\"use strict\";\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.inits = inits;\nfunction inits(items) {\n    //  discuss at: https://locutus.io/haskell/list/inits/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns all prefixes from shortest to longest, like Haskell Data.List.inits.\n    //   example 1: inits([1, 2, 3])\n    //   returns 1: [[], [1], [1, 2], [1, 2, 3]]\n    //   example 2: inits(['a', 'b'])\n    //   returns 2: [[], ['a'], ['a', 'b']]\n    //   example 3: inits([])\n    //   returns 3: [[]]\n    if (!Array.isArray(items)) {\n        return [];\n    }\n    const out = [[]];\n    for (let i = 1; i <= items.length; i++) {\n        out.push(items.slice(0, i));\n    }\n    return out;\n}"
const __locutus_standalone_ts_code = "// haskell/list/inits (target function module)\nfunction inits(items) {\n    //  discuss at: https://locutus.io/haskell/list/inits/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns all prefixes from shortest to longest, like Haskell Data.List.inits.\n    //   example 1: inits([1, 2, 3])\n    //   returns 1: [[], [1], [1, 2], [1, 2, 3]]\n    //   example 2: inits(['a', 'b'])\n    //   returns 2: [[], ['a'], ['a', 'b']]\n    //   example 3: inits([])\n    //   returns 3: [[]]\n    if (!Array.isArray(items)) {\n        return [];\n    }\n    const out = [[]];\n    for (let i = 1; i <= items.length; i++) {\n        out.push(items.slice(0, i));\n    }\n    return out;\n}"
const __locutus_standalone_js_code = "// haskell/list/inits (target function module)\nfunction inits(items) {\n    //  discuss at: https://locutus.io/haskell/list/inits/\n    // original by: Kevin van Zonneveld (https://kvz.io)\n    //      note 1: Returns all prefixes from shortest to longest, like Haskell Data.List.inits.\n    //   example 1: inits([1, 2, 3])\n    //   returns 1: [[], [1], [1, 2], [1, 2, 3]]\n    //   example 2: inits(['a', 'b'])\n    //   returns 2: [[], ['a'], ['a', 'b']]\n    //   example 3: inits([])\n    //   returns 3: [[]]\n    if (!Array.isArray(items)) {\n        return [];\n    }\n    const out = [[]];\n    for (let i = 1; i <= items.length; i++) {\n        out.push(items.slice(0, i));\n    }\n    return out;\n}"
...
describe('src/haskell/list/inits.ts (tested in test/generated/haskell/list/inits.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (inits: typeof __locutus_source_fn) => {
      return inits([1, 2, 3])
    }
