...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/path/Join.ts').Join
const __locutus_source_module_url = new URL("../../../../src/golang/path/Join.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/path/Join (target function module)\nconst cleanPath = (path) => {\n    if (path === '') {\n        return '.';\n    }\n    const rooted = path.startsWith('/');\n    const segments = path.split('/');\n    const stack = [];\n    for (const segment of segments) {\n        if (segment === '' || segment === '.') {\n            continue;\n        }\n        if (segment === '..') {\n            const top = stack[stack.length - 1];\n            if (top && top !== '..') {\n                stack.pop();\n            }\n            else if (!rooted) {\n                stack.push('..');\n            }\n            continue;\n        }\n        stack.push(segment);\n    }\n    const cleaned = `${rooted ? '/' : ''}${stack.join('/')}`;\n    if (cleaned === '') {\n        return rooted ? '/' : '.';\n    }\n    return cleaned;\n};\nfunction Join(...elem) {\n    //      discuss at: https://locutus.io/golang/path/Join\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Join('a', 'b', 'c')\n    //       returns 1: 'a/b/c'\n    //       example 2: Join('/a/', '/b/', 'c')\n    //       returns 2: '/a/b/c'\n    //       example 3: Join('a', '..', 'b')\n    //       returns 3: 'b'\n    //       example 4: Join('', '')\n    //       returns 4: ''\n    const parts = elem.map((value) => String(value));\n    if (parts.every((value) => value === '')) {\n        return '';\n    }\n    return cleanPath(parts.join('/'));\n}"
const __locutus_standalone_js_code = "// golang/path/Join (target function module)\nconst cleanPath = (path) => {\n    if (path === '') {\n        return '.';\n    }\n    const rooted = path.startsWith('/');\n    const segments = path.split('/');\n    const stack = [];\n    for (const segment of segments) {\n        if (segment === '' || segment === '.') {\n            continue;\n        }\n        if (segment === '..') {\n            const top = stack[stack.length - 1];\n            if (top && top !== '..') {\n                stack.pop();\n            }\n            else if (!rooted) {\n                stack.push('..');\n            }\n            continue;\n        }\n        stack.push(segment);\n    }\n    const cleaned = `${rooted ? '/' : ''}${stack.join('/')}`;\n    if (cleaned === '') {\n        return rooted ? '/' : '.';\n    }\n    return cleaned;\n};\nfunction Join(...elem) {\n    //      discuss at: https://locutus.io/golang/path/Join\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Join('a', 'b', 'c')\n    //       returns 1: 'a/b/c'\n    //       example 2: Join('/a/', '/b/', 'c')\n    //       returns 2: '/a/b/c'\n    //       example 3: Join('a', '..', 'b')\n    //       returns 3: 'b'\n    //       example 4: Join('', '')\n    //       returns 4: ''\n    const parts = elem.map((value) => String(value));\n    if (parts.every((value) => value === '')) {\n        return '';\n    }\n    return cleanPath(parts.join('/'));\n}"
...
describe('src/golang/path/Join.ts (tested in test/generated/golang/path/Join.vitest.ts)', function () {
