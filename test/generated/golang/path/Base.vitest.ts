...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/path/Base.ts').Base
const __locutus_source_module_url = new URL("../../../../src/golang/path/Base.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/path/Base (target function module)\nfunction Base(path) {\n    //      discuss at: https://locutus.io/golang/path/Base\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Base('/a/b/c.txt')\n    //       returns 1: 'c.txt'\n    //       example 2: Base('/a/b/')\n    //       returns 2: 'b'\n    //       example 3: Base('')\n    //       returns 3: '.'\n    //       example 4: Base('////')\n    //       returns 4: '/'\n    const raw = String(path);\n    if (raw === '') {\n        return '.';\n    }\n    let end = raw.length;\n    while (end > 0 && raw[end - 1] === '/') {\n        end -= 1;\n    }\n    if (end === 0) {\n        return '/';\n    }\n    const trimmed = raw.slice(0, end);\n    const slash = trimmed.lastIndexOf('/');\n    if (slash < 0) {\n        return trimmed;\n    }\n    return trimmed.slice(slash + 1);\n}"
const __locutus_standalone_js_code = "// golang/path/Base (target function module)\nfunction Base(path) {\n    //      discuss at: https://locutus.io/golang/path/Base\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Base('/a/b/c.txt')\n    //       returns 1: 'c.txt'\n    //       example 2: Base('/a/b/')\n    //       returns 2: 'b'\n    //       example 3: Base('')\n    //       returns 3: '.'\n    //       example 4: Base('////')\n    //       returns 4: '/'\n    const raw = String(path);\n    if (raw === '') {\n        return '.';\n    }\n    let end = raw.length;\n    while (end > 0 && raw[end - 1] === '/') {\n        end -= 1;\n    }\n    if (end === 0) {\n        return '/';\n    }\n    const trimmed = raw.slice(0, end);\n    const slash = trimmed.lastIndexOf('/');\n    if (slash < 0) {\n        return trimmed;\n    }\n    return trimmed.slice(slash + 1);\n}"
...
describe('src/golang/path/Base.ts (tested in test/generated/golang/path/Base.vitest.ts)', function () {
