...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strconv/Itoa.ts').Itoa
const __locutus_source_module_url = new URL("../../../../src/golang/strconv/Itoa.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "Itoa"
...
const __locutus_standalone_ts_code = "// golang/strconv/Itoa (target function module)\nfunction Itoa(i) {\n    //      discuss at: https://locutus.io/golang/strconv/Itoa\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts an integer to its decimal string representation.\n    //       example 1: Itoa(42)\n    //       returns 1: '42'\n    //       example 2: Itoa(-123)\n    //       returns 2: '-123'\n    //       example 3: Itoa(0)\n    //       returns 3: '0'\n    return String(Number.parseInt(String(i), 10));\n}"
const __locutus_standalone_js_code = "// golang/strconv/Itoa (target function module)\nfunction Itoa(i) {\n    //      discuss at: https://locutus.io/golang/strconv/Itoa\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts an integer to its decimal string representation.\n    //       example 1: Itoa(42)\n    //       returns 1: '42'\n    //       example 2: Itoa(-123)\n    //       returns 2: '-123'\n    //       example 3: Itoa(0)\n    //       returns 3: '0'\n    return String(Number.parseInt(String(i), 10));\n}"
...
describe('src/golang/strconv/Itoa.ts (tested in test/generated/golang/strconv/Itoa.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (Itoa: typeof __locutus_source_fn) => {
      return Itoa(42)
    }
