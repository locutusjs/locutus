...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/time/Sub.ts').Sub
const __locutus_source_module_url = new URL("../../../../src/golang/time/Sub.ts", import.meta.url)
...
const __locutus_standalone_js_code = "// golang/time/Sub (target function module)\nconst toTimeDate = (value) => {\n    const date = value instanceof Date ? new Date(value.getTime()) : new Date(value);\n    if (Number.isNaN(date.getTime())) {\n        throw new TypeError('Sub(): invalid date input');\n    }\n    return date;\n};\nfunction Sub(left, right) {\n    //      discuss at: https://locutus.io/golang/time/Sub\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the duration in milliseconds between two instants (left - right).\n    //       example 1: Sub('2026-03-03T13:14:15.500Z', '2026-03-03T13:14:15.000Z')\n    //       returns 1: 500\n    //       example 2: Sub('2026-03-03T13:14:10.000Z', '2026-03-03T13:14:15.000Z')\n    //       returns 2: -5000\n    return toTimeDate(left).getTime() - toTimeDate(right).getTime();\n}"
...
describe('src/golang/time/Sub.ts (tested in test/generated/golang/time/Sub.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (Sub: typeof __locutus_source_fn) => {
      return Sub('2026-03-03T13:14:15.500Z', '2026-03-03T13:14:15.000Z')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (Sub: typeof __locutus_source_fn) => {
      return Sub('2026-03-03T13:14:10.000Z', '2026-03-03T13:14:15.000Z')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
