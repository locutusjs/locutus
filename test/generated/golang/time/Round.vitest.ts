...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/time/Round.ts').Round
const __locutus_source_module_url = new URL("../../../../src/golang/time/Round.ts", import.meta.url)
...
const __locutus_standalone_js_code = "// golang/time/Round (target function module)\nconst toTimeDate = (value) => {\n    const date = value instanceof Date ? new Date(value.getTime()) : new Date(value);\n    if (Number.isNaN(date.getTime())) {\n        throw new TypeError('Round(): invalid date input');\n    }\n    return date;\n};\nfunction Round(value, unitMs) {\n    //      discuss at: https://locutus.io/golang/time/Round\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Rounds an instant to the nearest multiple of `unitMs`.\n    //       example 1: Round('2026-03-03T13:14:15.600Z', 1000).toISOString()\n    //       returns 1: '2026-03-03T13:14:16.000Z'\n    //       example 2: Round('2026-03-03T13:14:15.400Z', 1000).toISOString()\n    //       returns 2: '2026-03-03T13:14:15.000Z'\n    //       example 3: Round('2026-03-03T13:14:44.900Z', 60000).toISOString()\n    //       returns 3: '2026-03-03T13:15:00.000Z'\n    const date = toTimeDate(value);\n    const unit = Number(unitMs);\n    if (!Number.isFinite(unit) || unit <= 0) {\n        throw new TypeError('Round(): invalid unit');\n    }\n    return new Date(Math.round(date.getTime() / unit) * unit);\n}"
...
describe('src/golang/time/Round.ts (tested in test/generated/golang/time/Round.vitest.ts)', function () {
  it('should pass example 1', function () {
    const expected = '2026-03-03T13:14:16.000Z'
    ...
    const __locutus_run_example = (Round: typeof __locutus_source_fn) => {
      return Round('2026-03-03T13:14:15.600Z', 1000).toISOString()
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (Round: typeof __locutus_source_fn) => {
      return Round('2026-03-03T13:14:15.400Z', 1000).toISOString()
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
  ...
  it('should pass example 3', function () {
    const expected = '2026-03-03T13:15:00.000Z'
    const __locutus_variants: Array<{ name: string; fn: (...args: unknown[]) => unknown }> = [
      { name: "source", fn: __locutus_source_fn },
      { name: "module-js", fn: __locutus_module_js_fn },
      { name: "standalone-ts", fn: __locutus_standalone_ts_fn },
    ...
    const __locutus_run_example = (Round: typeof __locutus_source_fn) => {
      return Round('2026-03-03T13:14:44.900Z', 60000).toISOString()
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
