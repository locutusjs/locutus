...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/time/Equal.ts').Equal
const __locutus_source_module_url = new URL("../../../../src/golang/time/Equal.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "Equal"
...
const __locutus_standalone_js_code = "// golang/time/Equal (target function module)\nconst toTimeDate = (value) => {\n    const date = value instanceof Date ? new Date(value.getTime()) : new Date(value);\n    if (Number.isNaN(date.getTime())) {\n        throw new TypeError('Equal(): invalid date input');\n    }\n    return date;\n};\nfunction Equal(left, right) {\n    //      discuss at: https://locutus.io/golang/time/Equal\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Equal('2026-03-03T13:14:15.000Z', '2026-03-03T15:14:15.000+02:00')\n    //       returns 1: true\n    //       example 2: Equal('2026-03-03T13:14:15.001Z', '2026-03-03T13:14:15.000Z')\n    //       returns 2: false\n    return toTimeDate(left).getTime() === toTimeDate(right).getTime();\n}"
...
describe('src/golang/time/Equal.ts (tested in test/generated/golang/time/Equal.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (Equal: typeof __locutus_source_fn) => {
      return Equal('2026-03-03T13:14:15.000Z', '2026-03-03T15:14:15.000+02:00')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (Equal: typeof __locutus_source_fn) => {
      return Equal('2026-03-03T13:14:15.001Z', '2026-03-03T13:14:15.000Z')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
