...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/filepath/IsAbs.ts').IsAbs
const __locutus_source_module_url = new URL("../../../../src/golang/filepath/IsAbs.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/filepath/IsAbs (target function module)\nfunction IsAbs(path) {\n    //      discuss at: https://locutus.io/golang/filepath/IsAbs\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Mirrors path/filepath.IsAbs for slash-separated paths on the Go parity target.\n    //       example 1: IsAbs('/a/b')\n    //       returns 1: true\n    //       example 2: IsAbs('a/b')\n    //       returns 2: false\n    //       example 3: IsAbs('')\n    //       returns 3: false\n    return String(path).startsWith('/');\n}"
const __locutus_standalone_js_code = "// golang/filepath/IsAbs (target function module)\nfunction IsAbs(path) {\n    //      discuss at: https://locutus.io/golang/filepath/IsAbs\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Mirrors path/filepath.IsAbs for slash-separated paths on the Go parity target.\n    //       example 1: IsAbs('/a/b')\n    //       returns 1: true\n    //       example 2: IsAbs('a/b')\n    //       returns 2: false\n    //       example 3: IsAbs('')\n    //       returns 3: false\n    return String(path).startsWith('/');\n}"
...
describe('src/golang/filepath/IsAbs.ts (tested in test/generated/golang/filepath/IsAbs.vitest.ts)', function () {
