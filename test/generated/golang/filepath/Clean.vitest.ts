...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/filepath/Clean.ts').Clean
const __locutus_source_module_url = new URL("../../../../src/golang/filepath/Clean.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "Clean"
...
const __locutus_standalone_ts_code = "// golang/filepath/Clean (target function module)\nfunction Clean(path) {\n    //      discuss at: https://locutus.io/golang/filepath/Clean\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Mirrors path/filepath.Clean for slash-separated paths on the Go parity target.\n    //       example 1: Clean('/a//b/../c/.')\n    //       returns 1: '/a/c'\n    //       example 2: Clean('a/../../b')\n    //       returns 2: '../b'\n    //       example 3: Clean('')\n    //       returns 3: '.'\n    const raw = String(path);\n    if (raw === '') {\n        return '.';\n    }\n    const rooted = raw.startsWith('/');\n    const segments = raw.split('/');\n    const stack = [];\n    for (const segment of segments) {\n        if (segment === '' || segment === '.') {\n            continue;\n        }\n        if (segment === '..') {\n            const top = stack.at(-1);\n            if (top && top !== '..') {\n                stack.pop();\n            }\n            else if (!rooted) {\n                stack.push('..');\n            }\n            continue;\n        }\n        stack.push(segment);\n    }\n    const cleaned = `${rooted ? '/' : ''}${stack.join('/')}`;\n    if (cleaned === '') {\n        return rooted ? '/' : '.';\n    }\n    return cleaned;\n}"
const __locutus_standalone_js_code = "// golang/filepath/Clean (target function module)\nfunction Clean(path) {\n    //      discuss at: https://locutus.io/golang/filepath/Clean\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Mirrors path/filepath.Clean for slash-separated paths on the Go parity target.\n    //       example 1: Clean('/a//b/../c/.')\n    //       returns 1: '/a/c'\n    //       example 2: Clean('a/../../b')\n    //       returns 2: '../b'\n    //       example 3: Clean('')\n    //       returns 3: '.'\n    const raw = String(path);\n    if (raw === '') {\n        return '.';\n    }\n    const rooted = raw.startsWith('/');\n    const segments = raw.split('/');\n    const stack = [];\n    for (const segment of segments) {\n        if (segment === '' || segment === '.') {\n            continue;\n        }\n        if (segment === '..') {\n            const top = stack.at(-1);\n            if (top && top !== '..') {\n                stack.pop();\n            }\n            else if (!rooted) {\n                stack.push('..');\n            }\n            continue;\n        }\n        stack.push(segment);\n    }\n    const cleaned = `${rooted ? '/' : ''}${stack.join('/')}`;\n    if (cleaned === '') {\n        return rooted ? '/' : '.';\n    }\n    return cleaned;\n}"
...
describe('src/golang/filepath/Clean.ts (tested in test/generated/golang/filepath/Clean.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (Clean: typeof __locutus_source_fn) => {
      return Clean('/a//b/../c/.')
    }
