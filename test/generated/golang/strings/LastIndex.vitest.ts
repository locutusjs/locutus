...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/LastIndex.ts').LastIndex
const __locutus_source_module_url = new URL("../../../../src/golang/strings/LastIndex.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "LastIndex"
...
const __locutus_standalone_ts_code = "// golang/strings/LastIndex (target function module)\nfunction LastIndex(s, sep) {\n    //      discuss at: https://locutus.io/golang/strings/LastIndex\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //        input by: GopherJS (https://www.gopherjs.org/)\n    //       example 1: LastIndex('go gopher', 'go')\n    //       returns 1: 3\n    //       example 2: LastIndex('go gopher', 'rodent')\n    //       returns 2: -1\n    return s.lastIndexOf(sep);\n}"
const __locutus_standalone_js_code = "// golang/strings/LastIndex (target function module)\nfunction LastIndex(s, sep) {\n    //      discuss at: https://locutus.io/golang/strings/LastIndex\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //        input by: GopherJS (https://www.gopherjs.org/)\n    //       example 1: LastIndex('go gopher', 'go')\n    //       returns 1: 3\n    //       example 2: LastIndex('go gopher', 'rodent')\n    //       returns 2: -1\n    return s.lastIndexOf(sep);\n}"
...
describe('src/golang/strings/LastIndex.ts (tested in test/generated/golang/strings/LastIndex.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (LastIndex: typeof __locutus_source_fn) => {
      return LastIndex('go gopher', 'go')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (LastIndex: typeof __locutus_source_fn) => {
      return LastIndex('go gopher', 'rodent')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
