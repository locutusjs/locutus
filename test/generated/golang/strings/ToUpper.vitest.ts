...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/ToUpper.ts').ToUpper
const __locutus_source_module_url = new URL("../../../../src/golang/strings/ToUpper.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/strings/ToUpper (target function module)\nfunction ToUpper(s) {\n    //      discuss at: https://locutus.io/golang/strings/ToUpper\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: ToUpper('Gopher')\n    //       returns 1: 'GOPHER'\n    return (s + '').toUpperCase();\n}"
const __locutus_standalone_js_code = "// golang/strings/ToUpper (target function module)\nfunction ToUpper(s) {\n    //      discuss at: https://locutus.io/golang/strings/ToUpper\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: ToUpper('Gopher')\n    //       returns 1: 'GOPHER'\n    return (s + '').toUpperCase();\n}"
