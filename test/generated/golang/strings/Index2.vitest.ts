...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/Index2.ts').Index
const __locutus_source_module_url = new URL("../../../../src/golang/strings/Index2.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "Index"
...
const __locutus_standalone_ts_code = "// golang/strings/Index2 (target function module)\nfunction Index(s, sep) {\n    //      discuss at: https://locutus.io/golang/strings/Index\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Index('Kevin', 'K')\n    //       returns 1: 0\n    //       example 2: Index('Kevin', 'Z')\n    //       returns 2: -1\n    return (s + '').indexOf(sep);\n}"
const __locutus_standalone_js_code = "// golang/strings/Index2 (target function module)\nfunction Index(s, sep) {\n    //      discuss at: https://locutus.io/golang/strings/Index\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Index('Kevin', 'K')\n    //       returns 1: 0\n    //       example 2: Index('Kevin', 'Z')\n    //       returns 2: -1\n    return (s + '').indexOf(sep);\n}"
...
describe('src/golang/strings/Index2.ts (tested in test/generated/golang/strings/Index2.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (Index: typeof __locutus_source_fn) => {
      return Index('Kevin', 'K')
    }
