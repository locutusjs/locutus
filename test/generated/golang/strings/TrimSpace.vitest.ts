...
const __locutus_standalone_ts_code = "// golang/strings/TrimSpace (target function module)\nfunction TrimSpace(s) {\n    //      discuss at: https://locutus.io/golang/strings/TrimSpace\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Removes leading and trailing white space (as defined by Unicode)\n    //       example 1: TrimSpace(' \\t\\n Hello, Gophers \\n\\t\\r\\n')\n    //       returns 1: 'Hello, Gophers'\n    return (s + '').trim();\n}"
const __locutus_standalone_js_code = "// golang/strings/TrimSpace (target function module)\nfunction TrimSpace(s) {\n    //      discuss at: https://locutus.io/golang/strings/TrimSpace\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Removes leading and trailing white space (as defined by Unicode)\n    //       example 1: TrimSpace(' \\t\\n Hello, Gophers \\n\\t\\r\\n')\n    //       returns 1: 'Hello, Gophers'\n    return (s + '').trim();\n}"
