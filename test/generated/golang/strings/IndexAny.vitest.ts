...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/IndexAny.ts').IndexAny
const __locutus_source_module_url = new URL("../../../../src/golang/strings/IndexAny.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "IndexAny"
...
const __locutus_standalone_ts_code = "// golang/strings/IndexAny (target function module)\nfunction IndexAny(s, chars) {\n    //      discuss at: https://locutus.io/golang/strings/IndexAny/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: IndexAny('chicken', 'aeiouy')\n    //       returns 1: 2\n    //       example 2: IndexAny('crwth', 'aeiouy')\n    //       returns 2: -1\n    let minIndex = -1;\n    for (const char of chars) {\n        const idx = s.indexOf(char);\n        if (idx !== -1 && (minIndex === -1 || idx < minIndex)) {\n            minIndex = idx;\n        }\n    }\n    return minIndex;\n}"
const __locutus_standalone_js_code = "// golang/strings/IndexAny (target function module)\nfunction IndexAny(s, chars) {\n    //      discuss at: https://locutus.io/golang/strings/IndexAny/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: IndexAny('chicken', 'aeiouy')\n    //       returns 1: 2\n    //       example 2: IndexAny('crwth', 'aeiouy')\n    //       returns 2: -1\n    let minIndex = -1;\n    for (const char of chars) {\n        const idx = s.indexOf(char);\n        if (idx !== -1 && (minIndex === -1 || idx < minIndex)) {\n            minIndex = idx;\n        }\n    }\n    return minIndex;\n}"
...
describe('src/golang/strings/IndexAny.ts (tested in test/generated/golang/strings/IndexAny.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (IndexAny: typeof __locutus_source_fn) => {
      return IndexAny('chicken', 'aeiouy')
    }
