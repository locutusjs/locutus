...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/TrimPrefix.ts').TrimPrefix
const __locutus_source_module_url = new URL("../../../../src/golang/strings/TrimPrefix.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "TrimPrefix"
...
const __locutus_standalone_ts_code = "// golang/strings/TrimPrefix (target function module)\nfunction TrimPrefix(s, prefix) {\n    //      discuss at: https://locutus.io/golang/strings/TrimPrefix/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: TrimPrefix('Hello, World!', 'Hello, ')\n    //       returns 1: 'World!'\n    //       example 2: TrimPrefix('Hello, World!', 'Goodbye, ')\n    //       returns 2: 'Hello, World!'\n    if (s.startsWith(prefix)) {\n        return s.slice(prefix.length);\n    }\n    return s;\n}"
const __locutus_standalone_js_code = "// golang/strings/TrimPrefix (target function module)\nfunction TrimPrefix(s, prefix) {\n    //      discuss at: https://locutus.io/golang/strings/TrimPrefix/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: TrimPrefix('Hello, World!', 'Hello, ')\n    //       returns 1: 'World!'\n    //       example 2: TrimPrefix('Hello, World!', 'Goodbye, ')\n    //       returns 2: 'Hello, World!'\n    if (s.startsWith(prefix)) {\n        return s.slice(prefix.length);\n    }\n    return s;\n}"
...
describe('src/golang/strings/TrimPrefix.ts (tested in test/generated/golang/strings/TrimPrefix.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (TrimPrefix: typeof __locutus_source_fn) => {
      return TrimPrefix('Hello, World!', 'Hello, ')
    }
  ...
  it('should pass example 2', function () {
    ...
    const __locutus_run_example = (TrimPrefix: typeof __locutus_source_fn) => {
      return TrimPrefix('Hello, World!', 'Goodbye, ')
    }
    for (const __locutus_variant of __locutus_variants) {
      const result = __locutus_run_example(__locutus_variant.fn as typeof __locutus_source_fn)
      expect(result).toEqual(expected)
