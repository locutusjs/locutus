...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/Contains.ts').Contains
const __locutus_source_module_url = new URL("../../../../src/golang/strings/Contains.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/strings/Contains (target function module)\nfunction Contains(s, substr) {\n    //      discuss at: https://locutus.io/golang/strings/Contains\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Contains('Kevin', 'K')\n    //       returns 1: true\n    return (s + '').includes(substr);\n}"
const __locutus_standalone_js_code = "// golang/strings/Contains (target function module)\nfunction Contains(s, substr) {\n    //      discuss at: https://locutus.io/golang/strings/Contains\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: Contains('Kevin', 'K')\n    //       returns 1: true\n    return (s + '').includes(substr);\n}"
...
describe('src/golang/strings/Contains.ts (tested in test/generated/golang/strings/Contains.vitest.ts)', function () {
