...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/TrimLeft.ts').TrimLeft
const __locutus_source_module_url = new URL("../../../../src/golang/strings/TrimLeft.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/strings/TrimLeft (target function module)\nfunction TrimLeft(s, cutset) {\n    //      discuss at: https://locutus.io/golang/strings/TrimLeft/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: TrimLeft('¡¡¡Hello, Gophers!!!', '!¡')\n    //       returns 1: 'Hello, Gophers!!!'\n    //       example 2: TrimLeft('  hello  ', ' ')\n    //       returns 2: 'hello  '\n    let start = 0;\n    while (start < s.length && cutset.includes(s.charAt(start))) {\n        start++;\n    }\n    return s.slice(start);\n}"
const __locutus_standalone_js_code = "// golang/strings/TrimLeft (target function module)\nfunction TrimLeft(s, cutset) {\n    //      discuss at: https://locutus.io/golang/strings/TrimLeft/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: TrimLeft('¡¡¡Hello, Gophers!!!', '!¡')\n    //       returns 1: 'Hello, Gophers!!!'\n    //       example 2: TrimLeft('  hello  ', ' ')\n    //       returns 2: 'hello  '\n    let start = 0;\n    while (start < s.length && cutset.includes(s.charAt(start))) {\n        start++;\n    }\n    return s.slice(start);\n}"
