...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/CutPrefix.ts').CutPrefix
const __locutus_source_module_url = new URL("../../../../src/golang/strings/CutPrefix.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "CutPrefix"
...
const __locutus_standalone_ts_code = "// golang/strings/CutPrefix (target function module)\nfunction CutPrefix(s, prefix) {\n    //      discuss at: https://locutus.io/golang/strings/CutPrefix\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns [after, found] and mirrors Go strings.CutPrefix behavior.\n    //       example 1: CutPrefix('abc', 'a')\n    //       returns 1: ['bc', true]\n    //       example 2: CutPrefix('abc', '')\n    //       returns 2: ['abc', true]\n    //       example 3: CutPrefix('abc', 'd')\n    //       returns 3: ['abc', false]\n    const value = String(s);\n    const candidatePrefix = String(prefix);\n    if (value.startsWith(candidatePrefix)) {\n        return [value.slice(candidatePrefix.length), true];\n    }\n    return [value, false];\n}"
const __locutus_standalone_js_code = "// golang/strings/CutPrefix (target function module)\nfunction CutPrefix(s, prefix) {\n    //      discuss at: https://locutus.io/golang/strings/CutPrefix\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns [after, found] and mirrors Go strings.CutPrefix behavior.\n    //       example 1: CutPrefix('abc', 'a')\n    //       returns 1: ['bc', true]\n    //       example 2: CutPrefix('abc', '')\n    //       returns 2: ['abc', true]\n    //       example 3: CutPrefix('abc', 'd')\n    //       returns 3: ['abc', false]\n    const value = String(s);\n    const candidatePrefix = String(prefix);\n    if (value.startsWith(candidatePrefix)) {\n        return [value.slice(candidatePrefix.length), true];\n    }\n    return [value, false];\n}"
...
describe('src/golang/strings/CutPrefix.ts (tested in test/generated/golang/strings/CutPrefix.vitest.ts)', function () {
  it('should pass example 1', function () {
    const expected = ['bc', true]
    ...
    const __locutus_run_example = (CutPrefix: typeof __locutus_source_fn) => {
      return CutPrefix('abc', 'a')
    }
