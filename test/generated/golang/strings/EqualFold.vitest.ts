...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/EqualFold.ts').EqualFold
const __locutus_source_module_url = new URL("../../../../src/golang/strings/EqualFold.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "EqualFold"
...
const __locutus_standalone_ts_code = "// golang/strings/EqualFold (target function module)\nfunction EqualFold(s, t) {\n    //      discuss at: https://locutus.io/golang/strings/EqualFold/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: EqualFold('Go', 'go')\n    //       returns 1: true\n    //       example 2: EqualFold('Hello', 'HELLO')\n    //       returns 2: true\n    //       example 3: EqualFold('Σ', 'σ')\n    //       returns 3: true\n    return s.toLowerCase() === t.toLowerCase();\n}"
const __locutus_standalone_js_code = "// golang/strings/EqualFold (target function module)\nfunction EqualFold(s, t) {\n    //      discuss at: https://locutus.io/golang/strings/EqualFold/\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: EqualFold('Go', 'go')\n    //       returns 1: true\n    //       example 2: EqualFold('Hello', 'HELLO')\n    //       returns 2: true\n    //       example 3: EqualFold('Σ', 'σ')\n    //       returns 3: true\n    return s.toLowerCase() === t.toLowerCase();\n}"
...
describe('src/golang/strings/EqualFold.ts (tested in test/generated/golang/strings/EqualFold.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (EqualFold: typeof __locutus_source_fn) => {
      return EqualFold('Go', 'go')
    }
