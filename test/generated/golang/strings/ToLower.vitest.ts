...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/golang/strings/ToLower.ts').ToLower
const __locutus_source_module_url = new URL("../../../../src/golang/strings/ToLower.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// golang/strings/ToLower (target function module)\nfunction ToLower(s) {\n    //      discuss at: https://locutus.io/golang/strings/ToLower\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: ToLower('Gopher')\n    //       returns 1: 'gopher'\n    return (s + '').toLowerCase();\n}"
const __locutus_standalone_js_code = "// golang/strings/ToLower (target function module)\nfunction ToLower(s) {\n    //      discuss at: https://locutus.io/golang/strings/ToLower\n    // parity verified: Go 1.23\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: ToLower('Gopher')\n    //       returns 1: 'gopher'\n    return (s + '').toLowerCase();\n}"
