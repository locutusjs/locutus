...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/awk/builtin/sin.ts').sin
const __locutus_source_module_url = new URL("../../../../src/awk/builtin/sin.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// awk/builtin/sin (target function module)\nfunction sin(x) {\n    //      discuss at: https://locutus.io/awk/sin/\n    // parity verified: GNU AWK 5.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sin(0)\n    //       returns 1: 0\n    //       example 2: sin(1)\n    //       returns 2: 0.8414709848078965\n    return Math.sin(x);\n}"
const __locutus_standalone_js_code = "// awk/builtin/sin (target function module)\nfunction sin(x) {\n    //      discuss at: https://locutus.io/awk/sin/\n    // parity verified: GNU AWK 5.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: sin(0)\n    //       returns 1: 0\n    //       example 2: sin(1)\n    //       returns 2: 0.8414709848078965\n    return Math.sin(x);\n}"
...
describe('src/awk/builtin/sin.ts (tested in test/generated/awk/builtin/sin.vitest.ts)', function () {
