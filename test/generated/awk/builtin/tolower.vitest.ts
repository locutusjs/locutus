...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/awk/builtin/tolower.ts').tolower
const __locutus_source_module_url = new URL("../../../../src/awk/builtin/tolower.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// awk/builtin/tolower (target function module)\nfunction tolower(s) {\n    //      discuss at: https://locutus.io/awk/tolower/\n    // parity verified: GNU AWK 5.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tolower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: tolower('Hello World')\n    //       returns 2: 'hello world'\n    return String(s).toLowerCase();\n}"
const __locutus_standalone_js_code = "// awk/builtin/tolower (target function module)\nfunction tolower(s) {\n    //      discuss at: https://locutus.io/awk/tolower/\n    // parity verified: GNU AWK 5.3\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: tolower('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: tolower('Hello World')\n    //       returns 2: 'hello world'\n    return String(s).toLowerCase();\n}"
...
describe('src/awk/builtin/tolower.ts (tested in test/generated/awk/builtin/tolower.vitest.ts)', function () {
