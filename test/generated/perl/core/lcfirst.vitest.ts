...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/perl/core/lcfirst.ts').lcfirst
const __locutus_source_module_url = new URL("../../../../src/perl/core/lcfirst.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// perl/core/lcfirst (target function module)\nfunction lcfirst(str) {\n    //      discuss at: https://locutus.io/perl/lcfirst/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lcfirst('HELLO')\n    //       returns 1: 'hELLO'\n    //       example 2: lcfirst('Hello')\n    //       returns 2: 'hello'\n    const value = String(str);\n    if (!value) {\n        return '';\n    }\n    return value.charAt(0).toLowerCase() + value.slice(1);\n}"
const __locutus_standalone_js_code = "// perl/core/lcfirst (target function module)\nfunction lcfirst(str) {\n    //      discuss at: https://locutus.io/perl/lcfirst/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lcfirst('HELLO')\n    //       returns 1: 'hELLO'\n    //       example 2: lcfirst('Hello')\n    //       returns 2: 'hello'\n    const value = String(str);\n    if (!value) {\n        return '';\n    }\n    return value.charAt(0).toLowerCase() + value.slice(1);\n}"
...
describe('src/perl/core/lcfirst.ts (tested in test/generated/perl/core/lcfirst.vitest.ts)', function () {
