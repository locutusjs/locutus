...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/perl/core/lc.ts').lc
const __locutus_source_module_url = new URL("../../../../src/perl/core/lc.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "lc"
...
const __locutus_standalone_ts_code = "// perl/core/lc (target function module)\nfunction lc(str) {\n    //      discuss at: https://locutus.io/perl/lc/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lc('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: lc('Hello World')\n    //       returns 2: 'hello world'\n    return String(str).toLowerCase();\n}"
const __locutus_standalone_js_code = "// perl/core/lc (target function module)\nfunction lc(str) {\n    //      discuss at: https://locutus.io/perl/lc/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: lc('HELLO')\n    //       returns 1: 'hello'\n    //       example 2: lc('Hello World')\n    //       returns 2: 'hello world'\n    return String(str).toLowerCase();\n}"
...
describe('src/perl/core/lc.ts (tested in test/generated/perl/core/lc.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (lc: typeof __locutus_source_fn) => {
      return lc('HELLO')
    }
