...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/perl/core/int.ts').int
const __locutus_source_module_url = new URL("../../../../src/perl/core/int.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// perl/core/int (target function module)\nfunction int(value) {\n    //      discuss at: https://locutus.io/perl/int/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: int(4.7)\n    //       returns 1: 4\n    //       example 2: int(-4.7)\n    //       returns 2: -4\n    //       example 3: int(3)\n    //       returns 3: 3\n    const num = Number(value);\n    if (!Number.isFinite(num)) {\n        return 0;\n    }\n    return Math.trunc(num);\n}"
const __locutus_standalone_js_code = "// perl/core/int (target function module)\nfunction int(value) {\n    //      discuss at: https://locutus.io/perl/int/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: int(4.7)\n    //       returns 1: 4\n    //       example 2: int(-4.7)\n    //       returns 2: -4\n    //       example 3: int(3)\n    //       returns 3: 3\n    const num = Number(value);\n    if (!Number.isFinite(num)) {\n        return 0;\n    }\n    return Math.trunc(num);\n}"
...
describe('src/perl/core/int.ts (tested in test/generated/perl/core/int.vitest.ts)', function () {
