...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/perl/core/uc.ts').uc
const __locutus_source_module_url = new URL("../../../../src/perl/core/uc.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "uc"
...
const __locutus_standalone_ts_code = "// perl/core/uc (target function module)\nfunction uc(str) {\n    //      discuss at: https://locutus.io/perl/uc/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: uc('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: uc('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(str).toUpperCase();\n}"
const __locutus_standalone_js_code = "// perl/core/uc (target function module)\nfunction uc(str) {\n    //      discuss at: https://locutus.io/perl/uc/\n    // parity verified: Perl 5.40\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: uc('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: uc('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(str).toUpperCase();\n}"
...
describe('src/perl/core/uc.ts (tested in test/generated/perl/core/uc.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (uc: typeof __locutus_source_fn) => {
      return uc('hello')
    }
