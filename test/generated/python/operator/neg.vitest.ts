...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/operator/neg.ts').neg
const __locutus_source_module_url = new URL("../../../../src/python/operator/neg.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "neg"
...
describe('src/python/operator/neg.ts (tested in test/generated/python/operator/neg.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (neg: typeof __locutus_source_fn) => {
      return neg(4)
    }
