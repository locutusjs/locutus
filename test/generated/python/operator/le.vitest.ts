...
describe('src/python/operator/le.ts (tested in test/generated/python/operator/le.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (le: typeof __locutus_source_fn) => {
      return le(2, 2)
    }
