...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/operator/ne.ts').ne
const __locutus_source_module_url = new URL("../../../../src/python/operator/ne.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "ne"
...
describe('src/python/operator/ne.ts (tested in test/generated/python/operator/ne.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (ne: typeof __locutus_source_fn) => {
      return ne([1, 2], [1, 3])
    }
