...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/operator/gt.ts').gt
const __locutus_source_module_url = new URL("../../../../src/python/operator/gt.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "gt"
...
describe('src/python/operator/gt.ts (tested in test/generated/python/operator/gt.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (gt: typeof __locutus_source_fn) => {
      return gt(3, 2)
    }
