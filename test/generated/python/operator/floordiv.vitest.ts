...
describe('src/python/operator/floordiv.ts (tested in test/generated/python/operator/floordiv.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (floordiv: typeof __locutus_source_fn) => {
      return floordiv(7, 3)
    }
