...
describe('src/python/operator/pos.ts (tested in test/generated/python/operator/pos.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (pos: typeof __locutus_source_fn) => {
      return pos(-4)
    }
