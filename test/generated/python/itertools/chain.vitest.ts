...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/itertools/chain.ts').chain
const __locutus_source_module_url = new URL("../../../../src/python/itertools/chain.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "chain"
...
describe('src/python/itertools/chain.ts (tested in test/generated/python/itertools/chain.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (chain: typeof __locutus_source_fn) => {
