...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/string/digits.ts').digits
const __locutus_source_module_url = new URL("../../../../src/python/string/digits.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "digits"
...
const __locutus_standalone_ts_code = "// python/string/digits (target function module)\nfunction digits() {\n    //      discuss at: https://locutus.io/python/digits/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the string '0123456789'\n    //       example 1: digits()\n    //       returns 1: '0123456789'\n    return '0123456789';\n}"
const __locutus_standalone_js_code = "// python/string/digits (target function module)\nfunction digits() {\n    //      discuss at: https://locutus.io/python/digits/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the string '0123456789'\n    //       example 1: digits()\n    //       returns 1: '0123456789'\n    return '0123456789';\n}"
...
describe('src/python/string/digits.ts (tested in test/generated/python/string/digits.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (digits: typeof __locutus_source_fn) => {
      return digits()
    }
