...
const __locutus_standalone_ts_code = "// python/string/ascii_letters (target function module)\nfunction ascii_letters() {\n    // parity verified: Python 3.12\n    //     original by: Yury Shapkarin (https://shapkarin.me)\n    //       example 1: ascii_letters()\n    //       returns 1: 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'\n    return 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';\n}"
const __locutus_standalone_js_code = "// python/string/ascii_letters (target function module)\nfunction ascii_letters() {\n    // parity verified: Python 3.12\n    //     original by: Yury Shapkarin (https://shapkarin.me)\n    //       example 1: ascii_letters()\n    //       returns 1: 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'\n    return 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';\n}"
