...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/string/ascii_lowercase.ts').ascii_lowercase
const __locutus_source_module_url = new URL("../../../../src/python/string/ascii_lowercase.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "ascii_lowercase"
...
const __locutus_standalone_ts_code = "// python/string/ascii_lowercase (target function module)\nfunction ascii_lowercase() {\n    // parity verified: Python 3.12\n    //     original by: Yury Shapkarin (https://shapkarin.me)\n    //       example 1: ascii_lowercase()\n    //       returns 1: 'abcdefghijklmnopqrstuvwxyz'\n    return 'abcdefghijklmnopqrstuvwxyz';\n}"
const __locutus_standalone_js_code = "// python/string/ascii_lowercase (target function module)\nfunction ascii_lowercase() {\n    // parity verified: Python 3.12\n    //     original by: Yury Shapkarin (https://shapkarin.me)\n    //       example 1: ascii_lowercase()\n    //       returns 1: 'abcdefghijklmnopqrstuvwxyz'\n    return 'abcdefghijklmnopqrstuvwxyz';\n}"
...
describe('src/python/string/ascii_lowercase.ts (tested in test/generated/python/string/ascii_lowercase.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (ascii_lowercase: typeof __locutus_source_fn) => {
