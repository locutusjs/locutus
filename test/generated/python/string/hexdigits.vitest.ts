...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/string/hexdigits.ts').hexdigits
const __locutus_source_module_url = new URL("../../../../src/python/string/hexdigits.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "hexdigits"
...
const __locutus_standalone_ts_code = "// python/string/hexdigits (target function module)\nfunction hexdigits() {\n    //      discuss at: https://locutus.io/python/hexdigits/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the string '0123456789abcdefABCDEF'\n    //       example 1: hexdigits()\n    //       returns 1: '0123456789abcdefABCDEF'\n    return '0123456789abcdefABCDEF';\n}"
const __locutus_standalone_js_code = "// python/string/hexdigits (target function module)\nfunction hexdigits() {\n    //      discuss at: https://locutus.io/python/hexdigits/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the string '0123456789abcdefABCDEF'\n    //       example 1: hexdigits()\n    //       returns 1: '0123456789abcdefABCDEF'\n    return '0123456789abcdefABCDEF';\n}"
...
describe('src/python/string/hexdigits.ts (tested in test/generated/python/string/hexdigits.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (hexdigits: typeof __locutus_source_fn) => {
      return hexdigits()
    }
