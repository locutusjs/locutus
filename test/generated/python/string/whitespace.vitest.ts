...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/string/whitespace.ts').whitespace
const __locutus_source_module_url = new URL("../../../../src/python/string/whitespace.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "whitespace"
...
const __locutus_standalone_ts_code = "// python/string/whitespace (target function module)\nfunction whitespace() {\n    //      discuss at: https://locutus.io/python/whitespace/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns whitespace characters: space, tab, newline, return, formfeed, vertical tab\n    //       example 1: whitespace()\n    //       returns 1: ' \\t\\n\\r\\x0b\\x0c'\n    return ' \\t\\n\\r\\x0b\\x0c';\n}"
const __locutus_standalone_js_code = "// python/string/whitespace (target function module)\nfunction whitespace() {\n    //      discuss at: https://locutus.io/python/whitespace/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns whitespace characters: space, tab, newline, return, formfeed, vertical tab\n    //       example 1: whitespace()\n    //       returns 1: ' \\t\\n\\r\\x0b\\x0c'\n    return ' \\t\\n\\r\\x0b\\x0c';\n}"
...
describe('src/python/string/whitespace.ts (tested in test/generated/python/string/whitespace.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (whitespace: typeof __locutus_source_fn) => {
      return whitespace()
    }
