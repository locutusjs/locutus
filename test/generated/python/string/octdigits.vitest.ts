...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/string/octdigits.ts').octdigits
const __locutus_source_module_url = new URL("../../../../src/python/string/octdigits.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "octdigits"
...
const __locutus_standalone_ts_code = "// python/string/octdigits (target function module)\nfunction octdigits() {\n    //      discuss at: https://locutus.io/python/octdigits/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the string '01234567'\n    //       example 1: octdigits()\n    //       returns 1: '01234567'\n    return '01234567';\n}"
const __locutus_standalone_js_code = "// python/string/octdigits (target function module)\nfunction octdigits() {\n    //      discuss at: https://locutus.io/python/octdigits/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the string '01234567'\n    //       example 1: octdigits()\n    //       returns 1: '01234567'\n    return '01234567';\n}"
...
describe('src/python/string/octdigits.ts (tested in test/generated/python/string/octdigits.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (octdigits: typeof __locutus_source_fn) => {
      return octdigits()
    }
