...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/string/ascii_uppercase.ts').ascii_uppercase
const __locutus_source_module_url = new URL("../../../../src/python/string/ascii_uppercase.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "ascii_uppercase"
...
const __locutus_standalone_ts_code = "// python/string/ascii_uppercase (target function module)\nfunction ascii_uppercase() {\n    // parity verified: Python 3.12\n    //     original by: Yury Shapkarin (https://shapkarin.me)\n    //       example 1: ascii_uppercase()\n    //       returns 1: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'\n    return 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';\n}"
const __locutus_standalone_js_code = "// python/string/ascii_uppercase (target function module)\nfunction ascii_uppercase() {\n    // parity verified: Python 3.12\n    //     original by: Yury Shapkarin (https://shapkarin.me)\n    //       example 1: ascii_uppercase()\n    //       returns 1: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'\n    return 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';\n}"
...
describe('src/python/string/ascii_uppercase.ts (tested in test/generated/python/string/ascii_uppercase.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (ascii_uppercase: typeof __locutus_source_fn) => {
