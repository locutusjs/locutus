...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/atanh.ts').atanh
const __locutus_source_module_url = new URL("../../../../src/python/math/atanh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/atanh (target function module)\nfunction atanh(x) {\n    //      discuss at: https://locutus.io/python/atanh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the inverse hyperbolic tangent of x\n    //       example 1: atanh(0)\n    //       returns 1: 0\n    //       example 2: atanh(0.5)\n    //       returns 2: 0.5493061443340548\n    //       example 3: atanh(-0.5)\n    //       returns 3: -0.5493061443340548\n    return Math.atanh(x);\n}"
const __locutus_standalone_js_code = "// python/math/atanh (target function module)\nfunction atanh(x) {\n    //      discuss at: https://locutus.io/python/atanh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the inverse hyperbolic tangent of x\n    //       example 1: atanh(0)\n    //       returns 1: 0\n    //       example 2: atanh(0.5)\n    //       returns 2: 0.5493061443340548\n    //       example 3: atanh(-0.5)\n    //       returns 3: -0.5493061443340548\n    return Math.atanh(x);\n}"
...
describe('src/python/math/atanh.ts (tested in test/generated/python/math/atanh.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (atanh: typeof __locutus_source_fn) => {
      return atanh(0)
    }
