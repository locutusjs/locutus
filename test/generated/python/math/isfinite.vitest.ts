...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/isfinite.ts').isfinite
const __locutus_source_module_url = new URL("../../../../src/python/math/isfinite.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "isfinite"
...
const __locutus_standalone_ts_code = "// python/math/isfinite (target function module)\nfunction isfinite(x) {\n    //      discuss at: https://locutus.io/python/isfinite/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns True if x is neither infinity nor NaN\n    //       example 1: isfinite(42)\n    //       returns 1: true\n    //       example 2: isfinite(Infinity)\n    //       returns 2: false\n    //       example 3: isfinite(NaN)\n    //       returns 3: false\n    return Number.isFinite(x);\n}"
const __locutus_standalone_js_code = "// python/math/isfinite (target function module)\nfunction isfinite(x) {\n    //      discuss at: https://locutus.io/python/isfinite/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns True if x is neither infinity nor NaN\n    //       example 1: isfinite(42)\n    //       returns 1: true\n    //       example 2: isfinite(Infinity)\n    //       returns 2: false\n    //       example 3: isfinite(NaN)\n    //       returns 3: false\n    return Number.isFinite(x);\n}"
...
describe('src/python/math/isfinite.ts (tested in test/generated/python/math/isfinite.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (isfinite: typeof __locutus_source_fn) => {
      return isfinite(42)
    }
