...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/radians.ts').radians
const __locutus_source_module_url = new URL("../../../../src/python/math/radians.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "radians"
...
const __locutus_standalone_ts_code = "// python/math/radians (target function module)\nfunction radians(x) {\n    //      discuss at: https://locutus.io/python/radians/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts angle x from degrees to radians\n    //       example 1: radians(180)\n    //       returns 1: 3.141592653589793\n    //       example 2: radians(90)\n    //       returns 2: 1.5707963267948966\n    //       example 3: radians(0)\n    //       returns 3: 0\n    return x * (Math.PI / 180);\n}"
const __locutus_standalone_js_code = "// python/math/radians (target function module)\nfunction radians(x) {\n    //      discuss at: https://locutus.io/python/radians/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts angle x from degrees to radians\n    //       example 1: radians(180)\n    //       returns 1: 3.141592653589793\n    //       example 2: radians(90)\n    //       returns 2: 1.5707963267948966\n    //       example 3: radians(0)\n    //       returns 3: 0\n    return x * (Math.PI / 180);\n}"
...
describe('src/python/math/radians.ts (tested in test/generated/python/math/radians.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (radians: typeof __locutus_source_fn) => {
      return radians(180)
    }
