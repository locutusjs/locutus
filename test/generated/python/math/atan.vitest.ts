...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/atan.ts').atan
const __locutus_source_module_url = new URL("../../../../src/python/math/atan.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/atan (target function module)\nfunction atan(x) {\n    //      discuss at: https://locutus.io/python/atan/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the arc tangent of x, in radians\n    //       example 1: atan(0)\n    //       returns 1: 0\n    //       example 2: atan(1)\n    //       returns 2: 0.7853981633974483\n    //       example 3: atan(-1)\n    //       returns 3: -0.7853981633974483\n    return Math.atan(x);\n}"
const __locutus_standalone_js_code = "// python/math/atan (target function module)\nfunction atan(x) {\n    //      discuss at: https://locutus.io/python/atan/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the arc tangent of x, in radians\n    //       example 1: atan(0)\n    //       returns 1: 0\n    //       example 2: atan(1)\n    //       returns 2: 0.7853981633974483\n    //       example 3: atan(-1)\n    //       returns 3: -0.7853981633974483\n    return Math.atan(x);\n}"
...
describe('src/python/math/atan.ts (tested in test/generated/python/math/atan.vitest.ts)', function () {
