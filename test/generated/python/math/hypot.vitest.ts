...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/hypot.ts').hypot
const __locutus_source_module_url = new URL("../../../../src/python/math/hypot.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/hypot (target function module)\nfunction hypot(...coordinates) {\n    //      discuss at: https://locutus.io/python/hypot/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the Euclidean norm of the provided coordinates\n    //       example 1: hypot(3, 4)\n    //       returns 1: 5\n    //       example 2: hypot(3, 4, 12)\n    //       returns 2: 13\n    //       example 3: hypot()\n    //       returns 3: 0\n    return Math.hypot(...coordinates);\n}"
const __locutus_standalone_js_code = "// python/math/hypot (target function module)\nfunction hypot(...coordinates) {\n    //      discuss at: https://locutus.io/python/hypot/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the Euclidean norm of the provided coordinates\n    //       example 1: hypot(3, 4)\n    //       returns 1: 5\n    //       example 2: hypot(3, 4, 12)\n    //       returns 2: 13\n    //       example 3: hypot()\n    //       returns 3: 0\n    return Math.hypot(...coordinates);\n}"
...
describe('src/python/math/hypot.ts (tested in test/generated/python/math/hypot.vitest.ts)', function () {
