...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/sinh.ts').sinh
const __locutus_source_module_url = new URL("../../../../src/python/math/sinh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/sinh (target function module)\nfunction sinh(x) {\n    //      discuss at: https://locutus.io/python/sinh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the hyperbolic sine of x\n    //       example 1: sinh(0)\n    //       returns 1: 0\n    //       example 2: sinh(1)\n    //       returns 2: 1.1752011936438014\n    //       example 3: sinh(-1)\n    //       returns 3: -1.1752011936438014\n    return Math.sinh(x);\n}"
const __locutus_standalone_js_code = "// python/math/sinh (target function module)\nfunction sinh(x) {\n    //      discuss at: https://locutus.io/python/sinh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the hyperbolic sine of x\n    //       example 1: sinh(0)\n    //       returns 1: 0\n    //       example 2: sinh(1)\n    //       returns 2: 1.1752011936438014\n    //       example 3: sinh(-1)\n    //       returns 3: -1.1752011936438014\n    return Math.sinh(x);\n}"
...
describe('src/python/math/sinh.ts (tested in test/generated/python/math/sinh.vitest.ts)', function () {
