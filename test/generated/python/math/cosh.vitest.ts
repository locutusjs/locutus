...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/cosh.ts').cosh
const __locutus_source_module_url = new URL("../../../../src/python/math/cosh.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/cosh (target function module)\nfunction cosh(x) {\n    //      discuss at: https://locutus.io/python/cosh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the hyperbolic cosine of x\n    //       example 1: cosh(0)\n    //       returns 1: 1\n    //       example 2: cosh(1)\n    //       returns 2: 1.5430806348152437\n    //       example 3: cosh(-1)\n    //       returns 3: 1.5430806348152437\n    return Math.cosh(x);\n}"
const __locutus_standalone_js_code = "// python/math/cosh (target function module)\nfunction cosh(x) {\n    //      discuss at: https://locutus.io/python/cosh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the hyperbolic cosine of x\n    //       example 1: cosh(0)\n    //       returns 1: 1\n    //       example 2: cosh(1)\n    //       returns 2: 1.5430806348152437\n    //       example 3: cosh(-1)\n    //       returns 3: 1.5430806348152437\n    return Math.cosh(x);\n}"
...
describe('src/python/math/cosh.ts (tested in test/generated/python/math/cosh.vitest.ts)', function () {
