...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/log.ts').log
const __locutus_source_module_url = new URL("../../../../src/python/math/log.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/log (target function module)\nfunction log(x, base) {\n    //      discuss at: https://locutus.io/python/log/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the natural logarithm of x (base e)\n    //          note 2: If base is provided, returns log(x) / log(base)\n    //       example 1: log(1)\n    //       returns 1: 0\n    //       example 2: log(2.718281828459045)\n    //       returns 2: 1\n    if (base === undefined) {\n        return Math.log(x);\n    }\n    return Math.log(x) / Math.log(base);\n}"
const __locutus_standalone_js_code = "// python/math/log (target function module)\nfunction log(x, base) {\n    //      discuss at: https://locutus.io/python/log/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the natural logarithm of x (base e)\n    //          note 2: If base is provided, returns log(x) / log(base)\n    //       example 1: log(1)\n    //       returns 1: 0\n    //       example 2: log(2.718281828459045)\n    //       returns 2: 1\n    if (base === undefined) {\n        return Math.log(x);\n    }\n    return Math.log(x) / Math.log(base);\n}"
...
describe('src/python/math/log.ts (tested in test/generated/python/math/log.vitest.ts)', function () {
