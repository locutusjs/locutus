...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/log2.ts').log2
const __locutus_source_module_url = new URL("../../../../src/python/math/log2.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/log2 (target function module)\nfunction log2(x) {\n    //      discuss at: https://locutus.io/python/log2/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the base-2 logarithm of x\n    //       example 1: log2(1)\n    //       returns 1: 0\n    //       example 2: log2(2)\n    //       returns 2: 1\n    //       example 3: log2(8)\n    //       returns 3: 3\n    return Math.log2(x);\n}"
const __locutus_standalone_js_code = "// python/math/log2 (target function module)\nfunction log2(x) {\n    //      discuss at: https://locutus.io/python/log2/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the base-2 logarithm of x\n    //       example 1: log2(1)\n    //       returns 1: 0\n    //       example 2: log2(2)\n    //       returns 2: 1\n    //       example 3: log2(8)\n    //       returns 3: 3\n    return Math.log2(x);\n}"
...
describe('src/python/math/log2.ts (tested in test/generated/python/math/log2.vitest.ts)', function () {
