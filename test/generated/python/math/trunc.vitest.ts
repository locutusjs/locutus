...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/trunc.ts').trunc
const __locutus_source_module_url = new URL("../../../../src/python/math/trunc.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "trunc"
...
const __locutus_standalone_ts_code = "// python/math/trunc (target function module)\nfunction trunc(x) {\n    //      discuss at: https://locutus.io/python/trunc/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the integer part of x, removing the decimal part\n    //       example 1: trunc(3.7)\n    //       returns 1: 3\n    //       example 2: trunc(-3.7)\n    //       returns 2: -3\n    //       example 3: trunc(5)\n    //       returns 3: 5\n    return Math.trunc(x);\n}"
const __locutus_standalone_js_code = "// python/math/trunc (target function module)\nfunction trunc(x) {\n    //      discuss at: https://locutus.io/python/trunc/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the integer part of x, removing the decimal part\n    //       example 1: trunc(3.7)\n    //       returns 1: 3\n    //       example 2: trunc(-3.7)\n    //       returns 2: -3\n    //       example 3: trunc(5)\n    //       returns 3: 5\n    return Math.trunc(x);\n}"
...
describe('src/python/math/trunc.ts (tested in test/generated/python/math/trunc.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (trunc: typeof __locutus_source_fn) => {
      return trunc(3.7)
    }
