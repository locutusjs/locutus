...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/asinh.ts').asinh
const __locutus_source_module_url = new URL("../../../../src/python/math/asinh.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "asinh"
...
const __locutus_standalone_ts_code = "// python/math/asinh (target function module)\nfunction asinh(x) {\n    //      discuss at: https://locutus.io/python/asinh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the inverse hyperbolic sine of x\n    //       example 1: asinh(0)\n    //       returns 1: 0\n    //       example 2: asinh(1)\n    //       returns 2: 0.881373587019543\n    //       example 3: asinh(-2)\n    //       returns 3: -1.4436354751788103\n    return Math.asinh(x);\n}"
const __locutus_standalone_js_code = "// python/math/asinh (target function module)\nfunction asinh(x) {\n    //      discuss at: https://locutus.io/python/asinh/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the inverse hyperbolic sine of x\n    //       example 1: asinh(0)\n    //       returns 1: 0\n    //       example 2: asinh(1)\n    //       returns 2: 0.881373587019543\n    //       example 3: asinh(-2)\n    //       returns 3: -1.4436354751788103\n    return Math.asinh(x);\n}"
...
describe('src/python/math/asinh.ts (tested in test/generated/python/math/asinh.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (asinh: typeof __locutus_source_fn) => {
      return asinh(0)
    }
  ...
  it('should pass example 2', function () {
    const expected = 0.881373587019543
    const __locutus_variants: Array<{ name: string; fn: (...args: unknown[]) => unknown }> = [
      { name: "source", fn: __locutus_source_fn },
      { name: "module-js", fn: __locutus_module_js_fn },
      { name: "standalone-ts", fn: __locutus_standalone_ts_fn },
  ...
  it('should pass example 3', function () {
    const expected = -1.4436354751788103
    const __locutus_variants: Array<{ name: string; fn: (...args: unknown[]) => unknown }> = [
      { name: "source", fn: __locutus_source_fn },
      { name: "module-js", fn: __locutus_module_js_fn },
      { name: "standalone-ts", fn: __locutus_standalone_ts_fn },
