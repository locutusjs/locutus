...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/sin.ts').sin
const __locutus_source_module_url = new URL("../../../../src/python/math/sin.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/sin (target function module)\nfunction sin(x) {\n    //      discuss at: https://locutus.io/python/sin/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the sine of x, where x is in radians\n    //       example 1: sin(0)\n    //       returns 1: 0\n    //       example 2: sin(1.5707963267948966)\n    //       returns 2: 1\n    //       example 3: sin(-1.5707963267948966)\n    //       returns 3: -1\n    return Math.sin(x);\n}"
const __locutus_standalone_js_code = "// python/math/sin (target function module)\nfunction sin(x) {\n    //      discuss at: https://locutus.io/python/sin/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the sine of x, where x is in radians\n    //       example 1: sin(0)\n    //       returns 1: 0\n    //       example 2: sin(1.5707963267948966)\n    //       returns 2: 1\n    //       example 3: sin(-1.5707963267948966)\n    //       returns 3: -1\n    return Math.sin(x);\n}"
...
describe('src/python/math/sin.ts (tested in test/generated/python/math/sin.vitest.ts)', function () {
