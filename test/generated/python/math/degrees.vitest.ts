...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/degrees.ts').degrees
const __locutus_source_module_url = new URL("../../../../src/python/math/degrees.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "degrees"
...
const __locutus_standalone_ts_code = "// python/math/degrees (target function module)\nfunction degrees(x) {\n    //      discuss at: https://locutus.io/python/degrees/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts angle x from radians to degrees\n    //       example 1: degrees(3.141592653589793)\n    //       returns 1: 180\n    //       example 2: degrees(1.5707963267948966)\n    //       returns 2: 90\n    //       example 3: degrees(0)\n    //       returns 3: 0\n    return x * (180 / Math.PI);\n}"
const __locutus_standalone_js_code = "// python/math/degrees (target function module)\nfunction degrees(x) {\n    //      discuss at: https://locutus.io/python/degrees/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Converts angle x from radians to degrees\n    //       example 1: degrees(3.141592653589793)\n    //       returns 1: 180\n    //       example 2: degrees(1.5707963267948966)\n    //       returns 2: 90\n    //       example 3: degrees(0)\n    //       returns 3: 0\n    return x * (180 / Math.PI);\n}"
...
describe('src/python/math/degrees.ts (tested in test/generated/python/math/degrees.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (degrees: typeof __locutus_source_fn) => {
