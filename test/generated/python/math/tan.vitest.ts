...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/tan.ts').tan
const __locutus_source_module_url = new URL("../../../../src/python/math/tan.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/tan (target function module)\nfunction tan(x) {\n    //      discuss at: https://locutus.io/python/tan/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the tangent of x, where x is in radians\n    //       example 1: tan(0)\n    //       returns 1: 0\n    //       example 2: tan(0.7853981633974483)\n    //       returns 2: 0.9999999999999999\n    //       example 3: tan(-0.7853981633974483)\n    //       returns 3: -0.9999999999999999\n    return Math.tan(x);\n}"
const __locutus_standalone_js_code = "// python/math/tan (target function module)\nfunction tan(x) {\n    //      discuss at: https://locutus.io/python/tan/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the tangent of x, where x is in radians\n    //       example 1: tan(0)\n    //       returns 1: 0\n    //       example 2: tan(0.7853981633974483)\n    //       returns 2: 0.9999999999999999\n    //       example 3: tan(-0.7853981633974483)\n    //       returns 3: -0.9999999999999999\n    return Math.tan(x);\n}"
...
describe('src/python/math/tan.ts (tested in test/generated/python/math/tan.vitest.ts)', function () {
