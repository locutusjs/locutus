...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/isnan.ts').isnan
const __locutus_source_module_url = new URL("../../../../src/python/math/isnan.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "isnan"
...
const __locutus_standalone_ts_code = "// python/math/isnan (target function module)\nfunction isnan(x) {\n    //      discuss at: https://locutus.io/python/isnan/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns True if x is NaN (Not a Number)\n    //       example 1: isnan(NaN)\n    //       returns 1: true\n    //       example 2: isnan(42)\n    //       returns 2: false\n    //       example 3: isnan(Infinity)\n    //       returns 3: false\n    return Number.isNaN(x);\n}"
const __locutus_standalone_js_code = "// python/math/isnan (target function module)\nfunction isnan(x) {\n    //      discuss at: https://locutus.io/python/isnan/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns True if x is NaN (Not a Number)\n    //       example 1: isnan(NaN)\n    //       returns 1: true\n    //       example 2: isnan(42)\n    //       returns 2: false\n    //       example 3: isnan(Infinity)\n    //       returns 3: false\n    return Number.isNaN(x);\n}"
...
describe('src/python/math/isnan.ts (tested in test/generated/python/math/isnan.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (isnan: typeof __locutus_source_fn) => {
      return isnan(NaN)
    }
