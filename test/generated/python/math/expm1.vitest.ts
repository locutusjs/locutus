...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/expm1.ts').expm1
const __locutus_source_module_url = new URL("../../../../src/python/math/expm1.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "expm1"
...
const __locutus_standalone_ts_code = "// python/math/expm1 (target function module)\nfunction expm1(x) {\n    //      discuss at: https://locutus.io/python/expm1/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns e raised to x, minus 1\n    //       example 1: expm1(0)\n    //       returns 1: 0\n    //       example 2: expm1(1)\n    //       returns 2: 1.718281828459045\n    //       example 3: expm1(-1)\n    //       returns 3: -0.6321205588285577\n    return Math.expm1 ? Math.expm1(x) : Math.exp(x) - 1;\n}"
const __locutus_standalone_js_code = "// python/math/expm1 (target function module)\nfunction expm1(x) {\n    //      discuss at: https://locutus.io/python/expm1/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns e raised to x, minus 1\n    //       example 1: expm1(0)\n    //       returns 1: 0\n    //       example 2: expm1(1)\n    //       returns 2: 1.718281828459045\n    //       example 3: expm1(-1)\n    //       returns 3: -0.6321205588285577\n    return Math.expm1 ? Math.expm1(x) : Math.exp(x) - 1;\n}"
...
describe('src/python/math/expm1.ts (tested in test/generated/python/math/expm1.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (expm1: typeof __locutus_source_fn) => {
      return expm1(0)
    }
  ...
  it('should pass example 2', function () {
    const expected = 1.718281828459045
    const __locutus_variants: Array<{ name: string; fn: (...args: unknown[]) => unknown }> = [
      { name: "source", fn: __locutus_source_fn },
      { name: "module-js", fn: __locutus_module_js_fn },
      { name: "standalone-ts", fn: __locutus_standalone_ts_fn },
  ...
  it('should pass example 3', function () {
    const expected = -0.6321205588285577
    const __locutus_variants: Array<{ name: string; fn: (...args: unknown[]) => unknown }> = [
      { name: "source", fn: __locutus_source_fn },
      { name: "module-js", fn: __locutus_module_js_fn },
      { name: "standalone-ts", fn: __locutus_standalone_ts_fn },
