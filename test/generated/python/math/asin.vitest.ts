...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/asin.ts').asin
const __locutus_source_module_url = new URL("../../../../src/python/math/asin.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "asin"
...
const __locutus_standalone_ts_code = "// python/math/asin (target function module)\nfunction asin(x) {\n    //      discuss at: https://locutus.io/python/asin/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the arc sine of x, in radians\n    //       example 1: asin(0)\n    //       returns 1: 0\n    //       example 2: asin(1)\n    //       returns 2: 1.5707963267948966\n    //       example 3: asin(-1)\n    //       returns 3: -1.5707963267948966\n    return Math.asin(x);\n}"
const __locutus_standalone_js_code = "// python/math/asin (target function module)\nfunction asin(x) {\n    //      discuss at: https://locutus.io/python/asin/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the arc sine of x, in radians\n    //       example 1: asin(0)\n    //       returns 1: 0\n    //       example 2: asin(1)\n    //       returns 2: 1.5707963267948966\n    //       example 3: asin(-1)\n    //       returns 3: -1.5707963267948966\n    return Math.asin(x);\n}"
...
describe('src/python/math/asin.ts (tested in test/generated/python/math/asin.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (asin: typeof __locutus_source_fn) => {
      return asin(0)
    }
