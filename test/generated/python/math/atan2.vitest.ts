...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/atan2.ts').atan2
const __locutus_source_module_url = new URL("../../../../src/python/math/atan2.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "atan2"
...
const __locutus_standalone_ts_code = "// python/math/atan2 (target function module)\nfunction atan2(y, x) {\n    //      discuss at: https://locutus.io/python/atan2/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns atan(y / x), in radians, using the signs of both arguments\n    //       example 1: atan2(0, 1)\n    //       returns 1: 0\n    //       example 2: atan2(1, -1)\n    //       returns 2: 2.356194490192345\n    //       example 3: atan2(-1, -1)\n    //       returns 3: -2.356194490192345\n    return Math.atan2(y, x);\n}"
const __locutus_standalone_js_code = "// python/math/atan2 (target function module)\nfunction atan2(y, x) {\n    //      discuss at: https://locutus.io/python/atan2/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns atan(y / x), in radians, using the signs of both arguments\n    //       example 1: atan2(0, 1)\n    //       returns 1: 0\n    //       example 2: atan2(1, -1)\n    //       returns 2: 2.356194490192345\n    //       example 3: atan2(-1, -1)\n    //       returns 3: -2.356194490192345\n    return Math.atan2(y, x);\n}"
...
describe('src/python/math/atan2.ts (tested in test/generated/python/math/atan2.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (atan2: typeof __locutus_source_fn) => {
      return atan2(0, 1)
    }
  ...
  it('should pass example 2', function () {
    const expected = 2.356194490192345
    const __locutus_variants: Array<{ name: string; fn: (...args: unknown[]) => unknown }> = [
      { name: "source", fn: __locutus_source_fn },
      { name: "module-js", fn: __locutus_module_js_fn },
      { name: "standalone-ts", fn: __locutus_standalone_ts_fn },
