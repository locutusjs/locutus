...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/isinf.ts').isinf
const __locutus_source_module_url = new URL("../../../../src/python/math/isinf.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "isinf"
...
const __locutus_standalone_ts_code = "// python/math/isinf (target function module)\nfunction isinf(x) {\n    //      discuss at: https://locutus.io/python/isinf/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns True if x is positive or negative infinity\n    //       example 1: isinf(Infinity)\n    //       returns 1: true\n    //       example 2: isinf(-Infinity)\n    //       returns 2: true\n    //       example 3: isinf(42)\n    //       returns 3: false\n    return x === Infinity || x === -Infinity;\n}"
const __locutus_standalone_js_code = "// python/math/isinf (target function module)\nfunction isinf(x) {\n    //      discuss at: https://locutus.io/python/isinf/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns True if x is positive or negative infinity\n    //       example 1: isinf(Infinity)\n    //       returns 1: true\n    //       example 2: isinf(-Infinity)\n    //       returns 2: true\n    //       example 3: isinf(42)\n    //       returns 3: false\n    return x === Infinity || x === -Infinity;\n}"
...
describe('src/python/math/isinf.ts (tested in test/generated/python/math/isinf.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (isinf: typeof __locutus_source_fn) => {
      return isinf(Infinity)
    }
