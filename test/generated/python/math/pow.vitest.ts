...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/pow.ts').pow
const __locutus_source_module_url = new URL("../../../../src/python/math/pow.ts", import.meta.url)
...
const __locutus_standalone_ts_code = "// python/math/pow (target function module)\nfunction pow(x, y) {\n    //      discuss at: https://locutus.io/python/pow/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns x raised to the power y\n    //       example 1: pow(2, 10)\n    //       returns 1: 1024\n    //       example 2: pow(2.5, 2)\n    //       returns 2: 6.25\n    //       example 3: pow(2, -1)\n    //       returns 3: 0.5\n    return Math.pow(x, y);\n}"
const __locutus_standalone_js_code = "// python/math/pow (target function module)\nfunction pow(x, y) {\n    //      discuss at: https://locutus.io/python/pow/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns x raised to the power y\n    //       example 1: pow(2, 10)\n    //       returns 1: 1024\n    //       example 2: pow(2.5, 2)\n    //       returns 2: 6.25\n    //       example 3: pow(2, -1)\n    //       returns 3: 0.5\n    return Math.pow(x, y);\n}"
