...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/math/exp.ts').exp
const __locutus_source_module_url = new URL("../../../../src/python/math/exp.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "exp"
...
const __locutus_standalone_ts_code = "// python/math/exp (target function module)\nfunction exp(x) {\n    //      discuss at: https://locutus.io/python/exp/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns e raised to the power of x\n    //       example 1: exp(0)\n    //       returns 1: 1\n    //       example 2: exp(1)\n    //       returns 2: 2.718281828459045\n    return Math.exp(x);\n}"
const __locutus_standalone_js_code = "// python/math/exp (target function module)\nfunction exp(x) {\n    //      discuss at: https://locutus.io/python/exp/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns e raised to the power of x\n    //       example 1: exp(0)\n    //       returns 1: 1\n    //       example 2: exp(1)\n    //       returns 2: 2.718281828459045\n    return Math.exp(x);\n}"
...
describe('src/python/math/exp.ts (tested in test/generated/python/math/exp.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (exp: typeof __locutus_source_fn) => {
      return exp(0)
    }
