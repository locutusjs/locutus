...
describe('src/python/statistics/pstdev.ts (tested in test/generated/python/statistics/pstdev.vitest.ts)', function () {
  it('should pass example 1', function () {
    const expected = 0.816496580927726
    ...
    const __locutus_run_example = (pstdev: typeof __locutus_source_fn) => {
      return pstdev([1, 2, 3])
    }
