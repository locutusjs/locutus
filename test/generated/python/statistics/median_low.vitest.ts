...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/python/statistics/median_low.ts').median_low
const __locutus_source_module_url = new URL("../../../../src/python/statistics/median_low.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "median_low"
...
const __locutus_standalone_ts_code = "// python/statistics/median_low (target function module)\nfunction median_low(data) {\n    //      discuss at: https://locutus.io/python/statistics/median_low/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the lower of the two middle values for even-sized input.\n    //       example 1: median_low([1, 2, 3, 4])\n    //       returns 1: 2\n    //       example 2: median_low([1, 3, 5])\n    //       returns 2: 3\n    //       example 3: median_low(['d', 'c', 'b', 'a'])\n    //       returns 3: 'b'\n    const values = sortStatisticsValues(data, 'median_low');\n    if (values.length === 0) {\n        throw new Error('no median for empty data');\n    }\n    return values[Math.floor((values.length - 1) / 2)];\n}\nfunction sortStatisticsValues(data, functionName) {\n    if (!Array.isArray(data)) {\n        throw new TypeError(`${functionName}() data must be an array`);\n    }\n    if (data.length === 0) {\n        return [];\n    }\n    const values = data;\n    const firstKind = getStatisticsSortKind(values[0], functionName);\n    for (let index = 1; index < values.length; index += 1) {\n        if (getStatisticsSortKind(values[index], functionName) !== firstKind) {\n            throw new TypeError(`${functionName}() requires data values that can be ordered together`);\n        }\n    }\n    return [...values].sort((left, right) => compareStatisticsValues(left, right, firstKind));\n}\nfunction getStatisticsSortKind(value, functionName) {\n    if (typeof value === 'string') {\n        return 'string';\n    }\n    if (typeof value === 'number' || typeof value === 'boolean' || typeof value === 'bigint') {\n        return 'number';\n    }\n    throw new TypeError(`${functionName}() requires sortable scalar values`);\n}\nfunction compareStatisticsValues(left, right, kind) {\n    if (kind === 'string') {\n        return String(left).localeCompare(String(right));\n    }\n    return toNumericSortValue(left) - toNumericSortValue(right);\n}\nfunction toNumericSortValue(value) {\n    return typeof value === 'boolean' ? (value ? 1 : 0) : Number(value);\n}"
const __locutus_standalone_js_code = "// python/statistics/median_low (target function module)\nfunction median_low(data) {\n    //      discuss at: https://locutus.io/python/statistics/median_low/\n    // parity verified: Python 3.12\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //          note 1: Returns the lower of the two middle values for even-sized input.\n    //       example 1: median_low([1, 2, 3, 4])\n    //       returns 1: 2\n    //       example 2: median_low([1, 3, 5])\n    //       returns 2: 3\n    //       example 3: median_low(['d', 'c', 'b', 'a'])\n    //       returns 3: 'b'\n    const values = sortStatisticsValues(data, 'median_low');\n    if (values.length === 0) {\n        throw new Error('no median for empty data');\n    }\n    return values[Math.floor((values.length - 1) / 2)];\n}\nfunction sortStatisticsValues(data, functionName) {\n    if (!Array.isArray(data)) {\n        throw new TypeError(`${functionName}() data must be an array`);\n    }\n    if (data.length === 0) {\n        return [];\n    }\n    const values = data;\n    const firstKind = getStatisticsSortKind(values[0], functionName);\n    for (let index = 1; index < values.length; index += 1) {\n        if (getStatisticsSortKind(values[index], functionName) !== firstKind) {\n            throw new TypeError(`${functionName}() requires data values that can be ordered together`);\n        }\n    }\n    return [...values].sort((left, right) => compareStatisticsValues(left, right, firstKind));\n}\nfunction getStatisticsSortKind(value, functionName) {\n    if (typeof value === 'string') {\n        return 'string';\n    }\n    if (typeof value === 'number' || typeof value === 'boolean' || typeof value === 'bigint') {\n        return 'number';\n    }\n    throw new TypeError(`${functionName}() requires sortable scalar values`);\n}\nfunction compareStatisticsValues(left, right, kind) {\n    if (kind === 'string') {\n        return String(left).localeCompare(String(right));\n    }\n    return toNumericSortValue(left) - toNumericSortValue(right);\n}\nfunction toNumericSortValue(value) {\n    return typeof value === 'boolean' ? (value ? 1 : 0) : Number(value);\n}"
...
describe('src/python/statistics/median_low.ts (tested in test/generated/python/statistics/median_low.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (median_low: typeof __locutus_source_fn) => {
      return median_low([1, 2, 3, 4])
    }
