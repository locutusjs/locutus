...
process.env.TZ = 'UTC'
const __locutus_source_fn = require('../../../../src/julia/Base/uppercase.ts').uppercase
const __locutus_source_module_url = new URL("../../../../src/julia/Base/uppercase.ts", import.meta.url)
const __locutus_source_require = createRequire(__locutus_source_module_url)
const __locutus_func_name = "uppercase"
...
const __locutus_standalone_ts_code = "// julia/Base/uppercase (target function module)\nfunction uppercase(s) {\n    //      discuss at: https://locutus.io/julia/uppercase/\n    // parity verified: Julia 1.11\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: uppercase('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: uppercase('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(s).toUpperCase();\n}"
const __locutus_standalone_js_code = "// julia/Base/uppercase (target function module)\nfunction uppercase(s) {\n    //      discuss at: https://locutus.io/julia/uppercase/\n    // parity verified: Julia 1.11\n    //     original by: Kevin van Zonneveld (https://kvz.io)\n    //       example 1: uppercase('hello')\n    //       returns 1: 'HELLO'\n    //       example 2: uppercase('Hello World')\n    //       returns 2: 'HELLO WORLD'\n    return String(s).toUpperCase();\n}"
...
describe('src/julia/Base/uppercase.ts (tested in test/generated/julia/Base/uppercase.vitest.ts)', function () {
  it('should pass example 1', function () {
    ...
    const __locutus_run_example = (uppercase: typeof __locutus_source_fn) => {
