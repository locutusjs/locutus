function HEREDOC (xmllist) {
	...
	// %          note 3: As per E4X rules, {} can be used to encapsulate variables or JavaScript expressions within the HEREDOC
	// %          note 4: Could be renamed HERE, etc., as the HEREDOC naming is not fixed in PHP either
	// %          note 5: Unfortunately this approach will not work to simulate the PHP 5.3+ NOWDOC; you must escape any literal curly brackets manually with &#x7B and &#x7D;
