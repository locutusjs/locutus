module.exports = function get_defined_constants (categorize)  {
  ...
  // %        note 4: If you do ini_set('locutus.get_defined_constants.setConstants', 'this') then call this function,
  ...
  // %        note 4: If you do ini_set('locutus.get_defined_constants.setConstants', 'thisExt') then call this function,
