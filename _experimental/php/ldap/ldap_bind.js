module.exports = function ldap_bind (link_id, bind_rdn, bind_pass, successCb, errorCb)  {
  ...
  if (typeof link_id !== 'object' || !link_id.get_resource_type) { // Duck type for LOCUTUS_Resource
    return false;
  }
