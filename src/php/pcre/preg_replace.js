module.exports = function preg_replace (pattern, replacement, string) { // eslint-disable-line camelcase
  ...
  //   example 2: preg_replace('/[^a-zA-Z0-9]+/', '', 'The Development of code . http://www.')
  //   returns 2: TheDevelopmentofcodehttpwww
  //   example 3: preg_replace('/[^A-Za-z0-9_\\s]/', '', 'D"usseldorfer H"auptstrasse')
  //   returns 3: Dusseldorfer Hauptstrasse
