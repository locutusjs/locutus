module.exports = function preg_replace (pattern, replacement, string) { // eslint-disable-line camelcase
  ...
  //   example 1: preg_replace("/xmas/i", "Christmas", "Twas the night before Xmas.")
  //   returns 1: Twas the night before Christmas.
  //   example 2: preg_replace("/xmas/ig", "Christmas", "xMas: Twas the night before Xmas.")
  //   returns 2: Christmas: Twas the night before Christmas.
