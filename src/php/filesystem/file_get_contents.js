module.exports = function file_get_contents (url, flags, context, offset, maxLen) {
  ...
  //        note: get async by setting a custom "locutus.async" property to true and "notification" for an
  ...
  */
    ...
    try {
      if (http_options && http_options['locutus.sendAsBinary']) {
