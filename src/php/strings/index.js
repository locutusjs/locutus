...
module.exports.number_format = require('./number_format.ts').number_format
module.exports.ord = require('./ord')
module.exports.parse_str = require('./parse_str.ts').parse_str
...
module.exports.str_repeat = require('./str_repeat.ts').str_repeat
module.exports.str_replace = require('./str_replace.ts').str_replace
...
module.exports.strlen = require('./strlen.ts').strlen
...
module.exports.strtr = require('./strtr.ts').strtr
module.exports.substr = require('./substr.ts').substr
...
module.exports.wordwrap = require('./wordwrap.ts').wordwrap
