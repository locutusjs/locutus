...
module.exports.parse_str = require('./parse_str.ts').default
...
module.exports.str_repeat = require('./str_repeat.ts').default
module.exports.str_replace = require('./str_replace.ts').default
...
module.exports.strlen = require('./strlen.ts').default
...
module.exports.strtr = require('./strtr.ts').default
module.exports.substr = require('./substr.ts').default
