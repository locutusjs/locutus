...
module.exports.array_pop = require('./array_pop.ts').default
...
module.exports.arsort = require('./arsort.ts').default
module.exports.asort = require('./asort.ts').default
...
module.exports.krsort = require('./krsort.ts').default
module.exports.ksort = require('./ksort.ts').default
module.exports.natcasesort = require('./natcasesort.ts').default
module.exports.natsort = require('./natsort.ts').default
...
module.exports.rsort = require('./rsort.ts').default
module.exports.shuffle = require('./shuffle.ts').default
module.exports.sizeof = require('./sizeof')
module.exports.sort = require('./sort.ts').default
module.exports.uasort = require('./uasort.ts').default
module.exports.uksort = require('./uksort.ts').default
module.exports.usort = require('./usort.ts').default
