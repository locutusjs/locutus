...
module.exports.array_pop = require('./array_pop.ts').array_pop
...
module.exports.arsort = require('./arsort.ts').arsort
module.exports.asort = require('./asort.ts').asort
...
module.exports.krsort = require('./krsort.ts').krsort
module.exports.ksort = require('./ksort.ts').ksort
module.exports.natcasesort = require('./natcasesort.ts').natcasesort
module.exports.natsort = require('./natsort.ts').natsort
...
module.exports.rsort = require('./rsort.ts').rsort
module.exports.shuffle = require('./shuffle.ts').shuffle
module.exports.sizeof = require('./sizeof')
module.exports.sort = require('./sort.ts').sort
module.exports.uasort = require('./uasort.ts').uasort
module.exports.uksort = require('./uksort.ts').uksort
module.exports.usort = require('./usort.ts').usort
