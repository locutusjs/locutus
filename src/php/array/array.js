module.exports = function array () {
  //  discuss at: http://locutusjs.org/php/array/
  // original by: d3x
  ...
  if (p && p.ini && p.ini['locutus.return_locutus_arrays'].local_value.toLowerCase() === 'on') {
    ...
    LOCUTUS_Array.prototype = p.LOCUTUS_Array.prototype
    arrInst = new LOCUTUS_Array()
    p.LOCUTUS_Array.apply(arrInst, mainArgs)
    return arrInst
  }
