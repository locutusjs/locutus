module.exports = function stream_filter_prepend (stream, filtername, read_write, params)  {
  ...
  LOCUTUS_Resource.prototype.toString = function() {
    return 'Resource id #' + this.id;
  };
  LOCUTUS_Resource.prototype.get_resource_type = function() {
    return this.type;
  };
  LOCUTUS_Resource.prototype.var_dump = function() {
    return 'resource(' + this.id + ') of type (' + this.type + ')';
  };
  // END REDUNDANT

  this.php_js.resourceIdCounter++;
  resource = new LOCUTUS_Resource('stream filter', this.php_js.resourceIdCounter, 'stream_filter_append');
