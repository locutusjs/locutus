...
params:
  headKeys:
    discuss at:
      - - 'http://phpjs.org/functions/krsort/'
    original by:
...
{% highlight javascript %}
data = {d: 'lemon', a: 'orange', b: 'banana', c: 'apple'};,data = krsort(data);,$result = data
{% endhighlight %}

Should return

{% highlight javascript %}
data = {d: 'lemon', a: 'orange', b: 'banana', c: 'apple'};,data = krsort(data);,$result = data{% endhighlight %}

## Example 2

{% highlight javascript %}
ini_set('phpjs.strictForIn', true);,data = {2: 'van', 3: 'Zonneveld', 1: 'Kevin'};,krsort(data);,$result = data
{% endhighlight %}

Should return

{% highlight javascript %}
ini_set('phpjs.strictForIn', true);,data = {2: 'van', 3: 'Zonneveld', 1: 'Kevin'};,krsort(data);,$result = data{% endhighlight %}
