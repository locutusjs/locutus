---
layout: post
title: "Locutus 4.0: Fully Assimilated into TypeScript"
comments: true
...
The published `dist` is still CommonJS, so `require()` continues to work. Only the import shape changed.

## Thank you

This project has had [137 contributors](https://github.com/locutusjs/locutus/graphs/contributors) over its lifetime. Special thanks to [Brett Zamir](https://github.com/brettz9) for an extraordinary number of function implementations and reviews over the years, to [Rafal Kukawski](https://github.com/nicmart) for sustained improvements, and to everyone who filed issues, sent PRs, or just used the project quietly in their own work. And to @SignpostMarv for the discussion that kicked this whole thing off.
