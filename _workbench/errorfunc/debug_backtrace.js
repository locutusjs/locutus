function debug_backtrace (provide_object) {
    ...
    // Note, since "function" is a reserved word in JavaScript (even as a property), you must use the ['function'] notation to get the returned object's arrays' properties
    // Mozilla only
