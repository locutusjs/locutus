module.exports = function textdomain (domain)  {
  ...
  var stream_opts = {
    'http': {
      'method': 'GET',
      'locutus.override' : 'text/javascript; charset=' + codeset // Use our own custom "PHP"-like stream option to use XMLHttpRequest's overrideMimeType() (since PHP does not have an equivalent (?))
    }
  };
