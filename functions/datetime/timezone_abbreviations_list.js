function timezone_abbreviations_list () {
    ...
    var abbreviations = ["acst", "act", "addt", "adt", "aft", "ahdt", "ahst", "akdt",
    ...
    var offsets = [-43200, -41400, -39600, -37800, -36000, -34200, -32400,
    ...
    var prefixes = ['Africa', 'America', 'America/Argentina', 'America',
    ...
    while (tz_abbrs.length) {
        indice = abbreviations.shift();
        curr = tz_abbrs.shift();
        list[indice] = [];
        while (curr.length) {
            currSub = curr.shift();
