...
document.body.write( "*** Testing token_get_all() : unexpected values for 'source' argument ***\n");
...
MyClass.prototype.__toString = function() {
	return "object";
};
...
for(count = 0; count < source_values.length; count++) {
