...
load('/home/kevin/workspace/plutonia-phpjs/functions/array/array_walk_recursive.js');

window.location = '/home/kevin/workspace/plutonia-phpjs/_helpers/tester.htm';
window.onload = function(){
    print('## SETS ##');
    // Execute Example Code
    returns = array_walk_recursive ({'a':'b', 'c': {'d' : 'e'}} ,'void', 'userdata');;    
    ...
    print('## SETS ##');
    // Execute Example Code
    returns = array_walk_recursive ('a' ,'void', 'userdata');;    
