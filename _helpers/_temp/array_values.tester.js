...
load('/home/kevin/workspace/plutonia-phpjs/functions/array/array_values.js');

window.location = '/home/kevin/workspace/plutonia-phpjs/_helpers/tester.htm';
window.onload = function(){
    print('## SETS ##');
    // Execute Example Code
    returns = array_values( {firstname: 'Kevin', surname: 'van Zonneveld'} );;    
    
    // Compare call return value
    success = tester_comparer(returns, {0: 'Kevin', 1: 'van Zonneveld'});
