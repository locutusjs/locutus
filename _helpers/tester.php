...
function compile_tester_source($file, $example_set, $includes = false) {
    ...
    $tester .= t."success = comparer(returns, ".$example_set["returns"].");".n;
    $tester .= t."print('> returns', success, trim(print_r(returns, true)));".n;
    $tester .= t."".n;
    ...
    if (isset($example_set["results"])) {
        ...
        if (trim($val) && trim($key)) {
            ...
            $tester .= t."print('> results', success, trim(print_r(data, true)));".n;
        }
    }
