  ...
  */
  ...
  try {
    ...
    const _str = function (key: string | number, holder: Record<string, unknown>): string | undefined {
      ...
      const mind = gap
      let partial: string[] = []
      let value = holder[key as string] as Record<string, unknown> | string | number | boolean | null | undefined

      // If the value has a toJSON method, call it to obtain a replacement value.
      if (value && typeof value === 'object' && typeof (value as Record<string, unknown>).toJSON === 'function') {
        value = (value as Record<string, (...args: unknown[]) => unknown>).toJSON(key) as
      ...
      switch (typeof value) {
        ...
        case 'object':
          ...
          if (Object.prototype.toString.apply(value) === '[object Array]') {
            ...
            // for non-JSON values.
            length = (value as unknown as unknown[]).length
          ...
          for (k in value) {
            if (Object.hasOwnProperty.call(value, k)) {
              v = _str(k, value as Record<string, unknown>) || ''
              if (v) {
