...
2. Use `gh` to check on pending PRs. Make sure they have reviews, ensure they pass, fix them if needed, then look at them a next invocation. If all is green, merge. If you write comments make sure they are hyper consise and dense.
